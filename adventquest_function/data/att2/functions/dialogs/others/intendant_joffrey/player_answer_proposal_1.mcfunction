...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@s","extra":[{"text":" : "},{"text":"[Payer 1000 Chronotons -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-100a-0000-00000000100a if entity @s[distance=..7] if score intendant_joffrey_PNJ DIALOG matches 3 run function att2:dialogs/others/intendant_joffrey/answer_green_1"},"hover_event":{"action":"show_text","value":"Cliquez ici - réponse 1"}}]}
...
#JAPANESE LANGUAGE
tellraw @s[scores={LANGUAGE=3}] {"selector":"@s","extra":[{"text":" : "},{"text":"[1000 Chronotonsを支払う -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-100a-0000-00000000100a if entity @s[distance=..7] if score intendant_joffrey_PNJ DIALOG matches 3 run function att2:dialogs/others/intendant_joffrey/answer_green_1"},"hover_event":{"action":"show_text","value":"こちらをクリック - 回答 1"}}]}

#KOREAN LANGUAGE
tellraw @s[scores={LANGUAGE=4}] {"selector":"@s","extra":[{"text":" : "},{"text":"[1000 Chronotons 지불 -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-100a-0000-00000000100a if entity @s[distance=..7] if score intendant_joffrey_PNJ DIALOG matches 3 run function att2:dialogs/others/intendant_joffrey/answer_green_1"},"hover_event":{"action":"show_text","value":"여기를 클릭하세요 - 답변 1"}}]}
...
#HINDI LANGUAGE
tellraw @s[scores={LANGUAGE=9}] {"selector":"@s","extra":[{"text":" : "},{"text":"[1000 Chronotons भुगतान करें -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-100a-0000-00000000100a if entity @s[distance=..7] if score intendant_joffrey_PNJ DIALOG matches 3 run function att2:dialogs/others/intendant_joffrey/answer_green_1"},"hover_event":{"action":"show_text","value":"यहाँ क्लिक करें - उत्तर 1"}}]}
...
#Simplified Chinese
tellraw @s[scores={LANGUAGE=11}] {"selector":"@s","extra":[{"text":" : "},{"text":"[支付1000Chronotons即可获得房屋钥匙！-->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-100a-0000-00000000100a if entity @s[distance=..7] if score intendant_joffrey_PNJ DIALOG matches 3 run function att2:dialogs/others/intendant_joffrey/answer_green_1"},"hover_event":{"action":"show_text","value":"点击这里 - 回答 1"}}]}
