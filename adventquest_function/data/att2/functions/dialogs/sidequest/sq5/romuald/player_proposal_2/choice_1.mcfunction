...
tellraw @s[scores={LANGUAGE=3}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[うーん、それはうまくいっていないようだね... 確かに問題があるけど、アルコールの中には解決策はないよ... まずは何が問題か教えてくれ... -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-004a-0000-00000000004a if entity @s[distance=..7] if score romuald_PNJ DIALOG matches 1..2 run function att2:cinematic/sidequest/5/romuald/answer_1_2"},"hover_event":{"action":"show_text","value":"ここをクリック - 回答 1"}}]}

#KOREAN LANGUAGE

tellraw @s[scores={LANGUAGE=4}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[음, 이건 잘 안 될 것 같아... 분명히 문제가 있지만, 알코올에서는 해결책을 찾을 수 없어... 우선 뭐가 문제인지 말해줘... -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-004a-0000-00000000004a if entity @s[distance=..7] if score romuald_PNJ DIALOG matches 1..2 run function att2:cinematic/sidequest/5/romuald/answer_1_2"},"hover_event":{"action":"show_text","value":"여기를 클릭 - 답변 1"}}]}

#ARABIC LANGUAGE

tellraw @s[scores={LANGUAGE=5}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[أوه، يبدو أن هذا لا يعمل... لديك مشاكل، هذا مؤكد، لكن الكحول لن يحلها... ابدأ بقول لي ما المشكلة... -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-004a-0000-00000000004a if entity @s[distance=..7] if score romuald_PNJ DIALOG matches 1..2 run function att2:cinematic/sidequest/5/romuald/answer_1_2"},"hover_event":{"action":"show_text","value":"انقر هنا - الإجابة 1"}}]}

#RUSSIAN LANGUAGE

tellraw @s[scores={LANGUAGE=6}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[Упс, похоже, это не сработает... У вас есть проблемы, это точно, но алкоголь не решит их... Сначала скажите мне, что не так... -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-004a-0000-00000000004a if entity @s[distance=..7] if score romuald_PNJ DIALOG matches 1..2 run function att2:cinematic/sidequest/5/romuald/answer_1_2"},"hover_event":{"action":"show_text","value":"Нажмите здесь - ответ 1"}}]}
...
#Simplified Chinese
tellraw @s[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[好吧，看来这不管用...你确实遇到了问题，但从酒精里是找不到答案的...告诉我发生了什么... -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-004a-0000-00000000004a if entity @s[distance=..7] if score romuald_PNJ DIALOG matches 1..2 run function att2:cinematic/sidequest/5/romuald/answer_1_2"},"hover_event":{"action":"show_text","value":"点击这里 - 回答 1"}}]}
