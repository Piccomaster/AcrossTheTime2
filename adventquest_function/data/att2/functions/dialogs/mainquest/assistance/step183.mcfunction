...
tellraw @s[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"好吧，这座桥似乎是通过某种装置激活的。看样子我得走另外一条道路，找到能让这个装置正常工作的东西。","color":"aqua"}]}
