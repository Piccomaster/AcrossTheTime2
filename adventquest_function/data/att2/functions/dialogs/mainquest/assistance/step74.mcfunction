...
tellraw @s[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"封印那只怪物的巢穴的两个封印法器已经归位，我现在必须得回营地通知Relgon。最终决战即将来临...","color":"aqua"}]}
