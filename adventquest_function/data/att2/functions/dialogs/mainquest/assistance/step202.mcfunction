...
tellraw @s[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"我必须回到Ourano宫门前与Skaolon交谈。有了这个Néleptron，他也许会准许我去谒见国王。","color":"aqua"}]}
