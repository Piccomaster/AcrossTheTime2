...
tellraw @a[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"第一块空间宝石已经安置妥当了。我最好回去问问Wirth，看看他还有没有关于其它空间宝石的线索。","color":"aqua"}]}
