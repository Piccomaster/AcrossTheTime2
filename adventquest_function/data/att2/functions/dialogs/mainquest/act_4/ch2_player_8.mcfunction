...
tellraw @a[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"我现在得跨过一座坍塌的桥……它上方的钟乳石好大啊！这么宽，落下来的话应该可以给我铺条路，甚至能把洞填满。除了硬来我想不到其他办法，也许我们可以爬上去试着把它的底部融化掉！它落下来应该不会把剩下的桥也带倒，把整个洞穴都毁掉吧……","color":"aqua"}]}
