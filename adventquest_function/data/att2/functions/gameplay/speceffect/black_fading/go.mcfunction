...
execute if score black_fading TIMER matches 1 as @a[scores={NUMEROJOUEUR=1}] at @s run summon minecraft:armor_stand ^ ^ ^1.6 {Tags:["BlackFading"],NoBasePlate:1b,Invisible:1b,NoGravity:1b,Marker:1b,ShowArms:0b,DisabledSlots:2039552,equipment:{}}
