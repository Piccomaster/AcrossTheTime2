...
#set area score
execute if score tic TIMECOUNTER matches 2 as @e[tag=FISH_SPOT,type=armor_stand,distance=..20,limit=1,sort=nearest] at @s run function att2:gameplay/misc/fishing/nojelanth_past/pos_8/check
