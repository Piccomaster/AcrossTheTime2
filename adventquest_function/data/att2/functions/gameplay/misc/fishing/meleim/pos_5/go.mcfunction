...
#random POS select
execute if score tic TIMECOUNTER matches 2 as @e[tag=FISH_SPOT,type=armor_stand,distance=..20,limit=1,tag=SPOT_SELECT,sort=nearest] at @s run function att2:gameplay/misc/fishing/meleim/pos_5/pos_select
#set area score
