...
execute positioned -9956 72 -10017 if block ~ ~ ~ minecraft:light[level=10] run function att2:gameplay/maze/symbol/trigger/1
execute positioned -10048 72 -10053 if block ~ ~ ~ minecraft:light[level=10] run function att2:gameplay/maze/symbol/trigger/1
execute positioned -9992 72 -10065 if block ~ ~ ~ minecraft:light[level=10] run function att2:gameplay/maze/symbol/trigger/1
