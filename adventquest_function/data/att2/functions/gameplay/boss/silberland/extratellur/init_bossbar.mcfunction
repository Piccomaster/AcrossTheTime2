#################################################################
#Made by Adventquest											#
#Initialize bossbar Extratellur									#
#################################################################

bossbar add minecraft:extratellur1 {"text":"extratellur1","color":"dark_red"}
bossbar set minecraft:extratellur1 style notched_12
bossbar set minecraft:extratellur1 players @a
...
bossbar set minecraft:extratellur2 players @a
...
bossbar set minecraft:extratellur3 players @a
...
bossbar set minecraft:extratellur4 players @a
