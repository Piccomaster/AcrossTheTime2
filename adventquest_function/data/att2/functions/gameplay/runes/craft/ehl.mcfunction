...
##set price
#rune powder
scoreboard players operation temp_value_10 CAL = 11_ehl PRICES
#esc count
scoreboard players operation temp_value_11 CAL = 11_ehl_esc PRICES
#return0
...
#give
execute if score temp_value_13 CAL matches 1 run function att2:items/runes/11_ehl
#reset
