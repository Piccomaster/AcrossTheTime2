...
execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_name":{translate:'item.coin.esc.name'}}}]}] run function att2:gameplay/shop/mending/reparation/epi/deal
