...
#get DAR number
execute if predicate att2_pre:enchantment/arcanedrive/mainhand run scoreboard players operation temp_value_2 CAL += temp_value_1 CAL
execute if predicate att2_pre:enchantment/arcanedrive/offhand run scoreboard players operation temp_value_2 CAL += temp_value_1 CAL
#ger score
