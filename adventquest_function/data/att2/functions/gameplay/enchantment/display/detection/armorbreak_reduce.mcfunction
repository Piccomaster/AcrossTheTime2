...
execute if score armorbreak ENCHANTMENT > now_lvl_show ENCHANTMENT if score armorbreak ENCHANTMENT matches 2.. store result storage att2:enchantment end_lvl_show int 1 run scoreboard players get armorbreak ENCHANTMENT
