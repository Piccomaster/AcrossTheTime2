...
execute if score precisionshot ENCHANTMENT > now_lvl_show ENCHANTMENT if score precisionshot ENCHANTMENT matches 2.. store result storage att2:enchantment end_lvl_show int 1 run scoreboard players get precisionshot ENCHANTMENT
