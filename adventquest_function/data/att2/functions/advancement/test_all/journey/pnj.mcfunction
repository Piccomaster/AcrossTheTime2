#################################################################
#Made by Adventquest											#
#Process PNJ detect from pnj_talk/dialog_update 			    #
#################################################################
...
# Exile camp
execute if score daril_gram_PNJ statDIALOG matches 1 if score lisa_payin_PNJ statDIALOG matches 1 if score rokar_borton_PNJ statDIALOG matches 1 if score hermona_frihax_PNJ statDIALOG matches 1 if score garret_temeral_PNJ statDIALOG matches 1 if score eternal_soldier_1_PNJ statDIALOG matches 1 if score eternal_soldier_2_PNJ statDIALOG matches 1 if score feanorth_PNJ statDIALOG matches 1 if score eradon_PNJ statDIALOG matches 1 if score namrin_PNJ statDIALOG matches 1 if score relgon_PNJ statDIALOG matches 1 if score etotsira_young_PNJ statDIALOG matches 1 if score serile_PNJ statDIALOG matches 1 if score derim_kril_PNJ statDIALOG matches 1 run advancement grant @a only att2:journey/pnj_exile_camp
# Phoenix
execute if score phoebius_PNJ statDIALOG matches 1 if score ramsay_tork_PNJ statDIALOG matches 1 if score armel_darsan_PNJ statDIALOG matches 1 if score garry_traskel_PNJ statDIALOG matches 1 if score elsa_rasmon_PNJ statDIALOG matches 1 if score marion_marsot_PNJ statDIALOG matches 1 if score daril_gram_PNJ statDIALOG matches 1 run advancement grant @a only att2:journey/pnj_phoenix
# Angor
...
# All
execute if entity @a[advancements={att2:journey/pnj_ryliath=true,att2:journey/pnj_meleim=true,att2:journey/pnj_eolorion=true,att2:journey/pnj_kortaek=true,att2:journey/pnj_exile_camp=true,att2:journey/pnj_phoenix=true,att2:journey/pnj_angor=true,att2:journey/pnj_billgart=true,att2:journey/pnj_ouranos=true,att2:journey/pnj_earndhel=true,att2:journey/pnj_jarat=true,att2:journey/pnj_worlest=true,att2:journey/pnj_black=true,att2:journey/pnj_soquai=true,att2:journey/pnj_owsastr=true,att2:journey/pnj_plain=true,att2:journey/pnj_kert=true,att2:journey/pnj_asunark=true}] run advancement grant @a only att2:journey/the_talktative
