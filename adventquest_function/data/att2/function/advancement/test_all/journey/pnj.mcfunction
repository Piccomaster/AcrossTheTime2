...
# Phoenix
execute if score phoebius_PNJ statDIALOG matches 1 if score ramsay_tork_PNJ statDIALOG matches 1 if score armel_darsan_PNJ statDIALOG matches 1 if score garry_traskel_PNJ statDIALOG matches 1 if score elsa_rasmon_PNJ statDIALOG matches 1 if score marion_marsot_PNJ statDIALOG matches 1 if score derim_kril_PNJ statDIALOG matches 1 run advancement grant @a only att2:journey/pnj_phoenix
# Angor
