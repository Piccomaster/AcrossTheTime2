...
execute if score eolorion_dailyquest_4_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/eolorion/dq4
execute if score eolorion_dailyquest_5_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/eolorion/dq5
execute if score eolorion_dailyquest_6_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/eolorion/dq6
execute if score eolorion_dailyquest_7_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/eolorion/dq7
execute if score eolorion_dailyquest_8_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/eolorion/dq8
execute if score eolorion_dailyquest_9_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/eolorion/dq9
execute if score eolorion_dailyquest_10_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/eolorion/dq10
execute if score eolorion_dailyquest_11_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/eolorion/dq11
execute if score eolorion_dailyquest_12_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/eolorion/dq12
execute if score eolorion_dailyquest_13_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/eolorion/dq13
