...
execute if score ryliath_dailyquest_4_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/ryliath/dq4
execute if score ryliath_dailyquest_5_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/ryliath/dq5
execute if score ryliath_dailyquest_6_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/ryliath/dq6
execute if score ryliath_dailyquest_7_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/ryliath/dq7
execute if score ryliath_dailyquest_8_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/ryliath/dq8
execute if score ryliath_dailyquest_9_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/ryliath/dq9
execute if score ryliath_dailyquest_10_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/ryliath/dq10
execute if score ryliath_dailyquest_11_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/ryliath/dq11
execute if score ryliath_dailyquest_12_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/ryliath/dq12
execute if score ryliath_dailyquest_13_completed DAILYQUEST matches 1 run advancement grant @a only att2:quest/dailyquest/ryliath/dq13
