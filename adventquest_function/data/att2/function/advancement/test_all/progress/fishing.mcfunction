...
execute if score TOTAL FISH_DICOVER_COUNT matches 1.. run advancement grant @a only att2:progress/fishing/fishing_discover_1
execute if score TOTAL FISH_DICOVER_COUNT matches 5.. run advancement grant @a only att2:progress/fishing/fishing_discover_5
execute if score TOTAL FISH_DICOVER_COUNT matches 10.. run advancement grant @a only att2:progress/fishing/fishing_discover_10
execute if score TOTAL FISH_DICOVER_COUNT matches 25.. run advancement grant @a only att2:progress/fishing/fishing_discover_25
execute if score TOTAL FISH_DICOVER_COUNT matches 50.. run advancement grant @a only att2:progress/fishing/fishing_discover_50
execute if score TOTAL FISH_DICOVER_COUNT matches 100.. run advancement grant @a only att2:progress/fishing/fishing_discover_100
