...
advancement grant @s[scores={statBEEKILLED=200..}] only att2:mobskilled/bees_killed_200
advancement grant @s[scores={statBEEKILLED=400..}] only att2:mobskilled/bees_killed_400
