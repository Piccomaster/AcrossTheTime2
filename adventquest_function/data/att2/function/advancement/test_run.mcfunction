...
advancement grant @a[nbt={Inventory:[{components:{"minecraft:custom_data":{EquipmentID:"lostpast"}}}]}] only att2:adventure/myt
...
advancement grant @a[nbt={SelectedItem:{components:{"minecraft:custom_data":{EquipmentID:"lostpast"}}}}] only att2:collection/mythique/lost_past
