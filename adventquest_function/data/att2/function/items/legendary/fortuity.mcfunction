...
give @s minecraft:wooden_sword[custom_model_data={floats:[10000000]},lore=[{translate:item.legendary.fortuity.lore.1},{translate:item.legendary.fortuity.lore.2},{translate:item.legendary.fortuity.lore.3},{translate:item.legendary.fortuity.lore.4}],attribute_modifiers=[{amount:1.0d,id:"attack_damage",operation:"add_value",slot:"mainhand",type:"attack_damage"},{amount:-0.75d,id:"attack_speed",operation:"add_multiplied_base",slot:"mainhand",type:"attack_speed"}],attack_range={"min_reach":0,"max_reach":3.5,"hitbox_margin":0.2},enchantments={"looting":1},minimum_attack_charge=0.5,unbreakable={},custom_name={translate:item.legendary.fortuity.name},custom_data={EquipmentID:"fortuity",EquipmentType:"meleeWeapon",Rarity:"myt"},tooltip_style="minecraft:rarity/myt/myt"]