...
item replace entity @s armor.head with diamond_helmet[equippable={slot:saddle,equip_sound:intentionally_empty},enchantments={"att2_enchantment:legendary/weaponsking/explosion":1},item_model="nothing"]
##add tag
tag @s add WK_POS
#snyc score
