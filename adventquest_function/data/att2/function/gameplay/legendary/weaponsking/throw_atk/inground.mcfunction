...
#get damage
execute on origin if score @s DAHAL matches 100.. run scoreboard players set TEST CAL 1
...
#remove dahal
execute on origin run scoreboard players remove @s[scores={DAHAL=100..}] DAHAL 100
#reset
