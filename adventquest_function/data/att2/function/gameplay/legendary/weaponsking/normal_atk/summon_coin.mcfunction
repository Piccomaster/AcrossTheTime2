...
#ruby
$execute if score RUBY CAL matches 1.. run summon minecraft:item ~ ~ ~ {PickupDelay:0,Motion:[0.0,0.5,0.0],Item:{id:"minecraft:copper_ingot",count:$(RUBY),components:{custom_data:{EquipmentType:'misc',Rarity:'cur',Coin:'ruby',Action:'dropped'},custom_name:{translate:'item.coin.ruby.name'},lore:[{translate:'item.coin.ruby.lore'}],max_stack_size:99,tooltip_style:"minecraft:rarity/misc/misc"}}}
#amethyst
...
#big
$execute if score BIG_COIN CAL matches 1.. run summon minecraft:item ~ ~ ~ {PickupDelay:0,Motion:[0.0,0.5,0.0],Item:{id:"minecraft:gold_ingot",count:$(BIG_COIN),components:{custom_data:{EquipmentType:'misc',Rarity:'cur',Coin:'big',Action:'dropped'},custom_name:{translate:'item.coin.big.name'},lore:[{translate:'item.coin.big.lore'}],max_stack_size:99,tooltip_style:"minecraft:rarity/misc/misc"}}}
#small
