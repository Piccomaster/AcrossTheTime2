...
#motion
#make damage
execute as @e[distance=..3,team=hostile,scores={GAMELEVEL=0..},tag=!WK_RE_ATKED] at @s run function att2:gameplay/legendary/weaponsking/riptide_atk/effect with storage att2:damage
#keep particle
