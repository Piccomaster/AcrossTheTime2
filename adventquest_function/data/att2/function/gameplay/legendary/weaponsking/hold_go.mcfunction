...
#riptide detection
execute if score @s[predicate=att2_pre:legendary/weaponsking/riptide,scores={DAMAGE=..0}] WK_RIPTIDE matches 1.. run function att2:gameplay/legendary/weaponsking/riptide_atk/set
execute if score @s WK_RE_TIMER matches 1.. run function att2:gameplay/legendary/weaponsking/riptide_atk/go
#normal atk
execute if score @s[advancements={att2_test:legendary/weaponsking/normal_atk_trigger=true}] DAMAGE matches 1.. run function att2:gameplay/legendary/weaponsking/normal_atk/attack_trigger
#detection pos
