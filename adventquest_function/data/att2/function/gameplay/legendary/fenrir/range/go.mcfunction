...
execute if score TIMER CAL matches 1 as @e[distance=..5,scores={GAMELEVEL=0..},team=hostile,type=!bat,tag=!Guardian,type=!squid] at @s run function att2:gameplay/legendary/fenrir/range/enemy_effect with storage att2:damage
#other effect
