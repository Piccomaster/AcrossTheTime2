...
execute positioned ~-0.8 ~-0.8 ~-0.8 as @e[dx=1.6,dy=1.6,dz=1.6,scores={GAMELEVEL=0..},team=hostile,type=!bat,tag=!UltimaATK] run function att2:gameplay/legendary/ultima/damage/atk_laser