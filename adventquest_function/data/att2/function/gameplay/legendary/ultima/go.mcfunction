...
scoreboard players set @a[scores={HOLDING_UL=1..,DAMAGE=1..,DAHAL_TICK=1000..}] UL_EFFECT 1
scoreboard players remove @a[scores={HOLDING_UL=1..,DAMAGE=1..,DAHAL_TICK=1000..}] DAHAL_TICK 1000
