...
scoreboard players operation @s SHADOW_TOTAL *= 70 CAL
...
execute as @e[distance=..5,team=hostile,scores={GAMELEVEL=0..}] at @s run particle minecraft:item{item:"minecraft:black_wool"} ~ ~ ~ 0 0 0 1.0 200 normal
