...
execute on attacker run scoreboard players operation @s SHADOW_TOTAL += @s DAMAGE
execute unless score @s SHADOW_TIMER matches 1.. on attacker unless function att2:gameplay/legendary/loneshadow/normal_atk/attack_trigger run return fail
