...
#range damage
execute at @s anchored eyes positioned ^ ^ ^4 as @e[distance=..6,team=hostile,scores={GAMELEVEL=0..}] at @s run function att2:gameplay/legendary/rukyrion/normal_atk/damage with storage att2:damage
#particle
