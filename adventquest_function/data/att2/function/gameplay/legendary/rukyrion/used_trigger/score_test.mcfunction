...
#reduce dahal
execute if score TEST CAL matches 1 run scoreboard players remove @s[scores={RUK_USED=1..2,DAHAL=30..}] DAHAL 30
execute if score TEST CAL matches 1 run scoreboard players remove @s[scores={RUK_USED=3,DAHAL=100..}] DAHAL 100
