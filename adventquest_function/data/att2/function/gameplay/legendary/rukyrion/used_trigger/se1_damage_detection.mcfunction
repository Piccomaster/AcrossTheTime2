...
##damage
execute at @s align xyz positioned ~-0.5 ~-2 ~-0.5 as @e[dx=2,dy=4,dz=2,scores={GAMELEVEL=0..},team=hostile,type=!bat,tag=!RUK_ATKED,tag=!Guardian] run function att2:gameplay/legendary/rukyrion/used_trigger/se_damage with storage att2:score
##clear sword
