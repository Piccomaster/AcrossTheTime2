...
execute as @s[predicate=att2_pre:legendary/interfacer/mainhand,predicate=att2_pre:legendary/interfacer/dahal_magasin,scores={IF_MAGASIN=..0,IF_COOLDOWN=..0,DAHAL_TICK=5000..}] run function att2:gameplay/legendary/interfacer/reload_dahal
