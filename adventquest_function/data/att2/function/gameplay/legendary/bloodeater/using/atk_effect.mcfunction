...
#damage go
execute as @e[scores={GAMELEVEL=0..},team=hostile,distance=..3,tag=!BE_ATKED,tag=!Guardian] at @s run function att2:gameplay/legendary/bloodeater/using/damage with storage att2:damage
#reset
