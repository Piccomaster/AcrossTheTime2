...
#<= 91 -> on the wall
execute if score SA_MOTION_X_NEW CAL <= 78 CAL run scoreboard players set SA_BACK CAL 1
execute if score SA_MOTION_Z_NEW CAL <= 78 CAL run scoreboard players set SA_BACK CAL 1
#fix motion reduce
