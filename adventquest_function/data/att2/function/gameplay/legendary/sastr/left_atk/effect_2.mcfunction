...
#range damage
execute at @e[distance=..7,team=hostile,scores={GAMELEVEL=0..,SA_TIMER_2=1..},limit=1,sort=nearest,tag=TEMP_ATK] as @e[distance=..4,team=hostile,scores={GAMELEVEL=0..}] run function att2:gameplay/legendary/sastr/left_atk/damage
#remove tag 
