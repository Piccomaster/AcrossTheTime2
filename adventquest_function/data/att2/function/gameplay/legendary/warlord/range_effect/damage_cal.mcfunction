...
#get entity count
execute store result score MOB_COUNT_ROUND_1 CAL if entity @e[distance=5..8,team=hostile,scores={GAMELEVEL=0..}]
execute store result score MOB_COUNT_ROUND_2 CAL if entity @e[distance=..4.99,team=hostile,scores={GAMELEVEL=0..}]
#damage cal round 1
...
#damage go
execute as @e[distance=5..8,team=hostile,scores={GAMELEVEL=0..}] at @s run function att2:gameplay/legendary/warlord/range_effect/damage_1 with storage att2:damage
execute as @e[distance=..4.99,team=hostile,scores={GAMELEVEL=0..}] at @s run function att2:gameplay/legendary/warlord/range_effect/damage_2 with storage att2:damage
#reset
