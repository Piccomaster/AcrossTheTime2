#################################################################
#Made by Adventquest							#
#quick recipe 8_org_ave_hal_gal_ehl
#################################################################

##Confirmed twice
scoreboard players set TEST CAL 0
execute unless score @s QUCIK_RECIPE matches 8 run function att2:dialogs/gameplay/runes/quick_recipe/sure
execute if score @s QUCIK_RECIPE matches 8 run scoreboard players set TEST CAL 1
scoreboard players set @s QUCIK_RECIPE 8
...
##give items
function att2:items/runes/words/8_org_ave_hal_gal_ehl
