...
execute if score #19_mot_syl_kan_xul_zen RUNE matches 1 as @a[distance=..40] at @s run function att2:dialogs/gameplay/runes/runicwords/19_mot_syl_kan_xul_zen
