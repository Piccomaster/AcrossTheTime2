...
##return ave
execute store result storage att2:score count int 1 run scoreboard players get #return_ave_count CAL
execute if score #return_ave_count CAL matches 1.. run loot spawn -5029 91 -4958 loot {"pools":[{"rolls":1,"entries":[{"type":"minecraft:item","name":"minecraft:glowstone_dust","functions":[{"function":"minecraft:set_components","components":{"minecraft:custom_name":{"translate":"item.rune.name.11"},"minecraft:lore":[{"translate":"item.rune.material"},{"translate":"item.rune.rarity.b"},{"translate":"item.rune.lvl.23"}],"max_stack_size":99,"minecraft:custom_data":{"EquipmentType":"rune","Rarity":"spe","Runelvl":11b},"minecraft:custom_model_data":{"floats":[10000012]},"minecraft:tooltip_style":"minecraft:rarity/rune/rune_medium"}},{function:set_count,count:{type:"storage",storage:"att2:score",path:"count"}}]}]}]}


##summon tracking_arrow_3
scoreboard players operation #obtain_arrow_count CAL *= 4 CAL
execute store result storage att2:score count int 1 run scoreboard players get #obtain_arrow_count CAL
loot spawn -5029 91 -4958 loot {"pools":[{"rolls":1,"entries":[{"type":"minecraft:item","name":"minecraft:arrow","functions":[{"function":"minecraft:set_components","components":{"custom_name":[{"translate":"att2.item.special_arrow.tracking_arrow_3.name"}],"lore":[{"translate":"att2.item.special_arrow.tracking_arrow_3.lore.1"},{"translate":"att2.item.special_arrow.tracking_arrow_3.lore.2"}],"custom_data":{"EquipmentType":"arrow","Rarity":"unc","tracking_arrow":3,"special_arrow":true},"enchantment_glint_override":false,"max_stack_size":99,"item_model":"arrows/tracking_arrow","tooltip_style":"minecraft:rarity/epi/epi"}},{function:set_count,count:{type:"storage",storage:"att2:score",path:"count"}}]}]}]}
