...
##3 : 1 nym -> explosion_arrow_1 x 2

#cal arrows
scoreboard players operation #obtain_arrow_count CAL = #explosive_arrow_1 RUNECOUNT
scoreboard players operation #return_arrow_count CAL = #explosive_arrow_1 RUNECOUNT

scoreboard players operation #obtain_arrow_count CAL /= 3 CAL

#cal nym
scoreboard players operation #return_nym_count CAL = #nym RUNECOUNT

#cal max
scoreboard players operation #obtain_arrow_count CAL < #nym RUNECOUNT
scoreboard players operation #return_nym_count CAL -= #obtain_arrow_count CAL
...
##return nym
execute store result storage att2:score count int 1 run scoreboard players get #return_nym_count CAL
execute if score #return_nym_count CAL matches 1.. run loot spawn -5029 91 -4958 loot {"pools":[{"rolls":1,"entries":[{"type":"minecraft:item","name":"minecraft:glowstone_dust","functions":[{"function":"minecraft:set_components","components":{"minecraft:custom_name":{"translate":"item.rune.name.6"},"minecraft:lore":[{"translate":"item.rune.material"},{"translate":"item.rune.rarity.c"},{"translate":"item.rune.lvl.13"}],"max_stack_size":99,"minecraft:custom_data":{"EquipmentType":"rune","Rarity":"spe","Runelvl":6b},"minecraft:custom_model_data":{"floats":[10000007]},"minecraft:tooltip_style":"minecraft:rarity/rune/rune_low"}},{function:set_count,count:{type:"storage",storage:"att2:score",path:"count"}}]}]}]}


##summon explosive_arrow_2
