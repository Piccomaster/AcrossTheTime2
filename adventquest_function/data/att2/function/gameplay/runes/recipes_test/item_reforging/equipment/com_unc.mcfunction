...
execute if score #equipment_id CAL matches 6 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 8..9 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 32..33 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 35..39 run scoreboard players set #test CAL 1
...
scoreboard players set #test CAL 0
execute if score #equipment_id CAL matches 107..114 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 223..224 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 226..230 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 273..280 run scoreboard players set #test CAL 1
...
execute if score #equipment_id CAL matches 35..39 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 176..183 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 333 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 335..339 run scoreboard players set #test CAL 1
execute if score #test CAL matches 1 run function att2:gameplay/runes/recipe_done
...
execute if score #equipment_id CAL matches 273 run scoreboard players set #test CAL 1
