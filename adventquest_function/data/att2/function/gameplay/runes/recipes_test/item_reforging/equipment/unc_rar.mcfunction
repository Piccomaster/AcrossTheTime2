...
execute if score #equipment_id CAL matches 10..13 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 40..47 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 56..63 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 82..89 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 115..122 run scoreboard players set #test CAL 1
...
execute if score #equipment_id CAL matches 382..389 run scoreboard players set #test CAL 1
...
execute if score #equipment_id CAL matches 351..352 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 359..360 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 375..376 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 383..384 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 391..392 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 411..418 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 450..451 run scoreboard players set #test CAL 1
execute if score #test CAL matches 1 run function att2:gameplay/runes/recipe_done
...
#angband
scoreboard players set #test CAL 0
execute if score #equipment_id CAL matches 144..151 run scoreboard players set #test CAL 1
...
execute if score #equipment_id CAL matches 367..368 run scoreboard players set #test CAL 1
execute if score #test CAL matches 1 run function att2:gameplay/runes/recipe_done
...
execute if score #equipment_id CAL matches 434..435 run scoreboard players set #test CAL 1
execute if score #test CAL matches 1 run function att2:gameplay/runes/recipe_done
...
execute if score #equipment_id CAL matches 442..443 run scoreboard players set #test CAL 1
execute if score #test CAL matches 1 run function att2:gameplay/runes/recipe_done
