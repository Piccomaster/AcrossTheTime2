...
execute if score #equipment_id CAL matches 14 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 16..17 run scoreboard players set #test CAL 1
...
execute if score #equipment_id CAL matches 64..67 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 200..203 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 210 run scoreboard players set #test CAL 1
execute if score #equipment_id CAL matches 212..213 run scoreboard players set #test CAL 1
execute if score #test CAL matches 1 run function att2:gameplay/runes/recipe_done
