...
execute if score #total_item RUNECOUNT = #total_item CAL if score #explosive_arrow_1 RUNECOUNT matches 4.. if score #nym RUNECOUNT matches 1.. run return run function att2:gameplay/runes/recipes_test/special_arrow/explosion_arrow_2
...
execute if score #total_item RUNECOUNT = #total_item CAL if score #explosive_arrow_2 RUNECOUNT matches 4.. if score #von RUNECOUNT matches 1.. run return run function att2:gameplay/runes/recipes_test/special_arrow/explosion_arrow_3
...
execute if score #total_item RUNECOUNT = #total_item CAL if score #poisoned_arrow_1 RUNECOUNT matches 4.. if score #inu RUNECOUNT matches 1.. run return run function att2:gameplay/runes/recipes_test/special_arrow/poisoned_arrow_2
...
execute if score #total_item RUNECOUNT = #total_item CAL if score #poisoned_arrow_2 RUNECOUNT matches 4.. if score #ehl RUNECOUNT matches 1.. run return run function att2:gameplay/runes/recipes_test/special_arrow/poisoned_arrow_3
...
execute if score #total_item RUNECOUNT = #total_item CAL if score #tracking_arrow_1 RUNECOUNT matches 4.. if score #hal RUNECOUNT matches 1.. run return run function att2:gameplay/runes/recipes_test/special_arrow/tracking_arrow_2
...
execute if score #total_item RUNECOUNT = #total_item CAL if score #tracking_arrow_2 RUNECOUNT matches 4.. if score #ave RUNECOUNT matches 1.. run return run function att2:gameplay/runes/recipes_test/special_arrow/tracking_arrow_3
