...
##set price
#rune powder
scoreboard players operation #temp_value_10 CAL = #3_fus PRICES
#esc count
scoreboard players operation #temp_value_11 CAL = #3_fus_esc PRICES
#return0
...
#give
execute if score #temp_value_13 CAL matches 1 run function att2:items/runes/3_fus
#reset
