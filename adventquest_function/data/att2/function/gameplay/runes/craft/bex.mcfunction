...
##set price
#rune powder 
scoreboard players operation temp_value_10 CAL = 20_bex PRICES
#esc count
scoreboard players operation temp_value_11 CAL = 20_bex_esc PRICES
#return0
...
#give
execute if score temp_value_13 CAL matches 1 run function att2:items/runes/20_bex
#reset
