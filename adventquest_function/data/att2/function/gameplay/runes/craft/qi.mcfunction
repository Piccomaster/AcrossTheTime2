...
##set price
#rune powder
scoreboard players operation #temp_value_10 CAL = #19_qi PRICES
#esc count
scoreboard players operation #temp_value_11 CAL = #19_qi_esc PRICES
#return0
...
#give
execute if score #temp_value_13 CAL matches 1 run function att2:items/runes/19_qi
#reset
