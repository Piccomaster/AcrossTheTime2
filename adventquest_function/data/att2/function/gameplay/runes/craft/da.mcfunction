...
##set price
#rune powder
scoreboard players operation temp_value_10 CAL = 15_da PRICES
#esc count
scoreboard players operation temp_value_11 CAL = 15_da_esc PRICES
#return0
...
#give
execute if score temp_value_13 CAL matches 1 run function att2:items/runes/15_da
#reset
