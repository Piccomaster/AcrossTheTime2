...
##set price
#rune powder
scoreboard players operation #temp_value_10 CAL = 26_zen PRICES
#esc count
scoreboard players operation #temp_value_11 CAL = 26_zen_esc PRICES
#return0
...
execute if score #temp_value_13 CAL matches 1 run clear @s quartz[custom_data={EquipmentType:'misc',Rarity:'unk',Coin:'esc'}] 2
execute if score #temp_value_13 CAL matches 1 run function att2:gameplay/runes/craft/craft_true
#give
execute if score #temp_value_13 CAL matches 1 run function att2:items/runes/26_zen
#reset
