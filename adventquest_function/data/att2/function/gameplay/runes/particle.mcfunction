...
execute if block ~ ~ ~ gold_block if items entity @s weapon.mainhand *[custom_data~{EquipmentType:runic_word}] at @s run return run particle minecraft:dust{color:[1,1,1],scale:0.3} ~ ~1.75 ~ 0.2 0.4 0.2 0 10 normal
