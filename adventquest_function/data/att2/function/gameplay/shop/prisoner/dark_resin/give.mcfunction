...
execute as @a[x=-5044,y=110,z=-4887,distance=..7] if score Eldric DARK_RESIN matches 1 run function att2:dialogs/others/eldric/dialog_4
execute as @a[x=-5044,y=110,z=-4887,distance=..7] if score Eldric DARK_RESIN matches 2..26 run function att2:dialogs/others/eldric/dialog_5
execute as @a[x=-5044,y=110,z=-4887,distance=..7] if score Eldric DARK_RESIN matches 27.. run function att2:dialogs/others/eldric/dialog_6
