...
execute if score #stock RUNE_POWDER matches 50.. at @s run function att2:gameplay/shop/effect
execute if score #stock RUNE_POWDER matches 50.. run function att2:items/chronoton/esc_give_maco {count:1}
