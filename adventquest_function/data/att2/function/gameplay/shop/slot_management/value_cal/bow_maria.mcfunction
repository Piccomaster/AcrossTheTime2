...
#set value
execute if entity @s[tag=ShotSlotHolder,tag=slot1] run scoreboard players operation bow_maria_slot1 SHOP_OP1 = @s SHOP_OP1
execute if entity @s[tag=ShotSlotHolder,tag=slot2] run scoreboard players operation bow_maria_slot2 SHOP_OP1 = @s SHOP_OP1
execute if entity @s[tag=ShotSlotHolder,tag=slot3] run scoreboard players operation bow_maria_slot3 SHOP_OP1 = @s SHOP_OP1
execute if entity @s[tag=ShotSlotHolder,tag=slot4] run scoreboard players operation bow_maria_slot4 SHOP_OP1 = @s SHOP_OP1
execute if entity @s[tag=ShotSlotHolder,tag=slot5] run scoreboard players operation bow_maria_slot5 SHOP_OP1 = @s SHOP_OP1
execute if entity @s[tag=ShotSlotHolder,tag=slot6] run scoreboard players operation bow_maria_slot6 SHOP_OP1 = @s SHOP_OP1
execute if entity @s[tag=ShotSlotHolder,tag=slot7] run scoreboard players operation bow_maria_slot7 SHOP_OP1 = @s SHOP_OP1
execute if entity @s[tag=ShotSlotHolder,tag=slot8] run scoreboard players operation bow_maria_slot8 SHOP_OP1 = @s SHOP_OP1
execute if entity @s[tag=ShotSlotHolder,tag=slot9] run scoreboard players operation bow_maria_slot9 SHOP_OP1 = @s SHOP_OP1
execute if entity @s[tag=ShotSlotHolder,tag=slot10] run scoreboard players operation bow_maria_slot10 SHOP_OP1 = @s SHOP_OP1
execute if entity @s[tag=ShotSlotHolder,tag=slot11] run scoreboard players operation bow_maria_slot11 SHOP_OP1 = @s SHOP_OP1
execute if entity @s[tag=ShotSlotHolder,tag=slot12] run scoreboard players operation bow_maria_slot12 SHOP_OP1 = @s SHOP_OP1