...
#shop tips
execute if score #value SHOP_OP matches 939.. at 00000000-0000-074a-0000-00000000074a as @a[distance=..7] run function att2:sound/shop/shop_cue

#set value
execute if score #slot SHOP_OP matches 1 run scoreboard players operation #weapon_carmine_mordan_slot1 SHOP_OP = #value SHOP_OP
execute if score #slot SHOP_OP matches 2 run scoreboard players operation #weapon_carmine_mordan_slot2 SHOP_OP = #value SHOP_OP
execute if score #slot SHOP_OP matches 3 run scoreboard players operation #weapon_carmine_mordan_slot3 SHOP_OP = #value SHOP_OP
execute if score #slot SHOP_OP matches 4 run scoreboard players operation #weapon_carmine_mordan_slot4 SHOP_OP = #value SHOP_OP
execute if score #slot SHOP_OP matches 5 run scoreboard players operation #weapon_carmine_mordan_slot5 SHOP_OP = #value SHOP_OP
execute if score #slot SHOP_OP matches 6 run scoreboard players operation #weapon_carmine_mordan_slot6 SHOP_OP = #value SHOP_OP
execute if score #slot SHOP_OP matches 7 run scoreboard players operation #weapon_carmine_mordan_slot7 SHOP_OP = #value SHOP_OP
execute if score #slot SHOP_OP matches 8 run scoreboard players operation #weapon_carmine_mordan_slot8 SHOP_OP = #value SHOP_OP