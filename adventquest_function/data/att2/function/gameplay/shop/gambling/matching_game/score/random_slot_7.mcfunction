...
#Potion_Count
execute if score RNG MatchingGame matches 6 run function att2:gameplay/shop/gambling/matching_game/score/slot/potion
#Spell_Count
execute if score RNG MatchingGame matches 7 run function att2:gameplay/shop/gambling/matching_game/score/slot/spell
...
##loop
execute if score Max_Slot MatchingGame matches 1.. run function att2:gameplay/shop/gambling/matching_game/score/random_slot_7