...
#cal chronotons
execute if score @s CHRONOTON < matching_game_form6 PRICES run return run function att2:dialogs/gameplay/shop/not_enough_chronotons
execute if score @s CHRONOTON >= matching_game_form6 PRICES run scoreboard players operation @s CHRONOTON -= matching_game_form6 PRICES
##get player score
execute store result storage att2:matching_game player int 1 run scoreboard players get @s NUMEROJOUEUR
#max = 6
scoreboard players set Max_Slot MatchingGame 36
#size = 6
