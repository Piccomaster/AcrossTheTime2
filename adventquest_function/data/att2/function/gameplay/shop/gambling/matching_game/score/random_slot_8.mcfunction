...
#random value get
execute store result score RNG MatchingGame run random value 1..8
...
#Food_count
execute if score RNG MatchingGame matches 6 run function att2:gameplay/shop/gambling/matching_game/score/slot/food
#Currency_Count
execute if score RNG MatchingGame matches 5 run function att2:gameplay/shop/gambling/matching_game/score/slot/currency
#Potion_Count
execute if score RNG MatchingGame matches 7 run function att2:gameplay/shop/gambling/matching_game/score/slot/potion
#Spell_Count
execute if score RNG MatchingGame matches 4 run function att2:gameplay/shop/gambling/matching_game/score/slot/spell
#Rune_Count
execute if score RNG MatchingGame matches 8 run function att2:gameplay/shop/gambling/matching_game/score/slot/rune
...
##loop
execute if score Max_Slot MatchingGame matches 1.. run function att2:gameplay/shop/gambling/matching_game/score/random_slot_8