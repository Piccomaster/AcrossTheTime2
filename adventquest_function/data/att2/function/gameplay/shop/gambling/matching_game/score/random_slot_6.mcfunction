...
#random value get
execute store result score RNG MatchingGame run random value 1..6
...
##loop
execute if score Max_Slot MatchingGame matches 1.. run function att2:gameplay/shop/gambling/matching_game/score/random_slot_6