...
scoreboard players operation #T CAL = MeleeWeapon_Count MatchingGame
...
##get c/t
scoreboard players operation #C CAL = @s MatchingGameId
scoreboard players operation #T CAL = RangeWeapon_Count MatchingGame
#scoreboard players operation #T CAL /= 2 CAL
scoreboard players operation #T CAL > 1 CAL
function att2:gameplay/misc/chesteffect/other_dropchance
...
##get c/t
scoreboard players operation #C CAL = @s MatchingGameId
scoreboard players operation #T CAL = Armor_Count MatchingGame
#scoreboard players operation #T CAL /= 2 CAL
scoreboard players operation #T CAL > 1 CAL
function att2:gameplay/misc/chesteffect/other_dropchance
...
##get c/t
scoreboard players operation #C CAL = @s MatchingGameId
scoreboard players operation #T CAL = Potion_Count MatchingGame
#scoreboard players operation #T CAL /= 2 CAL
scoreboard players operation #T CAL > 1 CAL
function att2:gameplay/misc/chesteffect/other_dropchance
...
##get c/t
scoreboard players operation #C CAL = @s MatchingGameId
scoreboard players operation #T CAL = Rune_Count MatchingGame
#scoreboard players operation #T CAL /= 2 CAL
scoreboard players operation #T CAL > 1 CAL
function att2:gameplay/misc/chesteffect/other_dropchance
