...
function att2:gameplay/shop/slot_management/showcase/bow_emera_palundra
...
execute if score level statSMITH matches 1.. run function att2:gameplay/shop/slot_management/showcase/bow_emera_palundra
execute if score level statSMITH matches 2.. run scoreboard players set #slot SHOP_OP 6
execute if score level statSMITH matches 2.. run function att2:gameplay/shop/slot_management/showcase/bow_emera_palundra
