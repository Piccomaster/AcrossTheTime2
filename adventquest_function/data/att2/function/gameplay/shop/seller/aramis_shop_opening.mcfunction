...
execute unless score Mainquest SIDEQUEST matches 300.. unless score TOTAL_SQ SIDEQUEST matches 59.. run function att2:dialogs/gameplay/shop/items_selled_list/secret_list

execute if score Mainquest SIDEQUEST matches 300.. if score TOTAL_SQ SIDEQUEST matches 59.. run function att2:dialogs/gameplay/shop/showcase/spell/soul_companion