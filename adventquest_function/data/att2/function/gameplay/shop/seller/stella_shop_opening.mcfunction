...
function att2:dialogs/gameplay/shop/showcase/spell/battle_companion
execute if score Mainquest SIDEQUEST matches 83.. run function att2:dialogs/gameplay/shop/showcase/spell/stock_upgrade
