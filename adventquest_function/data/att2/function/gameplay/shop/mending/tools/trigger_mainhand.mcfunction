...
execute if predicate att2_pre:test_hold/rarity/mainhand/epi if score @s TOOLS_EPI matches ..0 run function att2:dialogs/gameplay/shop/not_enough_tools_epi
