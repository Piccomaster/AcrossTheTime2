...
execute predicate att2_pre:test_hold/rarity/mainhand/com if score @s TOOLS_COM matches ..0 run function att2:dialogs/gameplay/shop/not_enough_tools_com
execute predicate att2_pre:test_hold/rarity/mainhand/unc if score @s TOOLS_UNC matches ..0 run function att2:dialogs/gameplay/shop/not_enough_tools_unc
execute predicate att2_pre:test_hold/rarity/mainhand/rar if score @s TOOLS_RAR matches ..0 run function att2:dialogs/gameplay/shop/not_enough_tools_rar
execute predicate att2_pre:test_hold/rarity/mainhand/epi_esc if score @s TOOLS_ESC matches ..0 run function att2:dialogs/gameplay/shop/not_enough_tools_esc
execute predicate att2_pre:test_hold/rarity/mainhand/epi if score @s TOOLS_EPI matches ..0 run function att2:dialogs/gameplay/shop/not_enough_tools_epi
execute predicate att2_pre:test_hold/rarity/mainhand/leg if score @s TOOLS_LEG matches ..0 run function att2:dialogs/gameplay/shop/not_enough_tools_leg
execute predicate att2_pre:test_hold/rarity/mainhand/ult if score @s TOOLS_ULT matches ..0 run function att2:dialogs/gameplay/shop/not_enough_tools_ult
