...
##set step
##
scoreboard players remove #temp CAL 1

##cal list id
#cal line
scoreboard players operation #MazeMapListId CAL = #z CAL
...
scoreboard players operation #list CAL = #temp CAL
...
execute if score #step CAL matches 1.. run function att2:gameplay/maze/map/update/west_loop