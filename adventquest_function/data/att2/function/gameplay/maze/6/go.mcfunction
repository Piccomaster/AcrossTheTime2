...
execute if score Timer MAZE matches 1.. as @e[type=minecraft:endermite,tag=LostSoul,x=-9683,y=79,z=-9866,dx=204,dy=8,dz=-297,limit=1] run function att2:gameplay/maze/6/minions_spread
