...
execute if score Timer MAZE matches 1.. as @e[type=minecraft:endermite,tag=LostSoul,x=-9947,y=79,z=-10085,dx=248,dy=8,dz=205,limit=1] run function att2:gameplay/maze/5/minions_spread
