...
execute if score Timer MAZE matches 1.. as @e[type=minecraft:endermite,tag=LostSoul,x=-9416,y=75,z=-10179,dx=-296,dy=5,dz=-260,limit=1] run function att2:gameplay/maze/7/minions_spread
