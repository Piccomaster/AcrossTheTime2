...
clear @s minecraft:brown_mushroom[custom_name={translate:'item.quest.edible_mushroom.name'}] 1
...
#clear textdisplay
execute if score intake_mushroom SQ4 matches 20.. positioned -5080 77 -5036 run kill @e[type=#minecraft:display_entity,distance=..5,tag=QUEST]