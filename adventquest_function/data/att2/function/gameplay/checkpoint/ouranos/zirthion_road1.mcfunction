...
execute in minecraft:overworld run spawnpoint @s 6980 110 7221

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned 6980 110 7221 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned 6980 110 7221 as @a[distance=..40] run spawnpoint @s 6980 110 7221
...
##show count
execute unless score Ouranos_road CHECKPOINT matches 20 positioned 6980 110 7221 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_ouranos_road,color:red},{text:":",color:gray},{score:{name:"Ouranos_road",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"20",color:dark_red},{text:"~",color:dark_red}]

execute unless score Ouranos_road1 CHECKPOINT matches 1 positioned 6980 110 7221 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
