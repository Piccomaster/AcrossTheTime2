...
execute in minecraft:overworld positioned 7707 107 5949 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned 7707 107 5949 as @a[distance=..40] run spawnpoint @s 7707 107 5949
