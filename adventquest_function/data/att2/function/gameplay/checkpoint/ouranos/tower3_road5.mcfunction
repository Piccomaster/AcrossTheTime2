...
execute in minecraft:overworld positioned 7711 182 6105 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned 7711 182 6105 as @a[distance=..40] run spawnpoint @s 7711 182 6105
