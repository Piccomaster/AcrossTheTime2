...
##show count
execute unless score Ouranos_cloud CHECKPOINT matches 10 positioned 7357 87 6661 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_ouranos_cloud,color:red},{text:":",color:gray},{score:{name:"Ouranos_cloud",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"10",color:dark_red},{text:"~",color:dark_red}]

execute unless score Ouranos_cloud1 CHECKPOINT matches 1 positioned 7357 87 6661 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
