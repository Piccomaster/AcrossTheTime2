...
execute in minecraft:overworld run spawnpoint @s 7637 84 6402

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned 7637 84 6402 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned 7637 84 6402 as @a[distance=..40] run spawnpoint @s 7637 84 6402
...
##show count
execute unless score Ouranos_road CHECKPOINT matches 20 positioned 7637 84 6402 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_ouranos_road,color:red},{text:":",color:gray},{score:{name:"Ouranos_road",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"20",color:dark_red},{text:"~",color:dark_red}]

execute unless score Ouranos_road12 CHECKPOINT matches 1 positioned 7637 84 6402 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
