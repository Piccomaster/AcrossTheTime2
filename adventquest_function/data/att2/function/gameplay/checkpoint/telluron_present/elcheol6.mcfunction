...
execute in minecraft:overworld positioned -5041 140 -6598 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -5041 140 -6598 as @a[distance=..40] run spawnpoint @s -5041 140 -6598
...
##show count
execute unless score Elcheol CHECKPOINT matches 17 positioned -5041 140 -6598 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_elcheol,color:red},{text:":",color:gray},{score:{name:"Elcheol",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"17",color:dark_red},{text:"~",color:dark_red}]

execute unless score Elcheol6 CHECKPOINT matches 1 positioned -5041 140 -6598 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
