...
execute in minecraft:overworld run spawnpoint @s -5678 141 -6369

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -5678 141 -6369 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -5678 141 -6369 as @a[distance=..40] run spawnpoint @s -5678 141 -6369
...
##show count
execute unless score Vonaheim CHECKPOINT matches 29 positioned -5678 141 -6369 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_vonaheim,color:red},{text:":",color:gray},{score:{name:"Vonaheim",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"29",color:dark_red},{text:"~",color:dark_red}]

execute unless score Vonaheim14 CHECKPOINT matches 1 positioned -5678 141 -6369 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
