...
execute in minecraft:overworld run spawnpoint @s -4311 3 -5194

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -4311 3 -5194 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -4311 3 -5194 as @a[distance=..40] run spawnpoint @s -4311 3 -5194
...
##show count
execute unless score Cave CHECKPOINT matches 9 positioned -4311 3 -5194 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_cave,color:red},{text:":",color:gray},{score:{name:"Cave",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"9",color:dark_red},{text:"~",color:dark_red}]

execute unless score Cave3 CHECKPOINT matches 1 positioned -4311 3 -5194 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
