...
##show count
execute unless score Eolorion CHECKPOINT matches 5 positioned -5343 107 -6292 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_eolorion,color:red},{text:":",color:gray},{score:{name:"Eolorion",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"5",color:dark_red},{text:"~",color:dark_red}]

execute unless score Eolorion2 CHECKPOINT matches 1 positioned -5343 107 -6292 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
