...
execute in minecraft:overworld run spawnpoint @s -4566 7 -5280

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -4566 7 -5280 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -4566 7 -5280 as @a[distance=..40] run spawnpoint @s -4566 7 -5280
...
##show count
execute unless score Cave CHECKPOINT matches 9 positioned -4566 7 -5280 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_cave,color:red},{text:":",color:gray},{score:{name:"Cave",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"9",color:dark_red},{text:"~",color:dark_red}]

execute unless score Cave2 CHECKPOINT matches 1 positioned -4566 7 -5280 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
