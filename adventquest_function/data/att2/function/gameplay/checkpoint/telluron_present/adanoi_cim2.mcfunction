...
execute in minecraft:overworld run spawnpoint @s -3950 85 -5577

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -3950 85 -5577 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -3950 85 -5577 as @a[distance=..40] run spawnpoint @s -3950 85 -5577
...
##show count
execute unless score Adanoi CHECKPOINT matches 4 positioned -3950 85 -5577 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_adanoi,color:red},{text:":",color:gray},{score:{name:"Adanoi",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"4",color:dark_red},{text:"~",color:dark_red}]

execute unless score Adanoi2 CHECKPOINT matches 1 positioned -3950 85 -5577 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
