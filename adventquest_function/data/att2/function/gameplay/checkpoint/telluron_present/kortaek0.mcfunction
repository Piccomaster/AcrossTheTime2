...
execute in minecraft:overworld run spawnpoint @s -5529 86 -4724

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -5529 86 -4724 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -5529 86 -4724 as @a[distance=..40] run spawnpoint @s -5529 86 -4724
...
##show count
execute unless score Kortaek CHECKPOINT matches 2 positioned -5529 86 -4724 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_kortaek,color:red},{text:":",color:gray},{score:{name:"Kortaek",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"2",color:dark_red},{text:"~",color:dark_red}]

execute unless score Kortaek0 CHECKPOINT matches 1 positioned -5529 86 -4724 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
