...
execute in minecraft:overworld positioned -5935 85 -4714 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -5935 85 -4714 as @a[distance=..40] run spawnpoint @s -5935 85 -4714
