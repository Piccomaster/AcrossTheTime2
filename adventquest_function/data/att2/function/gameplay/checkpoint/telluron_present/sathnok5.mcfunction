...
execute unless score Sathnok5 CHECKPOINT matches 1 positioned -6053 86 -4639 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
