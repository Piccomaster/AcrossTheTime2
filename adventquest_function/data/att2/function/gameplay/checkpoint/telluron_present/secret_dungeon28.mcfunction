...
##show count
execute unless score Secret_dungeon CHECKPOINT matches 29 positioned -5109 53 -4666 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_secret_dungeon,color:red},{text:":",color:gray},{score:{name:"Secret_dungeon",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"29",color:dark_red},{text:"~",color:dark_red}]

execute unless score Secret_dungeon28 CHECKPOINT matches 1 positioned -5109 53 -4666 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
