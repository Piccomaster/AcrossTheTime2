...
execute in minecraft:overworld positioned -5539 109 -6358 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -5539 109 -6358 as @a[distance=..40] run spawnpoint @s -5539 109 -6358
