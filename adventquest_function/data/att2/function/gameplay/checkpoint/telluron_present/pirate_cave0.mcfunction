...
execute in minecraft:overworld run spawnpoint @s -4257 3 -5074

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -4257 3 -5074 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -4257 3 -5074 as @a[distance=..40] run spawnpoint @s -4257 3 -5074
...
##show count
execute unless score Cave CHECKPOINT matches 9 positioned -4257 3 -5074 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_cave,color:red},{text:":",color:gray},{score:{name:"Cave",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"9",color:dark_red},{text:"~",color:dark_red}]

execute unless score Cave7 CHECKPOINT matches 1 positioned -4257 3 -5074 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
