...
execute in minecraft:overworld run spawnpoint @s -5553 72 -5154

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -5553 72 -5154 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -5553 72 -5154 as @a[distance=..40] run spawnpoint @s -5553 72 -5154
