...
##show count
execute unless score Cave CHECKPOINT matches 9 positioned -4277 22 -5394 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_cave,color:red},{text:":",color:gray},{score:{name:"Cave",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"9",color:dark_red},{text:"~",color:dark_red}]

execute unless score Cave5 CHECKPOINT matches 1 positioned -4277 22 -5394 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
