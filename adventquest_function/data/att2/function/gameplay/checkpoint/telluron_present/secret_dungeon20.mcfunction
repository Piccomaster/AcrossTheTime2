...
execute in minecraft:overworld run spawnpoint @s -4738 25 -6192

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -4738 25 -6192 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -4738 25 -6192 as @a[distance=..40] run spawnpoint @s -4738 25 -6192
...
##show count
execute unless score Secret_dungeon CHECKPOINT matches 29 positioned -4738 25 -6192 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_secret_dungeon,color:red},{text:":",color:gray},{score:{name:"Secret_dungeon",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"29",color:dark_red},{text:"~",color:dark_red}]

execute unless score Secret_dungeon20 CHECKPOINT matches 1 positioned -4738 25 -6192 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
