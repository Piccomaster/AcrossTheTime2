...
##show count
execute unless score Vonaheim CHECKPOINT matches 29 positioned -5675 78 -6355 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_vonaheim,color:red},{text:":",color:gray},{score:{name:"Vonaheim",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"29",color:dark_red},{text:"~",color:dark_red}]

execute unless score Vonaheim3 CHECKPOINT matches 1 positioned -5675 78 -6355 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
