...
execute in minecraft:overworld run spawnpoint @s -4922 89 -5524

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -4922 89 -5524 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -4922 89 -5524 as @a[distance=..40] run spawnpoint @s -4922 89 -5524
