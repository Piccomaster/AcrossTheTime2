...
execute in minecraft:overworld positioned -4026 69 -4322 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -4026 69 -4322 as @a[distance=..40] run spawnpoint @s -4026 69 -4322
...
##show count
execute unless score Lost_island CHECKPOINT matches 5 positioned -4026 69 -4322 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_lost_island,color:red},{text:":",color:gray},{score:{name:"Lost_island",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"5",color:dark_red},{text:"~",color:dark_red}]

execute unless score Lost_island2 CHECKPOINT matches 1 positioned -4026 69 -4322 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
