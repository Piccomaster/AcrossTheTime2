...
execute in minecraft:overworld run spawnpoint @s -3505 74 -5058

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -3505 74 -5058 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -3505 74 -5058 as @a[distance=..40] run spawnpoint @s -3505 74 -5058
