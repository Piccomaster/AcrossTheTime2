...
execute in minecraft:overworld run spawnpoint @s -4994 96 -4943

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -4994 96 -4943 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -4994 96 -4943 as @a[distance=..40] run spawnpoint @s -4994 96 -4943
...
##show count
execute unless score Ryliath CHECKPOINT matches 10 positioned -4994 96 -4943 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_ryliath,color:red},{text:":",color:gray},{score:{name:"Ryliath",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"10",color:dark_red},{text:"~",color:dark_red}]

execute unless score Ryliath3 CHECKPOINT matches 1 positioned -4994 96 -4943 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
