...
##show count
execute unless score Volcano CHECKPOINT matches 8 positioned -5548 126 -5434 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_volcano,color:red},{text:":",color:gray},{score:{name:"Volcano",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"8",color:dark_red},{text:"~",color:dark_red}]

execute unless score Volcano1 CHECKPOINT matches 1 positioned -5548 126 -5434 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
