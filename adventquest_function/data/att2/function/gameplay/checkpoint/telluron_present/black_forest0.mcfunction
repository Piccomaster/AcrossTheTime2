...
execute in minecraft:overworld positioned -4575 70 -5757 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -4575 70 -5757 as @a[distance=..40] run spawnpoint @s -4575 70 -5757
