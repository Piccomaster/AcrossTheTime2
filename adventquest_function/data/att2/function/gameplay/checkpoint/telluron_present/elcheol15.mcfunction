...
execute in minecraft:overworld run spawnpoint @s -5065 91 -6198

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -5065 91 -6198 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -5065 91 -6198 as @a[distance=..40] run spawnpoint @s -5065 91 -6198
...
##show count
execute unless score Elcheol CHECKPOINT matches 17 positioned -5065 91 -6198 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_elcheol,color:red},{text:":",color:gray},{score:{name:"Elcheol",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"17",color:dark_red},{text:"~",color:dark_red}]

execute unless score Elcheol15 CHECKPOINT matches 1 positioned -5065 91 -6198 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
