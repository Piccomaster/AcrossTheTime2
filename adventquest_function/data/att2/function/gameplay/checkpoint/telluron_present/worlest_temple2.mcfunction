...
execute in minecraft:overworld positioned -4595 73 -5494 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -4595 73 -5494 as @a[distance=..40] run spawnpoint @s -4595 73 -5494
