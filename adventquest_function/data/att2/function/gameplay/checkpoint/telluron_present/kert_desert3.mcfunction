...
execute in minecraft:overworld run spawnpoint @s -5509 99 -4401

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -5509 99 -4401 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -5509 99 -4401 as @a[distance=..40] run spawnpoint @s -5509 99 -4401
...
##show count
execute unless score Kert CHECKPOINT matches 10 positioned -5509 99 -4401 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_kert,color:red},{text:":",color:gray},{score:{name:"Kert",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"10",color:dark_red},{text:"~",color:dark_red}]

execute unless score Kert3 CHECKPOINT matches 1 positioned -5509 99 -4401 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
