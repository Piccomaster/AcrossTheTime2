...
##show count
execute unless score Owsastr CHECKPOINT matches 13 positioned -4736 70 -4445 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_owsastr,color:red},{text:":",color:gray},{score:{name:"Owsastr",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"13",color:dark_red},{text:"~",color:dark_red}]

execute unless score Owsastr5 CHECKPOINT matches 1 positioned -4736 70 -4445 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
