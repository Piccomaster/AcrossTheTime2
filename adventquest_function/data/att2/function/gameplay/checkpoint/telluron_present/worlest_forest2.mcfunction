...
execute in minecraft:overworld positioned -4857 74 -5086 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -4857 74 -5086 as @a[distance=..40] run spawnpoint @s -4857 74 -5086
