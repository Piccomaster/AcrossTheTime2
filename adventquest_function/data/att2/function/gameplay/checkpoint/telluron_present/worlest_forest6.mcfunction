...
execute in minecraft:overworld positioned -5388 71 -5292 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -5388 71 -5292 as @a[distance=..40] run spawnpoint @s -5388 71 -5292
