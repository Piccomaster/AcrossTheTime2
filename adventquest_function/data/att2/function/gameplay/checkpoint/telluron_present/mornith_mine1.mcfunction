...
execute in minecraft:overworld positioned -4206 59 -6109 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -4206 59 -6109 as @a[distance=..40] run spawnpoint @s -4206 59 -6109
...
##show count
execute unless score Mornith CHECKPOINT matches 8 positioned -4206 59 -6109 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_mornith,color:red},{text:":",color:gray},{score:{name:"Mornith",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"8",color:dark_red},{text:"~",color:dark_red}]

execute unless score Mornith1 CHECKPOINT matches 1 positioned -4206 59 -6109 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
