...
execute in minecraft:the_end run spawnpoint @s -914 117 -616

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:the_end positioned -914 117 -616 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:the_end positioned -914 117 -616 as @a[distance=..40] run spawnpoint @s -914 117 -616
