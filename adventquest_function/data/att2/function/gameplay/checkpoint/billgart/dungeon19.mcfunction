...
##show count
execute unless score Billgart_dungeon CHECKPOINT matches 39 positioned -1356 126 -667 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_billgart_dungeon,color:red},{text:":",color:gray},{score:{name:"Billgart_dungeon",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"39",color:dark_red},{text:"~",color:dark_red}]

execute unless score Billgart_dungeon18 CHECKPOINT matches 1 positioned -1356 126 -667 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
