...
execute in minecraft:overworld run spawnpoint @s -7511 156 -4292

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:overworld positioned -7511 156 -4292 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -7511 156 -4292 as @a[distance=..40] run spawnpoint @s -7511 156 -4292
...
##show count
execute unless score Nojelanth_past CHECKPOINT matches 17 positioned -7511 156 -4292 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_nojelanth_past,color:red},{text:":",color:gray},{score:{name:"Nojelanth_past",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"17",color:dark_red},{text:"~",color:dark_red}]

execute unless score Nojelanth_past7 CHECKPOINT matches 1 positioned -7511 156 -4292 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
