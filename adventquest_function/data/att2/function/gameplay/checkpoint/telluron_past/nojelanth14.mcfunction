...
##show count
execute unless score Nojelanth_past CHECKPOINT matches 17 positioned -7620 14 -4225 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_nojelanth_past,color:red},{text:":",color:gray},{score:{name:"Nojelanth_past",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"17",color:dark_red},{text:"~",color:dark_red}]

execute unless score Nojelanth_past14 CHECKPOINT matches 1 positioned -7620 14 -4225 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
