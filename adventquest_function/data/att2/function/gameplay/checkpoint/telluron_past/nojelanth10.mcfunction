...
execute in minecraft:overworld positioned -7676 30 -4185 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:overworld positioned -7676 30 -4185 as @a[distance=..40] run spawnpoint @s -7676 30 -4185
