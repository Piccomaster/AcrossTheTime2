...
##show count
execute unless score Angor_palace CHECKPOINT matches 18 positioned 3478 36 4482 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_angor_palace,color:red},{text:":",color:gray},{score:{name:"Angor_palace",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"18",color:dark_red},{text:"~",color:dark_red}]

execute unless score Angor_palace1 CHECKPOINT matches 1 positioned 3478 36 4482 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
