...
##show count
execute unless score Angor CHECKPOINT matches 19 positioned 3441 34 4434 run tellraw @a[distance=..40] [{text:"~",color:dark_red},{translate:att2.advancement.journey.title.checkpoint_angor,color:red},{text:":",color:gray},{score:{name:"Angor",objective:"CHECKPOINT"},color:red},{text:"/",color:gray},{text:"19",color:dark_red},{text:"~",color:dark_red}]

execute unless score Angor5 CHECKPOINT matches 1 positioned 3441 34 4434 run tellraw @a[distance=..40] [{translate:att2.checkpoint.trigger.new,color:green}]
