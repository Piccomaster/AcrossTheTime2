...
execute in minecraft:the_nether run spawnpoint @s 3446 30 3834

## This command ensures that when a player manually triggers a respawn point, nearby players' respawn points are also reset.
execute in minecraft:the_nether positioned 3446 30 3834 as @a[distance=..40] run function att2:gameplay/checkpoint/effect
execute in minecraft:the_nether positioned 3446 30 3834 as @a[distance=..40] run spawnpoint @s 3446 30 3834
