...
execute if score timer WAYPOINT matches 5 as @e[type=!minecraft:item,tag=!ROAD_MARKER,x=756,y=81,z=843,distance=..5] at @s run function att2:gameplay/waypoint/tp_launch
...
execute if score Asunark_launch WAYPOINT matches 1.. if score timer WAYPOINT matches 10 as @e[type=!minecraft:item,type=!minecraft:player,tag=!ROAD_MARKER,x=-3661,y=70,z=-4977,distance=..5] at @s run tp @s 756 81 843
...
execute if score Eolorion_launch WAYPOINT matches 1.. if score timer WAYPOINT matches 10 as @e[type=!minecraft:item,type=!minecraft:player,tag=!ROAD_MARKER,x=-5248,y=100,z=-6202,distance=..5] at @s run tp @s 756 81 843
...
execute if score Kortaek_launch WAYPOINT matches 1.. if score timer WAYPOINT matches 10 as @e[type=!minecraft:item,type=!minecraft:player,tag=!ROAD_MARKER,x=-5533,y=87,z=-4678,distance=..5] at @s run tp @s 756 81 843
...
execute if score Meleim_launch WAYPOINT matches 1.. if score timer WAYPOINT matches 10 as @e[type=!minecraft:item,type=!minecraft:player,tag=!ROAD_MARKER,x=-3845,y=103,z=-5808,distance=..5] at @s run tp @s 756 81 843
...
execute if score Owsastr_launch WAYPOINT matches 1.. if score timer WAYPOINT matches 10 as @e[type=!minecraft:item,type=!minecraft:player,tag=!ROAD_MARKER,x=-4661,y=71,z=-4546,distance=..5] at @s run tp @s 756 81 843
...
execute if score Ryliath_launch WAYPOINT matches 1.. if score timer WAYPOINT matches 10 as @e[type=!minecraft:item,type=!minecraft:player,tag=!ROAD_MARKER,x=-5005,y=77,z=-5077,distance=..5] at @s run tp @s 756 81 843
...
execute if score Soquai_launch WAYPOINT matches 1.. if score timer WAYPOINT matches 10 as @e[type=!minecraft:item,type=!minecraft:player,tag=!ROAD_MARKER,x=-4790,y=100,z=-5686,distance=..5] at @s run tp @s 756 81 843
