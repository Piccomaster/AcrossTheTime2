...
##once tutorial
execute positioned -3845 102 -5808 as @a[distance=..10,advancements={att2:tutorial/trigger/waypoint=false}] run function att2:gameplay/tutorial/delay/waypoint