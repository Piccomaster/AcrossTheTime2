...
#test entity dialog
execute if score celestine_PNJ DIALOG matches 1..1 run function att2:dialogs/others/celestine/dialog_1

#Activation entity head movement
scoreboard players set 00000000-0000-123a-0000-00000000123a TALKING 1
scoreboard players set 00000000-0000-123a-0000-00000000123a PNJID 28
scoreboard players set 00000000-0000-123a-0000-00000000123a TALKING_TIMER 300

scoreboard players set @s PNJID 28
