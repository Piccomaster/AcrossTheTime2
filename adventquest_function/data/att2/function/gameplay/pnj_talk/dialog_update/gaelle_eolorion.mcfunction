...
#test entity dialog
execute if score gaelle_eolorion_PNJ DIALOG matches 1..1 run function att2:dialogs/others/gaelle_eolorion/dialog_1

#Activation entity head movement
scoreboard players set 00000000-0000-073c-0000-00000000073a TALKING 1
scoreboard players set 00000000-0000-073c-0000-00000000073a PNJID 57
scoreboard players set 00000000-0000-073c-0000-00000000073a TALKING_TIMER 300

scoreboard players set @s PNJID 57
