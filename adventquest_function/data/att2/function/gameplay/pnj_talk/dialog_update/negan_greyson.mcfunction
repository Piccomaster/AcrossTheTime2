...
#test entity dialog
execute if score negan_greyson_PNJ DIALOG matches 1..1 run function att2:dialogs/others/negan_greyson/dialog_1

#Activation entity head movement
scoreboard players set 00000000-0000-025a-0000-00000000025a TALKING 1
scoreboard players set 00000000-0000-025a-0000-00000000025a PNJID 101
scoreboard players set 00000000-0000-025a-0000-00000000025a TALKING_TIMER 300

scoreboard players set @s PNJID 101
