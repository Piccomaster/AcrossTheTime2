...
#test entity dialog
execute if score kelmyia_PNJ DIALOG matches 1..1 run function att2:dialogs/others/kelmyia/dialog_1

#Activation entity head movement
scoreboard players set 00000000-0000-017a-0000-00000000017a TALKING 1
scoreboard players set 00000000-0000-017a-0000-00000000017a PNJID 86
scoreboard players set 00000000-0000-017a-0000-00000000017a TALKING_TIMER 300

scoreboard players set @s PNJID 86
