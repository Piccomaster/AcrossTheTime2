...
#test entity dialog
execute if score ryliath_guard_1_PNJ DIALOG matches 1..1 run function att2:dialogs/others/ryliath_guard_1/dialog_1

#Activation entity head movement
scoreboard players set 00000000-0000-102a-0000-00000000102a TALKING 1
scoreboard players set 00000000-0000-102a-0000-00000000102a PNJID 122
scoreboard players set 00000000-0000-102a-0000-00000000102a TALKING_TIMER 300

scoreboard players set @s PNJID 122
