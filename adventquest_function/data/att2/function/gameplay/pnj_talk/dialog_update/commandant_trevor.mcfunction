...
#test entity dialog
execute if score commandant_trevor_PNJ DIALOG matches 1 run function att2:dialogs/sidequest/sq30/commandant_trevor/dialog_1

#Activation entity head movement
scoreboard players set 00000000-0000-097a-0000-00000000097a TALKING 1
scoreboard players set 00000000-0000-097a-0000-00000000097a PNJID 34
scoreboard players set 00000000-0000-097a-0000-00000000097a TALKING_TIMER 300

scoreboard players set @s PNJID 34
