...
#test entity dialog
execute if score miguel_PNJ DIALOG matches 1..1 run function att2:dialogs/others/miguel/dialog_1

#Activation entity head movement
scoreboard players set 00000000-0000-143a-0000-00000000143a TALKING 1
scoreboard players set 00000000-0000-143a-0000-00000000143a PNJID 98
scoreboard players set 00000000-0000-143a-0000-00000000143a TALKING_TIMER 300

scoreboard players set @s PNJID 98
