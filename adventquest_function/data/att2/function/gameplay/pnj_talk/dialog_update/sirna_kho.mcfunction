...
#test entity dialog
execute if score sirna_kho_PNJ DIALOG matches 1..1 run function att2:dialogs/others/sirna_kho/dialog_1

#Activation entity head movement
scoreboard players set 00000000-0000-021a-0000-00000000021a TALKING 1
scoreboard players set 00000000-0000-021a-0000-00000000021a PNJID 127
scoreboard players set 00000000-0000-021a-0000-00000000021a TALKING_TIMER 300

scoreboard players set @s PNJID 127
