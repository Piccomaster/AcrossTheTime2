...
#test entity dialog
execute if score charles_PNJ DIALOG matches 1 run function att2:dialogs/others/charles/dialog_1
execute if score charles_PNJ DIALOG matches 1 run function att2:dialogs/others/charles/dialog_2

#Activation entity head movement
scoreboard players set 00000000-0000-147a-0000-00000000147a TALKING 1
scoreboard players set 00000000-0000-147a-0000-00000000147a PNJID 29
scoreboard players set 00000000-0000-147a-0000-00000000147a TALKING_TIMER 300

scoreboard players set @s PNJID 29
