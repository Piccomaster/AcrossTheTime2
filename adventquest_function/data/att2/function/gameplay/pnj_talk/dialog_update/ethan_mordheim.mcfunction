...
#test entity dialog
execute if score ethan_mordheim_PNJ DIALOG matches 1..1 run function att2:dialogs/others/ethan_mordheim/dialog_1

#Activation entity head movement
scoreboard players set 00000000-0000-078a-0000-00000000078a TALKING 1
scoreboard players set 00000000-0000-078a-0000-00000000078a PNJID 49
scoreboard players set 00000000-0000-078a-0000-00000000078a TALKING_TIMER 300

scoreboard players set @s PNJID 49
