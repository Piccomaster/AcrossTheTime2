...
#test entity dialog
execute if score golem_buyer_PNJ DIALOG matches 1..1 run function att2:dialogs/others/golem/dialog_1

#Activation entity head movement
scoreboard players set 00000000-0000-145a-0000-00000000145a TALKING 1
scoreboard players set 00000000-0000-145a-0000-00000000145a PNJID 65
scoreboard players set 00000000-0000-145a-0000-00000000145a TALKING_TIMER 300

scoreboard players set @s PNJID 65
