...
#test entity dialog
execute if score jade_rozaell_PNJ DIALOG matches 1..1 run function att2:dialogs/others/jade_rozaell/dialog_1

#Activation entity head movement
scoreboard players set 00000000-0000-152a-0000-00000000152a TALKING 1
scoreboard players set 00000000-0000-152a-0000-00000000152a PNJID 81
scoreboard players set 00000000-0000-152a-0000-00000000152a TALKING_TIMER 300

scoreboard players set @s PNJID 81
