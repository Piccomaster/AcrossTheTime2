...
#test entity dialog
execute if score barry_PNJ DIALOG matches 1 run function att2:dialogs/others/barry/dialog_1

#Activation entity head movement
scoreboard players set 00000000-0000-154a-0000-00000000154a TALKING 1
scoreboard players set 00000000-0000-154a-0000-00000000154a PNJID 17
scoreboard players set 00000000-0000-154a-0000-00000000154a TALKING_TIMER 300

scoreboard players set @s PNJID 17
