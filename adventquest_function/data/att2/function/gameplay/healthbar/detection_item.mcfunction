...
#back value display
execute as @n[distance=..0.1,type=text_display,tag=VALUE,tag=HP_BAR] at @s unless score @s HP_DIS_TIMER matches 1.. run function att2:gameplay/healthbar/detection_text