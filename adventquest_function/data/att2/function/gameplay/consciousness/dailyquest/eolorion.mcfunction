...
execute if score eolorion_dailyquest_1 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.eolorion.1.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3310"},width:150}
##show time
scoreboard players operation #minutes CAL = eolorion_dailyquest_1_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = eolorion_dailyquest_1_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score eolorion_dailyquest_1 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score eolorion_dailyquest_1 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score eolorion_dailyquest_2 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.eolorion.2.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3311"},width:150}
##show time
scoreboard players operation #minutes CAL = eolorion_dailyquest_2_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = eolorion_dailyquest_2_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score eolorion_dailyquest_2 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score eolorion_dailyquest_2 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score eolorion_dailyquest_3 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.eolorion.3.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3312"},width:150}
##show time
scoreboard players operation #minutes CAL = eolorion_dailyquest_3_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = eolorion_dailyquest_3_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score eolorion_dailyquest_3 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score eolorion_dailyquest_3 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score eolorion_dailyquest_4 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.eolorion.4.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3313"},width:150}
##show time
scoreboard players operation #minutes CAL = eolorion_dailyquest_4_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = eolorion_dailyquest_4_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score eolorion_dailyquest_4 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score eolorion_dailyquest_4 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = eolorion_dailyquest_5_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score eolorion_dailyquest_5 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score eolorion_dailyquest_5 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score eolorion_dailyquest_6 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.eolorion.6.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3315"},width:150}
##show time
scoreboard players operation #minutes CAL = eolorion_dailyquest_6_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = eolorion_dailyquest_6_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score eolorion_dailyquest_6 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score eolorion_dailyquest_6 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score eolorion_dailyquest_7 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.eolorion.7.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3316"},width:150}
##show time
scoreboard players operation #minutes CAL = eolorion_dailyquest_7_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = eolorion_dailyquest_7_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score eolorion_dailyquest_7 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score eolorion_dailyquest_7 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score eolorion_dailyquest_8 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.eolorion.8.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3317"},width:150}
##show time
scoreboard players operation #minutes CAL = eolorion_dailyquest_8_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = eolorion_dailyquest_8_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score eolorion_dailyquest_8 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score eolorion_dailyquest_8 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score eolorion_dailyquest_9 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.eolorion.9.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3318"},width:150}
##show time
scoreboard players operation #minutes CAL = eolorion_dailyquest_9_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = eolorion_dailyquest_9_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score eolorion_dailyquest_9 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score eolorion_dailyquest_9 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score eolorion_dailyquest_10 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.eolorion.10.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3319"},width:150}
##show time
scoreboard players operation #minutes CAL = eolorion_dailyquest_10_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = eolorion_dailyquest_10_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score eolorion_dailyquest_10 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score eolorion_dailyquest_10 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
