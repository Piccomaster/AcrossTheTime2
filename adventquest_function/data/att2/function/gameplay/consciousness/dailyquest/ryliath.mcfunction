...
execute if score ryliath_dailyquest_1 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.ryliath.1.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3287"},width:150}
##show time
scoreboard players operation #minutes CAL = ryliath_dailyquest_1_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = ryliath_dailyquest_1_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score ryliath_dailyquest_1 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score ryliath_dailyquest_1 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score ryliath_dailyquest_2 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.ryliath.2.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3288"},width:150}
##show time
scoreboard players operation #minutes CAL = ryliath_dailyquest_2_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = ryliath_dailyquest_2_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score ryliath_dailyquest_2 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score ryliath_dailyquest_2 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score ryliath_dailyquest_3 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.ryliath.3.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3289"},width:150}
##show time
scoreboard players operation #minutes CAL = ryliath_dailyquest_3_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = ryliath_dailyquest_3_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score ryliath_dailyquest_3 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score ryliath_dailyquest_3 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score ryliath_dailyquest_4 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.ryliath.4.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3290"},width:150}
##show time
scoreboard players operation #minutes CAL = ryliath_dailyquest_4_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = ryliath_dailyquest_4_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score ryliath_dailyquest_4 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score ryliath_dailyquest_4 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score ryliath_dailyquest_5 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.ryliath.5.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3291"},width:150}
##show time
scoreboard players operation #minutes CAL = ryliath_dailyquest_5_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = ryliath_dailyquest_5_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score ryliath_dailyquest_5 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score ryliath_dailyquest_5 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score ryliath_dailyquest_6 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.ryliath.6.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3292"},width:150}
##show time
scoreboard players operation #minutes CAL = ryliath_dailyquest_6_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = ryliath_dailyquest_6_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score ryliath_dailyquest_6 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score ryliath_dailyquest_6 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score ryliath_dailyquest_7 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.ryliath.7.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3293"},width:150}
##show time
scoreboard players operation #minutes CAL = ryliath_dailyquest_7_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = ryliath_dailyquest_7_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score ryliath_dailyquest_7 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score ryliath_dailyquest_7 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score ryliath_dailyquest_8 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.ryliath.8.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3294"},width:150}
##show time
scoreboard players operation #minutes CAL = ryliath_dailyquest_8_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = ryliath_dailyquest_8_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score ryliath_dailyquest_8 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score ryliath_dailyquest_8 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score ryliath_dailyquest_9 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.ryliath.9.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3295"},width:150}
##show time
scoreboard players operation #minutes CAL = ryliath_dailyquest_9_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = ryliath_dailyquest_9_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score ryliath_dailyquest_9 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score ryliath_dailyquest_9 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score ryliath_dailyquest_10 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.ryliath.10.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3296"},width:150}
##show time
scoreboard players operation #minutes CAL = ryliath_dailyquest_10_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = ryliath_dailyquest_10_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score ryliath_dailyquest_10 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score ryliath_dailyquest_10 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score ryliath_dailyquest_11 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.ryliath.11.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3297"},width:150}
##show time
scoreboard players operation #minutes CAL = ryliath_dailyquest_11_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = ryliath_dailyquest_11_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score ryliath_dailyquest_11 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score ryliath_dailyquest_11 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score ryliath_dailyquest_12 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.ryliath.12.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3298"},width:150}
##show time
scoreboard players operation #minutes CAL = ryliath_dailyquest_12_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = ryliath_dailyquest_12_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score ryliath_dailyquest_12 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score ryliath_dailyquest_12 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
...
execute if score ryliath_dailyquest_13 DAILYQUEST matches 1..99 run data modify storage att2:dialog dailyquest append value {label:{translate:"att2.dailyquest.ryliath.13.name",color:"yellow"},tooltip:[{translate:"att2.dailyquest.assistance.click.tip",color:"yellow"},{translate:att2.dailyquest.remaining_time,with:[0,0],color:white}],action:{type:"run_command",command:"trigger ScoreTrigger set 3299"},width:150}
##show time
scoreboard players operation #minutes CAL = ryliath_dailyquest_13_timer DAILYQUEST
scoreboard players operation #minutes CAL /= 20 CAL
scoreboard players operation #minutes CAL /= 60 CAL
scoreboard players operation #second CAL = ryliath_dailyquest_13_timer DAILYQUEST
scoreboard players operation #second CAL /= 20 CAL
scoreboard players operation #second CAL %= 60 CAL
execute if score ryliath_dailyquest_13 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[0] int 1 run scoreboard players get #minutes CAL
execute if score ryliath_dailyquest_13 DAILYQUEST matches 1..99 store result storage att2:dialog dailyquest[-1].tooltip[-1].with[1] int 1 run scoreboard players get #second CAL
