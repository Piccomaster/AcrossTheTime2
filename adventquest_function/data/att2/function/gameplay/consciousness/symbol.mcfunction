...
##reset
data modify storage att2:dialog symbol set value []

# Academy_past
execute store result storage att2:dialog now_count int 1 run scoreboard players get Academy_past SYMBOL
data modify storage att2:dialog total_count set value 31
data modify storage att2:dialog color set value "yellow"
execute if score Academy_past SYMBOL matches 31.. run data modify storage att2:dialog color set value "green"
data modify storage att2:dialog id set value "academy_past"
...
#get now_count
execute store result storage att2:dialog now_count int 1 run scoreboard players get Exploration SYMBOL

##show_dialog
function att2:gameplay/consciousness/symbol_show with storage att2:dialog