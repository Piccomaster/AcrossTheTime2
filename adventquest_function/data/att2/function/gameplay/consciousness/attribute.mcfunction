...
execute unless score @s STR_FO matches 0 run function att2:any_function/execute {function:['execute store result storage att2:dialog point int 1 run scoreboard players get @s STR_FO','execute if score @s STR_FO matches 1.. run data modify storage att2:dialog color set value "green"','execute if score @s STR_FO matches ..-1 run data modify storage att2:dialog color set value "red"','data modify storage att2:dialog type set value "food"','function att2:gameplay/consciousness/insert/attribute_point_data with storage att2:dialog']}
...
execute unless score @s STR_LE matches 0 run function att2:any_function/execute {function:['execute store result storage att2:dialog point int 1 run scoreboard players get @s STR_LE','execute if score @s STR_LE matches 1.. run data modify storage att2:dialog color set value "green"','execute if score @s STR_LE matches ..-1 run data modify storage att2:dialog color set value "red"','data modify storage att2:dialog type set value "legendary"','function att2:gameplay/consciousness/insert/attribute_point_data with storage att2:dialog']}
##insert
...
execute unless score @s RES_LE matches 0 run function att2:any_function/execute {function:['execute store result storage att2:dialog point int 1 run scoreboard players get @s RES_LE','execute if score @s RES_LE matches 1.. run data modify storage att2:dialog color set value "green"','execute if score @s RES_LE matches ..-1 run data modify storage att2:dialog color set value "red"','data modify storage att2:dialog type set value "legendary"','function att2:gameplay/consciousness/insert/attribute_point_data with storage att2:dialog']}
##insert
...
execute unless score @s HAS_LE matches 0 run function att2:any_function/execute {function:['execute store result storage att2:dialog point int 1 run scoreboard players get @s HAS_LE','execute if score @s HAS_LE matches 1.. run data modify storage att2:dialog color set value "green"','execute if score @s HAS_LE matches ..-1 run data modify storage att2:dialog color set value "red"','data modify storage att2:dialog type set value "legendary"','function att2:gameplay/consciousness/insert/attribute_point_data with storage att2:dialog']}
##insert
...
execute unless score @s SPD_LE matches 0 run function att2:any_function/execute {function:['execute store result storage att2:dialog point int 1 run scoreboard players get @s SPD_LE','execute if score @s SPD_LE matches 1.. run data modify storage att2:dialog color set value "green"','execute if score @s SPD_LE matches ..-1 run data modify storage att2:dialog color set value "red"','data modify storage att2:dialog type set value "legendary"','function att2:gameplay/consciousness/insert/attribute_point_data with storage att2:dialog']}
##insert
...
execute unless score @s HER_LE matches 0 run function att2:any_function/execute {function:['execute store result storage att2:dialog point int 1 run scoreboard players get @s HER_LE','execute if score @s HER_LE matches 1.. run data modify storage att2:dialog color set value "green"','execute if score @s HER_LE matches ..-1 run data modify storage att2:dialog color set value "red"','data modify storage att2:dialog type set value "legendary"','function att2:gameplay/consciousness/insert/attribute_point_data with storage att2:dialog']}
##insert
...
execute unless score @s DAR_LE matches 0 run function att2:any_function/execute {function:['execute store result storage att2:dialog point int 1 run scoreboard players get @s DAR_LE','execute if score @s DAR_LE matches 1.. run data modify storage att2:dialog color set value "green"','execute if score @s DAR_LE matches ..-1 run data modify storage att2:dialog color set value "red"','data modify storage att2:dialog type set value "legendary"','function att2:gameplay/consciousness/insert/attribute_point_data with storage att2:dialog']}
##insert
...
execute unless score @s LUC_LE matches 0 run function att2:any_function/execute {function:['execute store result storage att2:dialog point int 1 run scoreboard players get @s LUC_LE','execute if score @s LUC_LE matches 1.. run data modify storage att2:dialog color set value "green"','execute if score @s LUC_LE matches ..-1 run data modify storage att2:dialog color set value "red"','data modify storage att2:dialog type set value "legendary"','function att2:gameplay/consciousness/insert/attribute_point_data with storage att2:dialog']}
##insert
...
execute unless score @s HUN_LE matches 0 run function att2:any_function/execute {function:['execute store result storage att2:dialog point int 1 run scoreboard players get @s HUN_LE','execute if score @s HUN_LE matches 1.. run data modify storage att2:dialog color set value "green"','execute if score @s HUN_LE matches ..-1 run data modify storage att2:dialog color set value "red"','data modify storage att2:dialog type set value "legendary"','function att2:gameplay/consciousness/insert/attribute_point_data with storage att2:dialog']}
##insert
