...
dialog show @a {type:"minecraft:multi_action",pause:false,columns:2,after_action:none,body:{type:plain_message,contents:{translate:consciousness.camera_shake.title,color:"#155DFC"}},title:"",actions:[{label:{translate:"这是啥嘛",hover_event:{action:show_text,value:"测试"}}}]}