...
$data modify storage att2:dialog player_infor append value {label:{text:"$(dahalmax)",color:"dark_red"},action:{type:run_command,command:"trigger ScoreTrigger set 2314"},width:100}
