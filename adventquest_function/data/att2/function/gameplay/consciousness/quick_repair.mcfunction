...
execute if predicate att2_pre:test_hold/rarity/head/epi_esc if score @s TOOLS_ESC matches 1.. run data modify storage att2:dialog color set value "green"
...
execute if predicate att2_pre:test_hold/rarity/chest/epi_esc if score @s TOOLS_ESC matches 1.. run data modify storage att2:dialog color set value "green"
...
execute if predicate att2_pre:test_hold/rarity/legs/epi_esc if score @s TOOLS_ESC matches 1.. run data modify storage att2:dialog color set value "green"
...
execute if predicate att2_pre:test_hold/rarity/feet/epi_esc if score @s TOOLS_ESC matches 1.. run data modify storage att2:dialog color set value "green"
...
execute if predicate att2_pre:test_hold/rarity/offhand/epi_esc if score @s TOOLS_ESC matches 1.. run data modify storage att2:dialog color set value "green"
...
execute if predicate att2_pre:test_hold/rarity/mainhand/epi_esc if score @s TOOLS_ESC matches 1.. run data modify storage att2:dialog color set value "green"
