...
execute if score 00000000-0000-012c-0000-00000000012c ENEMYABHEALTH matches ..0 run function att2:gameplay/boss/ether/umbratyanth/phase2/attack/charge/choose_pos
