...
execute if score Timer1 UMBRATYANTH matches 5 run function att2:gameplay/boss/ether/umbratyanth/phase2/choose_pos
execute if score Timer1 UMBRATYANTH matches 10.. as 00000000-0000-012c-0000-00000000012c if score @s ENEMYABHEALTH matches ..0 as @p[x=-5117,y=121,z=-6870] run function att2:gameplay/boss/ether/umbratyanth/phase2/choose_pos
...
execute if score Timer1 UMBRATYANTH matches 300 at 00000000-0000-012c-0000-00000000012c run function att2:sound/mobs/umbratyanth_prepare_attack
...
execute if score Timer3 UMBRATYANTH matches 25 at 00000000-0000-012c-0000-00000000012c run function att2:sound/mobs/umbratyanth_prepare_attack
