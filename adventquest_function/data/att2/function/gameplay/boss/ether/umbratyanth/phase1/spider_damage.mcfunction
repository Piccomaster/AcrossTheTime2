...
execute if score level DIFFICULTY matches 1 run damage @s 4 out_of_world by 00000000-0000-012c-0000-00000000012c
execute if score level DIFFICULTY matches 2 run damage @s 8 out_of_world by 00000000-0000-012c-0000-00000000012c
#magic damage
