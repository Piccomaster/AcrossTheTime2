...
execute positioned -7436 109 -4379 run function att2:summon/reg_1/putridarcher5_classx {class:CLASS17}
execute positioned -7432 109 -4375 run function att2:summon/reg_1/putridarcher5_classx {class:CLASS17}
