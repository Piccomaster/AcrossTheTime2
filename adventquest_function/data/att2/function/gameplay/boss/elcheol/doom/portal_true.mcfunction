...
execute in overworld unless block -5229 141 -6294 redstone_block run setblock -5229 141 -6294 minecraft:redstone_block
scoreboard players set ESC SQ56 0
particle minecraft:dust{color:[5,5,5],scale:0.7} -5229 143.5 -6293 1 1 1 1 100 normal
