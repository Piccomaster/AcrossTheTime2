...
execute positioned -1239 76 -615 run function att2:summon/reg_3/golem4_classx {class:CLASS16}
...
execute positioned -1239 50 -612 run function att2:summon/reg_3/blaze0_classx {class:CLASS16}
execute positioned -1242 50 -615 run function att2:summon/reg_3/blaze0_classx {class:CLASS16}
execute positioned -1239 50 -618 run function att2:summon/reg_3/blaze0_classx {class:CLASS16}
execute positioned -1236 50 -615 run function att2:summon/reg_3/blaze0_classx {class:CLASS16}
