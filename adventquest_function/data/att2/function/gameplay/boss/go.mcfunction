...
#per kill
execute if score tic TIMECOUNTER matches 1 run kill @n[distance=..50,type=bat,tag=BossRewards]
execute if score tic TIMECOUNTER matches 11 run kill @n[distance=..50,type=bat,tag=BossRewards]
##remove score
