...
execute if score OuranPhase3_timer1 OURANOS matches 19 as 00000000-0000-017b-0000-00000000017b at @s run data merge entity @s {Invulnerable:0b,Tags:["LVL0","CLASS13","Reg4"]}
execute if score OuranPhase3_timer1 OURANOS matches 19 run data modify entity 00000000-0000-054a-0000-00000000054a equipment.head.components.enchantments set value {"att2_enchantment:tick/mob_initialize":1}
