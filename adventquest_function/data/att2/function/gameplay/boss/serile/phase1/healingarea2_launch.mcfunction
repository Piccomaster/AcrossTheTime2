...
execute positioned 2196 110 1954 run summon minecraft:bat ~ ~ ~ {DeathLootTable:"att2:entities/regular/reg1l8t10",Silent:1b,active_effects:[{id:invisibility,amplifier:1,duration:-1,show_particles:false}]}
