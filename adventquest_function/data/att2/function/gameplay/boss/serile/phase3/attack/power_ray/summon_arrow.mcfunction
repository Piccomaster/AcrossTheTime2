...
summon minecraft:arrow ~ ~ ~ {Silent:1b,Tags:["SERILEPowerRayArrow","newSERILEPRA"],crit:0,pickup:2,damage:25.0,life:1195.0,item:{id:"minecraft:tipped_arrow",count:1,components:{"minecraft:potion_contents":{custom_color:16406787}}}}
