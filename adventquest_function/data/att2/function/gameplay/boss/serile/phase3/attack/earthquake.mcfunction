...
execute if score Timer3 SERILE matches 10 run summon minecraft:armor_stand 1543.0 25 1495.0 {Rotation:[90.0f,0.0f],Invulnerable:1b,Invisible:1,NoGravity:1b,DisabledSlots:2039552,Tags:["SerileEarthquake"]}
