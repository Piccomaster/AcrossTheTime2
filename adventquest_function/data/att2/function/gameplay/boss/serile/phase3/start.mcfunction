...
execute as 00000000-0000-022b-0000-00000000022b run data merge entity @s {Invulnerable:0b,Glowing:0,NoAI:0b,Health:1000}
...
summon minecraft:armor_stand 1543.0 25 1495.0 {Rotation:[-90.0f,0.0f],Invulnerable:1b,Invisible:1,NoGravity:1b,DisabledSlots:2039552,Tags:["SerileCenter"]}
summon minecraft:armor_stand 1543.0 20 1495.0 {Rotation:[-90.0f,0.0f],Invulnerable:1b,Invisible:1,NoGravity:1b,DisabledSlots:2039552,Tags:["ArenaCenter"]}