...
execute if score Timer4 SERILE matches 1..300 run function att2:gameplay/speceffect/disincarnate/keep/real0
execute if score Timer4 SERILE matches 1 run data modify storage att2:performance rotation set value [0,90]
...
execute if score Timer4 SERILE matches 50 positioned 2326 120 1945 as @a[x=2225,y=99,z=1945,distance=..500] run function att2:gameplay/speceffect/disincarnate/start/real0
execute if score Timer4 SERILE matches 50..199 run tp @n[type=text_display,tag=Real0] 2326 120 1945 0 90
...
execute if score Timer4 SERILE matches 200..249 run tp @n[type=text_display,tag=Real0] 2361 102 1945 -90 20
...
execute if score Timer4 SERILE matches 250..299 run tp @n[type=text_display,tag=Real0] 2382 98 1945 -90 5
execute if score Timer4 SERILE matches 300 as @a[gamemode=spectator,scores={Performance=0}] run function att2:gameplay/speceffect/disincarnate/end/real0
