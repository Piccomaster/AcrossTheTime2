...
execute if score FlammeNoire ANGOR_BOSS matches 10 as @a[scores={DIMENSION=6},x=3518,y=41,z=4678,distance=..100] run function att2:gameplay/checkpoint/angband/flamme_noire1
