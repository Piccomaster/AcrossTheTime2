...
execute if score FlammeNoire ANGOR_BOSS matches 10..296 run function att2:gameplay/speceffect/disincarnate/keep/neth0
execute if score FlammeNoire ANGOR_BOSS matches 296 run data modify storage att2:performance rotation set value [0,0]

execute if score FlammeNoire ANGOR_BOSS matches 296 positioned 3513 52 4900 as @a[scores={DIMENSION=6}] run function att2:gameplay/speceffect/disincarnate/start/neth0
...
execute if score FlammeNoire ANGOR_BOSS matches 201..295 in minecraft:the_nether run tp @n[type=text_display,tag=Real2] 3513 52 4900 0 0
...
execute if score FlammeNoire ANGOR_BOSS matches 11..100 in minecraft:the_nether run tp @n[type=text_display,tag=Neth0] 3497 73 4902 -30 20
execute if score FlammeNoire ANGOR_BOSS matches 10 as @a[gamemode=spectator,scores={Performance=10}] run function att2:gameplay/speceffect/disincarnate/end/neth0
execute if score FlammeNoire ANGOR_BOSS matches 10 as @a[scores={DIMENSION=6}] run function att2:gameplay/checkpoint/angband/flamme_noire1
execute if score FlammeNoire ANGOR_BOSS matches 7 run tag @a[scores={DIMENSION=6}] add CheckpointFN
...
execute if score FlammeNoire ANGOR_BOSS matches 2 as @a[scores={DIMENSION=6}] run scoreboard players set @s ANGOR_BOSS 0
