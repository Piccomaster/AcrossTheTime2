...
execute as 00000000-0000-009c-0000-00000000009c run data merge entity @s {NoAI:0b}
execute as 00000000-0000-008c-0000-00000000008c run data merge entity @s {NoAI:1b,Invulnerable:0b}
