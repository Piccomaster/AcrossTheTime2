...
##add spell xp
execute if score @s GAMELEVEL matches 1.. run scoreboard players add @s SPELL7_LVL 1
execute if score @s GAMELEVEL matches 25.. run scoreboard players add @s SPELL7_LVL 1
execute if score @s GAMELEVEL matches 50.. run scoreboard players add @s SPELL7_LVL 1
execute if score @s LEVELMASTER matches 100.. run scoreboard players add @s SPELL7_LVL 1
execute if score @s LEVELMASTER matches 200.. run scoreboard players add @s SPELL7_LVL 1
execute if score @s LEVELMASTER matches 300.. run scoreboard players add @s SPELL7_LVL 1
#test lvl up
