...
scoreboard players operation @s remain_time = lvl6 COOLDOWN32
function att2:gameplay/dahal/action/cooldown_cal_remain
scoreboard players operation COOLDOWN_LVL6 SPELL_DATA = @s remain_time

scoreboard players operation @s remain_time = lvl7 COOLDOWN32
function att2:gameplay/dahal/action/cooldown_cal_remain
scoreboard players operation COOLDOWN_LVL7 SPELL_DATA = @s remain_time

scoreboard players operation @s remain_time = lvl8 COOLDOWN32
function att2:gameplay/dahal/action/cooldown_cal_remain
scoreboard players operation COOLDOWN_LVL8 SPELL_DATA = @s remain_time

scoreboard players operation @s remain_time = lvl9 COOLDOWN32
function att2:gameplay/dahal/action/cooldown_cal_remain
scoreboard players operation COOLDOWN_LVL9 SPELL_DATA = @s remain_time

scoreboard players operation @s remain_time = lvl10 COOLDOWN32
function att2:gameplay/dahal/action/cooldown_cal_remain
...
scoreboard players set DISTANCE_LVL6 SPELL_DATA 240
scoreboard players set DISTANCE_LVL7 SPELL_DATA 280
scoreboard players set DISTANCE_LVL8 SPELL_DATA 320
scoreboard players set DISTANCE_LVL9 SPELL_DATA 360
scoreboard players set DISTANCE_LVL10 SPELL_DATA 777
##ESC COUNT cal
...
scoreboard players set COUNT_LVL1 SPELL_DATA 3
scoreboard players set COUNT_LVL2 SPELL_DATA 4
scoreboard players set COUNT_LVL3 SPELL_DATA 4
scoreboard players set COUNT_LVL4 SPELL_DATA 5
scoreboard players set COUNT_LVL5 SPELL_DATA 10
