...
#cooldown cal
scoreboard players operation @s remain_time = lvl1 COOLDOWN23
...
##SPD cal
scoreboard players set SPD_LVL1 SPELL_DATA 1
scoreboard players set SPD_LVL2 SPELL_DATA 2
scoreboard players set SPD_LVL3 SPELL_DATA 3
