...
#cooldown cal
scoreboard players operation @s remain_time = lvl1 COOLDOWN11
...
scoreboard players operation @s remain_time = lvl2 COOLDOWN11
function att2:gameplay/dahal/action/cooldown_cal_remain
scoreboard players operation COOLDOWN_LVL2 SPELL_DATA = @s remain_time

scoreboard players operation @s remain_time = lvl3 COOLDOWN11
function att2:gameplay/dahal/action/cooldown_cal_remain
scoreboard players operation COOLDOWN_LVL3 SPELL_DATA = @s remain_time

scoreboard players operation @s remain_time = lvl4 COOLDOWN11
function att2:gameplay/dahal/action/cooldown_cal_remain
scoreboard players operation COOLDOWN_LVL4 SPELL_DATA = @s remain_time

scoreboard players operation @s remain_time = lvl5 COOLDOWN11
function att2:gameplay/dahal/action/cooldown_cal_remain
scoreboard players operation COOLDOWN_LVL5 SPELL_DATA = @s remain_time

scoreboard players operation @s remain_time = lvl6 COOLDOWN11
function att2:gameplay/dahal/action/cooldown_cal_remain
scoreboard players operation COOLDOWN_LVL6 SPELL_DATA = @s remain_time

scoreboard players operation @s remain_time = lvl7 COOLDOWN11
function att2:gameplay/dahal/action/cooldown_cal_remain
scoreboard players operation COOLDOWN_LVL7 SPELL_DATA = @s remain_time

scoreboard players operation @s remain_time = lvl8 COOLDOWN11
function att2:gameplay/dahal/action/cooldown_cal_remain
scoreboard players operation COOLDOWN_LVL8 SPELL_DATA = @s remain_time

scoreboard players operation @s remain_time = lvl9 COOLDOWN11
function att2:gameplay/dahal/action/cooldown_cal_remain
scoreboard players operation COOLDOWN_LVL9 SPELL_DATA = @s remain_time

scoreboard players operation @s remain_time = lvl10 COOLDOWN11
function att2:gameplay/dahal/action/cooldown_cal_remain
scoreboard players operation COOLDOWN_LVL10 SPELL_DATA = @s remain_time
##DAHAL cost
scoreboard players set DAHAL_LVL1 SPELL_DATA 40
scoreboard players set DAHAL_LVL2 SPELL_DATA 38
scoreboard players set DAHAL_LVL3 SPELL_DATA 36
scoreboard players set DAHAL_LVL4 SPELL_DATA 34
scoreboard players set DAHAL_LVL5 SPELL_DATA 32
scoreboard players set DAHAL_LVL6 SPELL_DATA 30
scoreboard players set DAHAL_LVL7 SPELL_DATA 28
scoreboard players set DAHAL_LVL8 SPELL_DATA 26
scoreboard players set DAHAL_LVL9 SPELL_DATA 24
scoreboard players set DAHAL_LVL10 SPELL_DATA 20
##distance cal
