...
#cooldown cal
scoreboard players operation @s remain_time = lvl1 COOLDOWN10
...
scoreboard players set COUNT_LVL2 SPELL_DATA 2
scoreboard players set COUNT_LVL3 SPELL_DATA 3
scoreboard players set COUNT_LVL4 SPELL_DATA 4
scoreboard players set COUNT_LVL5 SPELL_DATA 5
scoreboard players set COUNT_LVL6 SPELL_DATA 6
scoreboard players set COUNT_LVL7 SPELL_DATA 7
scoreboard players set COUNT_LVL8 SPELL_DATA 8
scoreboard players set COUNT_LVL9 SPELL_DATA 9
scoreboard players set COUNT_LVL10 SPELL_DATA 10
##power cal
#store temp lvl
scoreboard players operation TEMP_LVL SPELL_DATA = @s SPELL10_SLCT
#LVL1
scoreboard players set @s SPELL10_SLCT 1
function att2:gameplay/dahal/action/spell10/damage_cal
scoreboard players operation DAMAGE_LVL1 SPELL_DATA = finalDG SPDG
#LVL2
scoreboard players set @s SPELL10_SLCT 2
function att2:gameplay/dahal/action/spell10/damage_cal
scoreboard players operation DAMAGE_LVL2 SPELL_DATA = finalDG SPDG
#LVL3
scoreboard players set @s SPELL10_SLCT 3
function att2:gameplay/dahal/action/spell10/damage_cal
scoreboard players operation DAMAGE_LVL3 SPELL_DATA = finalDG SPDG
#LVL4
scoreboard players set @s SPELL10_SLCT 4
function att2:gameplay/dahal/action/spell10/damage_cal
scoreboard players operation DAMAGE_LVL4 SPELL_DATA = finalDG SPDG
#LVL5
scoreboard players set @s SPELL10_SLCT 5
function att2:gameplay/dahal/action/spell10/damage_cal
scoreboard players operation DAMAGE_LVL5 SPELL_DATA = finalDG SPDG
#LVL6
scoreboard players set @s SPELL10_SLCT 6
function att2:gameplay/dahal/action/spell10/damage_cal
scoreboard players operation DAMAGE_LVL6 SPELL_DATA = finalDG SPDG
#LVL7
scoreboard players set @s SPELL10_SLCT 7
function att2:gameplay/dahal/action/spell10/damage_cal
scoreboard players operation DAMAGE_LVL7 SPELL_DATA = finalDG SPDG
#LVL8
scoreboard players set @s SPELL10_SLCT 8
function att2:gameplay/dahal/action/spell10/damage_cal
scoreboard players operation DAMAGE_LVL8 SPELL_DATA = finalDG SPDG
#LVL9
scoreboard players set @s SPELL10_SLCT 9
function att2:gameplay/dahal/action/spell10/damage_cal
scoreboard players operation DAMAGE_LVL9 SPELL_DATA = finalDG SPDG
#LVL10
scoreboard players set @s SPELL10_SLCT 10
function att2:gameplay/dahal/action/spell10/damage_cal
scoreboard players operation DAMAGE_LVL10 SPELL_DATA = finalDG SPDG
#reset
scoreboard players operation @s SPELL10_SLCT = TEMP_LVL SPELL_DATA

##cal critical
scoreboard players operation #Critical SPELL_DATA = SPELL10_CRITICAL Critical
