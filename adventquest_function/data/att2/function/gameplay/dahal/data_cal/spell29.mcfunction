...
#cooldown cal
scoreboard players operation @s remain_time = lvl1 COOLDOWN29
...
scoreboard players set COUNT_LIMIT_LVL3 SPELL_DATA 1
scoreboard players set COUNT_LIMIT_LVL4 SPELL_DATA 2
scoreboard players set COUNT_LIMIT_LVL5 SPELL_DATA 2
scoreboard players set COUNT_LIMIT_LVL6 SPELL_DATA 2
scoreboard players set COUNT_LIMIT_LVL7 SPELL_DATA 3
scoreboard players set COUNT_LIMIT_LVL8 SPELL_DATA 3
scoreboard players set COUNT_LIMIT_LVL9 SPELL_DATA 3
scoreboard players set COUNT_LIMIT_LVL10 SPELL_DATA 4
