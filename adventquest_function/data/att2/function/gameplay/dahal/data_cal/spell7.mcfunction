...
#cooldown cal
scoreboard players operation @s remain_time = lvl1 COOLDOWN7
...
##time cal
scoreboard players operation TIMER_LVL1 SPELL_DATA = timer_lvl1 SPELL7_DATA
scoreboard players operation TIMER_LVL1 SPELL_DATA /= 20 CAL
scoreboard players operation TIMER_LVL2 SPELL_DATA = timer_lvl2 SPELL7_DATA
scoreboard players operation TIMER_LVL2 SPELL_DATA /= 20 CAL
scoreboard players operation TIMER_LVL3 SPELL_DATA = timer_lvl3 SPELL7_DATA
scoreboard players operation TIMER_LVL3 SPELL_DATA /= 20 CAL
scoreboard players operation TIMER_LVL4 SPELL_DATA = timer_lvl4 SPELL7_DATA
scoreboard players operation TIMER_LVL4 SPELL_DATA /= 20 CAL
scoreboard players operation TIMER_LVL5 SPELL_DATA = timer_lvl5 SPELL7_DATA
scoreboard players operation TIMER_LVL5 SPELL_DATA /= 20 CAL
scoreboard players operation TIMER_LVL6 SPELL_DATA = timer_lvl6 SPELL7_DATA
scoreboard players operation TIMER_LVL6 SPELL_DATA /= 20 CAL
scoreboard players operation TIMER_LVL7 SPELL_DATA = timer_lvl7 SPELL7_DATA
scoreboard players operation TIMER_LVL7 SPELL_DATA /= 20 CAL
scoreboard players operation TIMER_LVL8 SPELL_DATA = timer_lvl8 SPELL7_DATA
scoreboard players operation TIMER_LVL8 SPELL_DATA /= 20 CAL
scoreboard players operation TIMER_LVL9 SPELL_DATA = timer_lvl9 SPELL7_DATA
scoreboard players operation TIMER_LVL9 SPELL_DATA /= 20 CAL
scoreboard players operation TIMER_LVL10 SPELL_DATA = timer_lvl10 SPELL7_DATA
scoreboard players operation TIMER_LVL10 SPELL_DATA /= 20 CAL
##power cal
#store temp lvl
scoreboard players operation TEMP_LVL SPELL_DATA = @s SPELL7_SLCT
#LVL1
