...
#clear page item
$execute as @a[scores={NUMEROJOUEUR=$(NUMEROJOUEUR)}] at @s if items entity @s player.cursor shulker_shell[tooltip_style="minecraft:rarity/misc/misc",minecraft:custom_name={translate:att2.spell20.page.pr}] run item replace entity @s player.cursor from entity @e[type=chest_minecart,tag=spell20_chest,scores={OWNER=$(NUMEROJOUEUR)},limit=1] container.8

$execute as @a[scores={NUMEROJOUEUR=$(NUMEROJOUEUR)}] at @s if items entity @s player.cursor shulker_shell[tooltip_style="minecraft:rarity/misc/misc",minecraft:custom_name={translate:att2.spell20.page.ne}] run item replace entity @s player.cursor from entity @e[type=chest_minecart,tag=spell20_chest,scores={OWNER=$(NUMEROJOUEUR)},limit=1] container.26

$execute as @a[scores={NUMEROJOUEUR=$(NUMEROJOUEUR)}] at @s if items entity @s player.cursor shulker_shell[tooltip_style="minecraft:rarity/misc/misc",minecraft:custom_name={translate:att2.spell20.page.drop}] run item replace entity @s player.cursor from entity @e[type=chest_minecart,tag=spell20_chest,scores={OWNER=$(NUMEROJOUEUR)},limit=1] container.17
