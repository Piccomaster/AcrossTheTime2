...
execute if score @s SPELL30_SLCT matches 2 run function att2:gameplay/dahal/launcher/spell_30/get
...
scoreboard players operation @s SPELL30_COST = SP30_2 DAHAL_COST
