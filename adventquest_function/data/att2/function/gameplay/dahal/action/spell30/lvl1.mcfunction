...
execute at @e[type=minecraft:armor_stand,tag=RecyclerSpell,distance=..10,scores={SPELL30_EFFECT=100}] run function att2:gameplay/dahal/action/spell30/validate/lvl1