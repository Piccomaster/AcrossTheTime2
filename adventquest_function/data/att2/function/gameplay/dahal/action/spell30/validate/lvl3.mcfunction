...
scoreboard players operation ult SPELL30 *= 10000 SPELL30

function att2:gameplay/dahal/action/spell30/xpprocess

kill @e[type=item,distance=..3,limit=10,predicate=att2_pre:recycle/arrow]
kill @e[type=item,distance=..3,limit=10,predicate=att2_pre:recycle/misc]
kill @e[type=item,distance=..3,limit=10,predicate=att2_pre:recycle/com]
kill @e[type=item,distance=..3,limit=10,predicate=att2_pre:recycle/unc]
kill @e[type=item,distance=..3,limit=10,predicate=att2_pre:recycle/rar]
kill @e[type=item,distance=..3,limit=10,predicate=att2_pre:recycle/epi]
kill @e[type=item,distance=..3,limit=10,predicate=att2_pre:recycle/epi_set]
kill @e[type=item,distance=..3,limit=10,predicate=att2_pre:recycle/leg]
kill @e[type=item,distance=..3,limit=10,predicate=att2_pre:recycle/leg_armset]
kill @e[type=item,distance=..3,limit=10,predicate=att2_pre:recycle/ult]