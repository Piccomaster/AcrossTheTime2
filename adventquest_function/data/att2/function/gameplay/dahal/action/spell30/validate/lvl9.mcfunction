...
scoreboard players set xp SPELL30 4000
...
scoreboard players set xp SPELL30 20000
scoreboard players operation leg_armset SPELL30 *= xp SPELL30
scoreboard players set xp SPELL30 40000
