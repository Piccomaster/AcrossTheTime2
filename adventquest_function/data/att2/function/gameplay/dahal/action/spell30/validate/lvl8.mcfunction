...
scoreboard players set xp SPELL30 300
scoreboard players operation rar SPELL30 *= xp SPELL30
scoreboard players set xp SPELL30 1750
...
scoreboard players set xp SPELL30 17500
scoreboard players operation leg_armset SPELL30 *= xp SPELL30
scoreboard players set xp SPELL30 35000
