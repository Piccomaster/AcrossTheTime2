...
execute if score @s COOLDOWN2 matches 1.. if score tic TIMECOUNTER matches 7 if predicate att2_pre:dahal/main/spell_2 run function att2:dialogs/gameplay/dahal/remain/spell2
