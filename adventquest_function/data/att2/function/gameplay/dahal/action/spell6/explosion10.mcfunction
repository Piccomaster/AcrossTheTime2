...
execute at @s align xyz positioned ~-6.5 ~1.38 ~-6.5 as @e[dx=14,dy=14,dz=14,scores={GAMELEVEL=0..},team=hostile,tag=!FB_DAHAL] at @s run function att2:gameplay/dahal/action/spell6/damage
