...
execute if score @s SPELL6_SLCT matches 4 run function att2:gameplay/dahal/launcher/spell_6/get
...
scoreboard players operation @s SPELL6_COST = SP6_4 DAHAL_COST
