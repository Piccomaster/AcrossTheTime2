...
execute if score @s SPELL6_SLCT matches 5 run function att2:gameplay/dahal/launcher/spell_6/get
...
scoreboard players operation @s SPELL6_COST = SP6_5 DAHAL_COST
