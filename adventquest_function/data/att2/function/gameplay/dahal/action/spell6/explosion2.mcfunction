...
particle minecraft:flash{color:[1,1,1,1]} ~ ~1 ~ 0.5 0.5 0.5 1 2 normal
...
execute at @s align xyz positioned ~-1.5 ~1.38 ~-1.5 as @e[dx=4,dy=4,dz=4,scores={GAMELEVEL=0..},team=hostile,tag=!FB_DAHAL] at @s run effect give @s minecraft:slowness 2 1 true
#damage cal
