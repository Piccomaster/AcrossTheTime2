...
execute if score @s SPELL6_SLCT matches 7 run function att2:gameplay/dahal/launcher/spell_6/get
...
scoreboard players operation @s SPELL6_COST = SP6_7 DAHAL_COST
