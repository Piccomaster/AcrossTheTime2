...
particle minecraft:flash{color:[1,1,1,1]} ~ ~1 ~ 0.5 0.5 0.5 8 5 normal
...
execute at @s align xyz positioned ~-5.5 ~1.38 ~-5.5 as @e[dx=12,dy=12,dz=12,scores={GAMELEVEL=0..},team=hostile,tag=!FB_DAHAL] at @s run effect give @s minecraft:slowness 5 5 true
#damage cal
