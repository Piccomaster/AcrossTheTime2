...
execute if score @s COOLDOWN44 matches 1.. if score tic TIMECOUNTER matches 7 if predicate att2_pre:dahal/main/spell_44 run function att2:dialogs/gameplay/dahal/remain/spell44
