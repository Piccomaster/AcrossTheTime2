...
##if on quick slot
execute if predicate att2_pre:dahal/spell_bundle/spell11 run scoreboard players set Spell_Bundle_Slot_Test CAL 1
...
#replace hand
#mainhand
execute unless score Spell_Bundle_Slot_Test CAL matches 1 if items entity @s weapon.mainhand enchanted_book[custom_data~{Spell:11}] run function att2:gameplay/dahal/action/replace/mainhand
#offhand
execute unless score Spell_Bundle_Slot_Test CAL matches 1 if items entity @s weapon.offhand enchanted_book[custom_data~{Spell:11}] run function att2:gameplay/dahal/action/replace/mainhand
#reset
