...
execute if entity @e[type=minecraft:bat,tag=VitalityPet1,distance=..10,predicate=att2_pre:score/owner] run return run function att2:gameplay/dahal/action/spell21/peteffect_lvl2
