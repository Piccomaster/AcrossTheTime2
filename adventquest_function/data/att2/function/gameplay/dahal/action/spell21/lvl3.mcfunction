...
scoreboard players set @e[type=bat,tag=NewPet] DAMAGEREDUCE 100
execute as @e[type=bat,tag=NewPet] run tag @s add VitalityPet3
...
##dahal_cost
scoreboard players operation @s DAHAL -= SP21_3 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP21_3 DAHAL_COST
