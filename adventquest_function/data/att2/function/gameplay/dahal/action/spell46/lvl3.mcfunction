...
scoreboard players operation SPELL46_DAR CAL = lvl3 SPELL46_DAR
scoreboard players operation SPELL46_TIMER CAL = lvl3 SPELL46_TIMER
#TIMER
...
#dahal
##dahal_cost
scoreboard players operation @s DAHAL -= SP46_3 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP46_3 DAHAL_COST
