...
##other players
execute at @s as @a[distance=0.1..4] run function att2:gameplay/dahal/action/spell45/other_player
#effect other
...
#dahal
##dahal_cost
scoreboard players operation @s DAHAL -= SP45_4 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP45_4 DAHAL_COST
