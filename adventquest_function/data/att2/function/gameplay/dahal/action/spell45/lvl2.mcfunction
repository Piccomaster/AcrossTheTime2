...
scoreboard players operation SPELL45_HER CAL = lvl2 SPELL45_HER
scoreboard players operation SPELL45_STR CAL = lvl2 SPELL45_STR
scoreboard players operation SPELL45_TIMER CAL = lvl2 SPELL45_TIMER
scoreboard players operation SPELL45_HEALTH CAL = lvl2_remove SPELL45_HER
#HEALTH
scoreboard players operation @s HER_VALUE -= lvl2_remove SPELL45_HER
#TIMER
...
##other players
execute at @s as @a[distance=0.1..2] run function att2:gameplay/dahal/action/spell45/other_player
#effect other
...
#dahal
##dahal_cost
scoreboard players operation @s DAHAL -= SP45_1 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP45_1 DAHAL_COST
