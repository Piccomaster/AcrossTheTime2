...
scoreboard players operation SPELL45_HEALTH CAL = lvl7_remove SPELL45_HER
#HEALTH
scoreboard players operation @s HER_VALUE -= lvl7_remove SPELL45_HER
#TIMER
...
##other players
execute at @s as @a[distance=0.1..7] run function att2:gameplay/dahal/action/spell45/other_player
#effect other
...
#dahal
##dahal_cost
scoreboard players operation @s DAHAL -= SP45_7 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP45_7 DAHAL_COST
