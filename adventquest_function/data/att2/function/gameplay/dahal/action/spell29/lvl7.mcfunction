...
#update score
scoreboard players set @e[distance=..5,type=vex,tag=NewInvo,tag=Spell29] SPELL29_CAP 7
##update data
attribute @n[distance=..5,type=vex,tag=NewInvo,tag=Spell29] movement_speed base set 1.5
...
scoreboard players add @s SPELL29_LVL 7
