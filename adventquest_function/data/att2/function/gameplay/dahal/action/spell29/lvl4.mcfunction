...
execute positioned ~ ~ ~ run function att2:summon/dahal/vex0_classx {class:CLASS8}
...
#update score
scoreboard players set @e[distance=..5,type=vex,tag=NewInvo,tag=Spell29] SPELL29_CAP 4
##update data
attribute @n[distance=..5,type=vex,tag=NewInvo,tag=Spell29] movement_speed base set 1.2
item replace entity @n[distance=..5,type=vex,tag=NewInvo,tag=Spell29] weapon.mainhand with copper_sword
##dahal_cost
...
scoreboard players add @s SPELL29_LVL 4
