...
execute positioned ~ ~ ~ run function att2:summon/dahal/vex0_classx {class:CLASS10}
...
#update score
scoreboard players set @e[distance=..5,type=vex,tag=NewInvo,tag=Spell29] SPELL29_CAP 5
##update data
attribute @n[distance=..5,type=vex,tag=NewInvo,tag=Spell29] movement_speed base set 1.3
...
scoreboard players add @s SPELL29_LVL 5
