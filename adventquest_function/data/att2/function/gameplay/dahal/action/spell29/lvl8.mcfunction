...
execute positioned ~ ~ ~ run function att2:summon/dahal/vex0_classx {class:CLASS16}
...
#update score
scoreboard players set @e[distance=..5,type=vex,tag=NewInvo,tag=Spell29] SPELL29_CAP 8
##update data
attribute @n[distance=..5,type=vex,tag=NewInvo,tag=Spell29] movement_speed base set 1.6
item replace entity @n[distance=..5,type=vex,tag=NewInvo,tag=Spell29] weapon.mainhand with diamond_sword
##dahal_cost
...
scoreboard players add @s SPELL29_LVL 8
