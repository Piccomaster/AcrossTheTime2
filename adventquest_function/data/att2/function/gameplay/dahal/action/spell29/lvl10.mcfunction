...
execute positioned ~ ~ ~ run function att2:summon/dahal/vex0_classx {class:CLASS20}
...
#update score
scoreboard players set @e[distance=..5,type=vex,tag=NewInvo,tag=Spell29] SPELL29_CAP 10
##update data
attribute @n[distance=..5,type=vex,tag=NewInvo,tag=Spell29] movement_speed base set 1.8
...
scoreboard players add @s SPELL29_LVL 10
