...
##store
execute store result storage att2:score speed double 0.2 run scoreboard players get #speed CAL
##motion
...
##range damage effect
execute at @s positioned ~-1.5 ~-0.5 ~-1.5 as @e[dx=3,dy=1,dz=3,scores={GAMELEVEL=0..},team=hostile,type=!bat] at @s run function att2:gameplay/dahal/action/spell29/damage with storage att2:score
