...
execute if score @s SPELL28_SLCT matches 2 run function att2:gameplay/dahal/launcher/spell_28/get
...
scoreboard players operation @s SPELL28_COST = SP28_2 DAHAL_COST
