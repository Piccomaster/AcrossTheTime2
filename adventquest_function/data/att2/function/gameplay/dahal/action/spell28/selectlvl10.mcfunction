...
execute if score @s SPELL28_SLCT matches 10 run function att2:gameplay/dahal/launcher/spell_28/get
...
scoreboard players operation @s SPELL28_COST = SP28_10 DAHAL_COST
