...
##test cooldown
##If over -> clear use 
execute if score @s COOLDOWN25 matches ..0 run data modify storage att2:cooldown spell_data.components."minecraft:consumable" set value {animation:spear,consume_seconds:0.05,has_consume_particles:false,sound:{sound_id:""}}
