...
execute if score @s SPELL9_SLCT matches 10 run function att2:gameplay/dahal/launcher/spell_9/get
...
scoreboard players operation @s SPELL9_COST = SP9_10 DAHAL_COST
