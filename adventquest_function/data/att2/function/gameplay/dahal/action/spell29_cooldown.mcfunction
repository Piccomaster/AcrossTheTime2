...
execute if score #Spell_Existence CAL matches 2.. run clear @s enchanted_book[custom_data~{Dahal:"launcher",Spell:29}] 1
...
##limit
execute unless data storage att2:cooldown inventory[{id:"minecraft:enchanted_book",components:{"minecraft:custom_data":{Spell:29}}}].Slot run scoreboard players set #Spell_Existence CAL -1
...
##offhand
execute unless score #Spell_Existence CAL matches -100 if items entity @s weapon.offhand enchanted_book[custom_data~{Dahal:"launcher",Spell:29}] run function att2:gameplay/dahal/action/replace/cooldown/offhand
##in player cursor
execute unless score #Spell_Existence CAL matches -100 if items entity @s player.cursor enchanted_book[custom_data~{Dahal:"launcher",Spell:29}] run function att2:gameplay/dahal/action/replace/cooldown/player_cursor
##player_crafting
execute unless score #Spell_Existence CAL matches -100 if items entity @s player.crafting.* enchanted_book[custom_data~{Dahal:"launcher",Spell:29}] run function att2:gameplay/dahal/action/replace/cooldown/player_crafting
##spell_bundle
