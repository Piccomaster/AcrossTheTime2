...
execute as @s[scores={SPELL_SLCT=81..90,COOLDOWN9=1..}] at @s run function att2:gameplay/dahal/action/loadingfail
...
execute as @s[scores={SPELL20_SLCT=1..200,COOLDOWN20=1..}] run function att2:gameplay/dahal/action/loadingfail
...
execute as @s[scores={SPELL20_SLCT=1..200,COOLDOWN20=..0}] at @s run function att2:gameplay/dahal/action/spell20/go
...
##horse
execute as @s[scores={SPELL_SLCT=281..290,COOLDOWN29=..0}] run function att2:gameplay/dahal/action/spell29/go

execute as @s[scores={SPELL_SLCT=291..300,COOLDOWN30=..0}] run function att2:gameplay/dahal/action/spell30/go
##Runerecycler
execute as @s[scores={SPELL_SLCT=301..310,COOLDOWN31=..0}] run function att2:gameplay/dahal/action/spell31/go
###SpaceTeleport
...
###oceanpet
execute as @s[scores={SPELL_SLCT=1001..1003,COOLDOWN101=..0}] run function att2:gameplay/dahal/action/spell101/go