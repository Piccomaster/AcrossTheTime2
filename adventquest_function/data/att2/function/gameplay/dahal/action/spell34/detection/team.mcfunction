...
team join dark_gray @e[type=minecraft:shulker,tag=chestmarker]
team join detect_minerals_runes @e[type=minecraft:shulker,tag=mineralsmarker]
team join blue @e[type=minecraft:shulker,tag=fishingmarker]
team join aqua @e[type=minecraft:shulker,tag=runictrialmarker]
team join aqua @e[type=minecraft:shulker,tag=elytra_racing_marker]
team join black @e[type=minecraft:shulker,tag=potmarker]