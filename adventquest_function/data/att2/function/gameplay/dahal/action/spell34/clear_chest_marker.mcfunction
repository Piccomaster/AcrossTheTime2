...
##add spell 34 xp
execute if entity @e[type=minecraft:shulker,tag=chestmarker,distance=..10] as @a[distance=..10] at @s run function att2:gameplay/dahal/action/spell34/find_bonus
