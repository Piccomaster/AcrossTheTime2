...
execute if score @s SPELL34_SLCT matches 3 run function att2:gameplay/dahal/launcher/spell_34/get
...
scoreboard players operation @s SPELL34_COST = SP34_3 DAHAL_COST
