...
execute if score @s SPELL34_SLCT matches 7 run function att2:gameplay/dahal/launcher/spell_34/get
...
scoreboard players operation @s SPELL34_COST = SP34_7 DAHAL_COST
