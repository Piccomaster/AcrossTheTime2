...
execute if score @s SPELL43_SLCT matches 4 run function att2:gameplay/dahal/launcher/spell_43/get
...
scoreboard players operation @s SPELL43_COST = SP43_4 DAHAL_COST
