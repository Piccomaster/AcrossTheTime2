...
execute as @a[distance=..2] at @s run particle minecraft:dust{color:[0.9,0.9,0.1],scale:2.25} ~ ~1 ~ 0.1 0.1 0.1 0 2 normal
...
#dahal
##dahal_cost
scoreboard players operation @s DAHAL -= SP43_2 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP43_2 DAHAL_COST
