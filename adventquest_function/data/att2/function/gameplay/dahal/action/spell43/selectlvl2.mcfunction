...
execute if score @s SPELL43_SLCT matches 2 run function att2:gameplay/dahal/launcher/spell_43/get
...
scoreboard players operation @s SPELL43_COST = SP43_2 DAHAL_COST
