...
execute if score @s COOLDOWN1 matches 1.. if score tic TIMECOUNTER matches 7 if predicate att2_pre:dahal/main/spell_1 run function att2:dialogs/gameplay/dahal/remain/spell1
