...
execute if score @s SPELL26_SLCT matches 8 run function att2:gameplay/dahal/launcher/spell_26/get
...
scoreboard players operation @s SPELL26_COST = SP26_8 DAHAL_COST
