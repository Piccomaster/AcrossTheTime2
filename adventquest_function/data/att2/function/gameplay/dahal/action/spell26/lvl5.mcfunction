...
scoreboard players operation @e[tag=Spell26] OWNER = @s NUMEROJOUEUR
...
##dahal_cost
scoreboard players operation @s DAHAL -= SP26_5 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP26_5 DAHAL_COST
