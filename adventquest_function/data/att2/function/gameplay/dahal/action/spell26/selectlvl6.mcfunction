...
execute if score @s SPELL26_SLCT matches 6 run function att2:gameplay/dahal/launcher/spell_26/get
...
scoreboard players operation @s SPELL26_COST = SP26_6 DAHAL_COST
