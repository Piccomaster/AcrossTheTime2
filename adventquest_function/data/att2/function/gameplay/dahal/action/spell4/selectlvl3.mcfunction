...
execute if score @s SPELL4_SLCT matches 3 run function att2:gameplay/dahal/launcher/spell_4/get
...
scoreboard players operation @s SPELL4_COST = SP4_3 DAHAL_COST
