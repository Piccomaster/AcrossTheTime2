...
execute at @s anchored eyes positioned ^ ^-0Z.5 ^4.8 run function att2:gameplay/dahal/action/spell4/ray/2
...
#dahal
##dahal_cost
scoreboard players operation @s DAHAL -= SP4_2 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP4_2 DAHAL_COST
