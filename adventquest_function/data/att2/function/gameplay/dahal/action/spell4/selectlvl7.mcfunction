...
execute if score @s SPELL4_SLCT matches 7 run function att2:gameplay/dahal/launcher/spell_4/get
...
scoreboard players operation @s SPELL4_COST = SP4_7 DAHAL_COST
