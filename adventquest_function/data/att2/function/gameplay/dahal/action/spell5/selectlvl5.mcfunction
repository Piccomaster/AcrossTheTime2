...
execute if score @s SPELL5_SLCT matches 5 run function att2:gameplay/dahal/launcher/spell_5/get
...
scoreboard players operation @s SPELL5_COST = SP5_5 DAHAL_COST
