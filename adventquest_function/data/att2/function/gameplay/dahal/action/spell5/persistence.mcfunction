...
##effect slowness
execute if score @s SPELL5_SLCT matches 1..2 align xyz positioned ~-2.5 ~-2.5 ~-2.5 run effect give @e[dx=6,dy=6,dz=6,scores={GAMELEVEL=0..},team=hostile] slowness 1 0 true
execute if score @s SPELL5_SLCT matches 3..4 align xyz positioned ~-3 ~-3 ~-3 run effect give @e[dx=7,dy=9,dz=7,scores={GAMELEVEL=0..},team=hostile] slowness 1 0 true
execute if score @s SPELL5_SLCT matches 5..6 align xyz positioned ~-4 ~-4 ~-4 run effect give @e[dx=9,dy=12,dz=9,scores={GAMELEVEL=0..},team=hostile] slowness 1 1 true
execute if score @s SPELL5_SLCT matches 7..8 align xyz positioned ~-5 ~-5 ~-5 run effect give @e[dx=11,dy=15,dz=11,scores={GAMELEVEL=0..},team=hostile] slowness 1 1 true
execute if score @s SPELL5_SLCT matches 9.. align xyz positioned ~-6 ~-6 ~-6 run effect give @e[dx=13,dy=18,dz=13,scores={GAMELEVEL=0..},team=hostile] slowness 1 2 true
#remove
