...
execute if score @s SPELL5_SLCT matches 3 run function att2:gameplay/dahal/launcher/spell_5/get
...
scoreboard players operation @s SPELL5_COST = SP5_3 DAHAL_COST
