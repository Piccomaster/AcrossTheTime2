...
execute as @a[distance=..2] at @s run particle minecraft:dust{color:[0.95,0.11,0.23],scale:2} ~ ~1 ~ 0.1 0.1 0.1 0 2 normal
execute as @a[distance=..2] at @s run particle minecraft:crimson_spore ~ ~1 ~ 0.2 1 0.2 0 20 normal

##add HP
scoreboard players operation #count CAL = SP42_HP_LVL1 DAHAL_COST
scoreboard players operation #count CAL *= 10000 CAL
scoreboard players operation @s HER_VALUE += #count CAL

#set spell effect score
scoreboard players operation SPELL42_RES CAL = lvl1 SPELL42_RES
scoreboard players operation SPELL42_TIMER CAL = lvl1 SPELL42_TIMER
#TIMER
...
#dahal
##dahal_cost
scoreboard players operation @s DAHAL -= SP42_1 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP42_1 DAHAL_COST
