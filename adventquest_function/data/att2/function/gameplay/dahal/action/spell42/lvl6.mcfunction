...
##add HP
scoreboard players operation #count CAL = SP42_HP_LVL6 DAHAL_COST
...
#dahal
##dahal_cost
scoreboard players operation @s DAHAL -= SP42_6 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP42_6 DAHAL_COST
