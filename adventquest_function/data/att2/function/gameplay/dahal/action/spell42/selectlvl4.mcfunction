...
execute if score @s SPELL42_SLCT matches 4 run function att2:gameplay/dahal/launcher/spell_42/get
...
scoreboard players operation @s SPELL42_COST = SP42_4 DAHAL_COST
