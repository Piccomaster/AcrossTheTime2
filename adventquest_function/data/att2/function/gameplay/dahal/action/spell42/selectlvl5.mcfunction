...
execute if score @s SPELL42_SLCT matches 5 run function att2:gameplay/dahal/launcher/spell_42/get
...
scoreboard players operation @s SPELL42_COST = SP42_5 DAHAL_COST
