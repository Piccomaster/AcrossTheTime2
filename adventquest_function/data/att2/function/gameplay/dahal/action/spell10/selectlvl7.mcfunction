...
execute if score @s SPELL10_SLCT matches 7 run function att2:gameplay/dahal/launcher/spell_10/get
...
scoreboard players operation @s SPELL10_COST = SP10_7 DAHAL_COST
