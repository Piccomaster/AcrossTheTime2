...
##critical detection
function att2:gameplay/dahal/action/critical/spell10_detection
...
##set spell icon
data modify storage att2:enemy_health spell_icon set value "item/custom/spell_book/spell10"