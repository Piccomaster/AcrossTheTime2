...
execute as @e[type=phantom,tag=NewPet] run tag @s add ObstinacyPet1
...
##dahal_cost
scoreboard players operation @s DAHAL -= SP22_1 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP22_1 DAHAL_COST
