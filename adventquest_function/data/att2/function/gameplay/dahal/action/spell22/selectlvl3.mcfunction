...
execute if score @s SPELL22_SLCT matches 3 run function att2:gameplay/dahal/launcher/spell_22/get
...
scoreboard players operation @s SPELL22_COST = SP22_3 DAHAL_COST
