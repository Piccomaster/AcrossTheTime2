...
scoreboard players operation SPELL44_HUN CAL = lvl2 SPELL44_HUN
scoreboard players operation SPELL44_HAS CAL = lvl2 SPELL44_HAS
scoreboard players operation SPELL44_SPD CAL = lvl2 SPELL44_SPD
scoreboard players operation SPELL44_TIMER CAL = lvl2 SPELL44_TIMER
#TIMER
scoreboard players set SPELL44_TIMER CAL 400
...
#dahal
##dahal_cost
scoreboard players operation @s DAHAL -= SP44_2 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP44_2 DAHAL_COST
