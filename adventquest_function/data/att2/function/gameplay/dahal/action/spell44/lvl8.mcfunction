...
scoreboard players operation SPELL44_HUN CAL = lvl8 SPELL44_HUN
scoreboard players operation SPELL44_HAS CAL = lvl8 SPELL44_HAS
scoreboard players operation SPELL44_SPD CAL = lvl8 SPELL44_SPD
scoreboard players operation SPELL44_TIMER CAL = lvl8 SPELL44_TIMER
#TIMER
scoreboard players set SPELL44_TIMER CAL 1500
...
##other players
execute at @s as @a[distance=0.1..8] run function att2:gameplay/dahal/action/spell44/other_player
#effect other
...
#dahal
##dahal_cost
scoreboard players operation @s DAHAL -= SP44_8 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP44_8 DAHAL_COST
