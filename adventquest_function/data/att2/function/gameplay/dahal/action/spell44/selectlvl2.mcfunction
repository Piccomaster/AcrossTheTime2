...
execute if score @s SPELL44_SLCT matches 2 run function att2:gameplay/dahal/launcher/spell_44/get
...
scoreboard players operation @s SPELL44_COST = SP44_2 DAHAL_COST
