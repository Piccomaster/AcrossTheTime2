...
execute if score @s SPELL2_SLCT matches 6 run function att2:gameplay/dahal/launcher/spell_2/get
...
scoreboard players operation @s SPELL2_COST = SP2_6 DAHAL_COST
