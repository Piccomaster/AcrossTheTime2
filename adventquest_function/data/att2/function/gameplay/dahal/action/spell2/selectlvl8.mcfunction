...
execute if score @s SPELL2_SLCT matches 8 run function att2:gameplay/dahal/launcher/spell_2/get
...
scoreboard players operation @s SPELL2_COST = SP2_8 DAHAL_COST
