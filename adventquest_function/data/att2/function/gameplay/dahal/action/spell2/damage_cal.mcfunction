...
execute if score level DIFFICULTY matches 1.. run scoreboard players add maxDG SPDG 50
execute if score level DIFFICULTY matches 2.. run scoreboard players add maxDG SPDG 70
#max-min
