...
summon interaction ~ ~1.2 ~ {Tags:["Stock","Cover","New"],height:1.2,width:1.2}
summon block_display ~ ~1.4 ~ {Rotation:[0,0],block_state:{Name:"minecraft:ender_chest"},Tags:["Stock","New","Cover"],transformation:{translation:[0.5f,-1.2f,2.0f],scale:[1.0f,1.0f,1.0f],right_rotation:[0.0f,1.0f,0.0f,1.0f],left_rotation:[0.0f,1.0f,0.0f,1.0f]},billboard:fixed,Passengers:[{id:"chest_minecart",Tags:["invminecarts.invisible_minecart","spell20_chest","Stock","New"],Silent:true,Invulnerable:true,HasVisualFire:false,DisplayState:{Name:"barrier"},NoGravity:true,CustomName:[{translate:att2.spell20.name}]}]}
