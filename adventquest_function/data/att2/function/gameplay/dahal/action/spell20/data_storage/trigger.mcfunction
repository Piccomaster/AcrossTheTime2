...
$item replace entity @s container.26 with shulker_shell[custom_data={Stock:page_ne,EquipmentType:misc,Trigger:true},custom_name={translate:att2.spell20.page_ne.name},lore=[{translate:att2.spell20.page_ne.lore.1},{translate:att2.spell20.page_ne.lore.2},{translate:att2.spell20.page_ne.lore.3},{translate:att2.spell20.page},{text:"§e$(page_now) §f/ §6$(page_max)"}]]