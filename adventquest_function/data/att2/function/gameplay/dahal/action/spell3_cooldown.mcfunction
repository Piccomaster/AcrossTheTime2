...
execute if score @s COOLDOWN3 matches 1.. if score tic TIMECOUNTER matches 7 if predicate att2_pre:dahal/main/spell_3 run function att2:dialogs/gameplay/dahal/remain/spell3
...
#not enough
execute if score DAHAL_TEST CAL matches 0 unless predicate att2_pre:dahal/empty_cooldown/spell_3 run function att2:gameplay/dahal/action/replace/detection/spell3
...
execute if predicate att2_pre:dahal/empty_cooldown/spell_3 run function att2:gameplay/dahal/action/replace/detection/spell3
