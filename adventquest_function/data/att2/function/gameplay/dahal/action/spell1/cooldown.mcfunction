...
#cooldown cal
function att1:gameplay/dahal/action/cooldown_cal
scoreboard players set @s CDPERCENT1 11
scoreboard players operation SECONDS CAL = @s COOLDOWN1

scoreboard players operation SECONDS CAL /= COOLDOWN CAL
#store score
execute store result storage att1:cooldown seconds float 0.05 run scoreboard players get SECONDS CAL
data modify storage att1:cooldown spell_id set value 1
#set dahal score
