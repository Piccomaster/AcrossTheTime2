...
execute if score @s SPELL1_SLCT matches 3 run function att2:gameplay/dahal/launcher/spell_1/get
...
scoreboard players operation @s SPELL1_COST = SP1_3 DAHAL_COST
