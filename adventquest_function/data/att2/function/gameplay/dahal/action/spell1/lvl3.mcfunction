...
function att2:gameplay/dahal/action/spell1/summon {speed:1.1}

##dahal_cost
scoreboard players operation @s DAHAL -= SP1_3 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP1_3 DAHAL_COST
