...
data modify entity @n[tag=New,type=eye_of_ender,tag=FireballSpell] Rotation set from entity @s Rotation
...
execute as @s[tag=Corrupted] run tag @e[tag=New,type=fireball,tag=FireballSpell,distance=..10] add CorruptedZ
##detection
