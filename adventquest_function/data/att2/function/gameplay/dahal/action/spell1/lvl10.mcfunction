...
function att2:gameplay/dahal/action/spell1/summon {speed:1.5}

##dahal_cost
scoreboard players operation @s DAHAL -= SP1_10 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP1_10 DAHAL_COST
