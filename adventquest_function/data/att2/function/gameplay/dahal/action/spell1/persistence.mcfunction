...
##test snowball onground
execute on vehicle at @s unless block ~ ~ ~ minecraft:air on passengers at @s run return run function att2:gameplay/dahal/action/spell1/explosion with storage att2:spell_1
##if player far 
