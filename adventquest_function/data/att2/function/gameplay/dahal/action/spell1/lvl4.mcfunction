...
function att2:gameplay/dahal/action/spell1/summon {speed:1.15}

##dahal_cost
scoreboard players operation @s DAHAL -= SP1_4 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP1_4 DAHAL_COST
