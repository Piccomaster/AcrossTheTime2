...
scoreboard players operation epi SPELL31 = epi SPELL31_DATA
...
execute as @e[type=minecraft:item,predicate=att2_pre:test_item/epi,predicate=!att2_pre:test_item/error,distance=..5,limit=1,sort=nearest] at @s run function att2:gameplay/dahal/action/spell31/particle/epi_item with storage att2:spell31
