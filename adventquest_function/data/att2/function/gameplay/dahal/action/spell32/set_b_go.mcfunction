...
#launch go
execute if score CHECK CAL matches 1 if score @s SPELL32_SLCT matches 1 run function att2:gameplay/dahal/action/spell32/set_armorstand/lvl1_set_b
execute if score CHECK CAL matches 1 if score @s SPELL32_SLCT matches 2 run function att2:gameplay/dahal/action/spell32/set_armorstand/lvl2_set_b
execute if score CHECK CAL matches 1 if score @s SPELL32_SLCT matches 3 run function att2:gameplay/dahal/action/spell32/set_armorstand/lvl3_set_b
