...
execute at @s as @e[type=armor_stand,tag=SPELL32_SET_A,distance=81..120] if score @s OWNER = @a[distance=..0,limit=1] NUMEROJOUEUR run scoreboard players set DISTANCE CAL 2
#get esc score
