...
execute if entity @p[tag=TEMP,distance=240.1..320] run return run scoreboard players set #DISTANCE CAL 4
execute if entity @p[tag=TEMP,distance=320.1..360] run return run scoreboard players set #DISTANCE CAL 5
##always
