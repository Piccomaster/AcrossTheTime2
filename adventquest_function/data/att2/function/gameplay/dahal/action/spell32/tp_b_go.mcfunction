...
##对玩家距离点位和esc数量进行检测
execute as @s[scores={SPELL32_SLCT=1..,DAHAL=350..,tp_point_set_b=1}] run function att2:gameplay/dahal/action/spell32/tp_check/detection_b
...
execute if score @s tp_point_set_b matches 0 run function att2:gameplay/dahal/action/spell32/no_set
