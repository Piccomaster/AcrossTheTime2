...
execute if score @s SPELL7_SLCT matches 5 run function att2:gameplay/dahal/launcher/spell_7/get
...
scoreboard players operation @s SPELL7_COST = SP7_5 DAHAL_COST
