...
execute as @e[team=hostile,scores={GAMELEVEL=0..},type=!bat,distance=..5] run effect give @s minecraft:wither 3 5 true
execute as @e[team=hostile,scores={GAMELEVEL=0..},type=!bat,distance=..5] at @s unless entity @s[scores={SPELL7_EFFECT=1..}] run tp @s[tag=!owlkar] ~ ~0.07 ~ ~ ~
tp @s ~ ~ ~ ~5 ~
