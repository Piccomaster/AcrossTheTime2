...
execute as @e[team=hostile,scores={GAMELEVEL=0..},type=!bat,distance=..2] run effect give @s minecraft:wither 2 2 true
execute as @e[team=hostile,scores={GAMELEVEL=0..},type=!bat,distance=..2] at @s unless entity @s[scores={SPELL7_EFFECT=1..}] run tp @s[tag=!owlkar] ~ ~0.05 ~ ~ ~
