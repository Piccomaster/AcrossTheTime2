...
##dahal_cost
scoreboard players operation @s DAHAL -= SP24_2 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP24_2 DAHAL_COST
...
execute at @s as @e[tag=NewInvo,distance=..10] run scoreboard players operation @s SPELL24_EFFECT = timer_lvl2 SPELL24_DATA
