...
execute if score @s SPELL24_SLCT matches 5 run function att2:gameplay/dahal/launcher/spell_24/get
...
scoreboard players operation @s SPELL24_COST = SP24_5 DAHAL_COST
