...
scoreboard players operation #DAHAL_TICK_COST CAL = SP24_4 DAHAL_COST
...
execute at @s as @e[tag=NewInvo,distance=..10] run scoreboard players operation @s SPELL24_EFFECT = timer_lvl4 SPELL24_DATA
