...
#launch
execute if score @s[scores={SPELL33_SLCT=1}] DAHAL >= SP33_1 DAHAL_COST anchored eyes positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell33/lvl1
execute if score @s[scores={SPELL33_SLCT=2}] DAHAL >= SP33_2 DAHAL_COST anchored eyes positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell33/lvl2
execute if score @s[scores={SPELL33_SLCT=3}] DAHAL >= SP33_3 DAHAL_COST anchored eyes positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell33/lvl3
execute if score @s[scores={SPELL33_SLCT=4}] DAHAL >= SP33_4 DAHAL_COST anchored eyes positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell33/lvl4
execute if score @s[scores={SPELL33_SLCT=5}] DAHAL >= SP33_5 DAHAL_COST anchored eyes positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell33/lvl5
execute if score @s[scores={SPELL33_SLCT=6}] DAHAL >= SP33_6 DAHAL_COST anchored eyes positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell33/lvl6
execute if score @s[scores={SPELL33_SLCT=7}] DAHAL >= SP33_7 DAHAL_COST anchored eyes positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell33/lvl7
execute if score @s[scores={SPELL33_SLCT=8}] DAHAL >= SP33_8 DAHAL_COST anchored eyes positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell33/lvl8
execute if score @s[scores={SPELL33_SLCT=9}] DAHAL >= SP33_9 DAHAL_COST anchored eyes positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell33/lvl9
execute if score @s[scores={SPELL33_SLCT=10}] DAHAL >= SP33_10 DAHAL_COST anchored eyes positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell33/lvl10
