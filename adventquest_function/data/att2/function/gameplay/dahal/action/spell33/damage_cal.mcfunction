...
#cal  (SLCT_LVL-1)
scoreboard players operation slctlvl SPDG = @s SPELL33_SLCT
...
scoreboard players operation enhancementBONUS SPDG = BonusPowerSpell33 ENHANCEMENT
...
function att2:gameplay/dahal/action/critical/spell33_detection
...
##set spell icon
data modify storage att2:enemy_health spell_icon set value "item/custom/spell_book/spell33"