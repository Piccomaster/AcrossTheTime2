...
execute as @e[type=parrot,tag=NewPet] run tag @s add AgilityPet1
...
##dahal_cost
scoreboard players operation @s DAHAL -= SP23_1 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP23_1 DAHAL_COST
