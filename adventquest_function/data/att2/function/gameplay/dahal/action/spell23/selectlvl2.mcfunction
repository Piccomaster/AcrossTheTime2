...
execute if score @s SPELL23_SLCT matches 2 run function att2:gameplay/dahal/launcher/spell_23/get
...
scoreboard players operation @s SPELL23_COST = SP23_2 DAHAL_COST
