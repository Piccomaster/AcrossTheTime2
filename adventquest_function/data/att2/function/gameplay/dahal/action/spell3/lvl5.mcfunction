...
execute at @s align xyz positioned ~-4.5 ~-4.5 ~-4.5 as @e[dx=10,dy=10,dz=10,scores={GAMELEVEL=0..},team=hostile,tag=!FB_DAHAL] run data merge entity @s {Fire:300}
#damage cal
...
particle minecraft:item{item:"minecraft:soul_lantern"} ~ ~1 ~ 0 0 0 1 75 normal
...
#dahal
##dahal_cost
scoreboard players operation @s DAHAL -= SP3_5 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP3_5 DAHAL_COST
