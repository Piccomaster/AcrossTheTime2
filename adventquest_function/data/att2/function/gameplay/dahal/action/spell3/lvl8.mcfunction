...
execute at @s align xyz positioned ~-6.5 ~-6.5 ~-6.5 as @e[dx=14,dy=14,dz=14,scores={GAMELEVEL=0..},team=hostile] run data merge entity @s {Fire:450}
execute at @s align xyz positioned ~-6.5 ~-6.5 ~-6.5 as @e[dx=14,dy=14,dz=14,scores={GAMELEVEL=0..},team=hostile] run effect give @s wither 4 3 true
#damage cal
