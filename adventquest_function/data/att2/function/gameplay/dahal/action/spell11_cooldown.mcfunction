...
execute if score @s COOLDOWN11 matches 1.. if score tic TIMECOUNTER matches 7 if predicate att2_pre:dahal/main/spell_11 run function att2:dialogs/gameplay/dahal/remain/spell11
