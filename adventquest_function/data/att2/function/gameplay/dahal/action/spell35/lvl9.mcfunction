...
#update score
scoreboard players set @e[distance=..5,type=allay,tag=NewInvo,tag=Spell35] SPELL35_CAP 9
...
##dahal_cost
scoreboard players operation @s DAHAL -= SP35_9 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP35_9 DAHAL_COST
