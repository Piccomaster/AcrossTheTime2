...
# Particle
function att2:gameplay/dahal/action/spell35/particle
#hold
...
##glowing
execute if entity @p[predicate=att2_pre:score/player,scores={COOLDOWN35=..0}] run effect give @s glowing infinite 0 true