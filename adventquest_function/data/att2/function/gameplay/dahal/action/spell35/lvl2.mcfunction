...
#update score
scoreboard players set @e[distance=..5,type=allay,tag=NewInvo,tag=Spell35] SPELL35_CAP 2
scoreboard players operation @e[distance=..5,type=allay,tag=NewInvo,tag=Spell35] SPELL35_TIMER = lvl2 SPELL35_TIMER
scoreboard players operation @e[distance=..5,type=allay,tag=NewInvo,tag=Spell35] OWNER = @s NUMEROJOUEUR

##dahal_cost
scoreboard players operation @s DAHAL -= SP35_2 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP35_2 DAHAL_COST
