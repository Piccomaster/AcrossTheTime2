...
execute positioned ~-0.8 ~-0.8 ~-0.8 as @e[dx=1.6,dy=1.6,dz=1.6,scores={GAMELEVEL=0..},team=hostile,type=!bat,tag=!SPELL35_ATK] run function att2:gameplay/dahal/action/spell35/damage with storage att2:score