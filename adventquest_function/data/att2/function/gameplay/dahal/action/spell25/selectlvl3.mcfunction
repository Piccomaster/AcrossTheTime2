...
execute if score @s SPELL25_SLCT matches 3 run function att2:gameplay/dahal/launcher/spell_25/get
...
scoreboard players operation @s SPELL25_COST = SP25_3 DAHAL_COST
