...
execute at @s positioned ~-12 ~-12 ~-12 as @e[dx=24,dy=24,dz=24,scores={GAMELEVEL=0..},type=!bat,team=hostile,tag=!FB_DAHAL] at @s run function att2:gameplay/dahal/action/spell8/damage with storage att2:sp_dmg
