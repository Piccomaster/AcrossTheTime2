...
at @s align xyz positioned ~-9.5 ~-9.5 ~-9.5 as @e[dx=20,dy=10,dz=20,scores={GAMELEVEL=0..},type=!bat,team=hostile,tag=!FB_DAHAL] at @s run function att2:gameplay/dahal/action/spell8/damage with storage att2:sp_dmg
