...
at @s align xyz positioned ~-10.5 ~-10.5 ~-10.5 as @e[dx=22,dy=22,dz=22,scores={GAMELEVEL=0..},type=!bat,team=hostile,tag=!FB_DAHAL] at @s run function att2:gameplay/dahal/action/spell8/damage with storage att2:sp_dmg
