...
execute if score @s SPELL8_SLCT matches 4 run function att2:gameplay/dahal/launcher/spell_8/get
...
scoreboard players operation @s SPELL8_COST = SP8_4 DAHAL_COST
