...
execute at @s positioned ~-7 ~-7 ~-7 as @e[dx=14,dy=14,dz=14,scores={GAMELEVEL=0..},type=!bat,team=hostile,tag=!FB_DAHAL] at @s run function att2:gameplay/dahal/action/spell8/damage
