...
execute at @s positioned ~-8 ~-8 ~-8 as @e[dx=16,dy=16,dz=16,scores={GAMELEVEL=0..},type=!bat,team=hostile,tag=!FB_DAHAL] at @s run function att2:gameplay/dahal/action/spell8/damage with storage att2:sp_dmg
...
scoreboard players operation #DAHAL_TICK_COST CAL = SP8_4 DAHAL_COST
