...
particle minecraft:falling_dust{block_state:"minecraft:magma_block"} ~ ~7 ~ 6 5 6 1 150 normal
particle minecraft:lava ~ ~5 ~ 6 2 6 1 150 normal
particle minecraft:item{item:"minecraft:blaze_powder"} ~ ~2.5 ~ 0 0 0 1 150 normal
