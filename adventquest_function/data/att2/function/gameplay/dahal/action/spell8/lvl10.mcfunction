...
execute at @s positioned ~-15 ~-15 ~-15 as @e[dx=30,dy=30,dz=30,scores={GAMELEVEL=0..},type=!bat,team=hostile,tag=!FB_DAHAL] at @s run function att2:gameplay/dahal/action/spell8/damage with storage att2:sp_dmg
