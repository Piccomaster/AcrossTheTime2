...
execute at @s positioned ~-13 ~-13 ~-13 as @e[dx=26,dy=26,dz=26,scores={GAMELEVEL=0..},type=!bat,team=hostile,tag=!FB_DAHAL] at @s run function att2:gameplay/dahal/action/spell8/damage
