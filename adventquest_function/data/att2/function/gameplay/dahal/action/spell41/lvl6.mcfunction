...
execute as @a[distance=..6] at @s run particle minecraft:dust{color:[0.9,0.6,0.7],scale:0.7} ~ ~ ~ 4.5 4.5 4.5 0 30 normal
execute as @a[distance=..6] at @s run particle minecraft:witch ~ ~ ~ 4.5 0.5 4.5 0 60 normal
#set spell effect score
scoreboard players operation SPELL41_HER CAL = lvl6 SPELL41_HER
scoreboard players operation SPELL41_SPD CAL = lvl6 SPELL41_SPD
scoreboard players operation SPELL41_TIMER CAL = lvl6 SPELL41_TIMER
#TIMER
...
##other players
execute at @s as @a[distance=0.1..6] run function att2:gameplay/dahal/action/spell41/other_player
#effect other
...
#dahal
##dahal_cost
scoreboard players operation @s DAHAL -= SP41_6 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP41_6 DAHAL_COST
