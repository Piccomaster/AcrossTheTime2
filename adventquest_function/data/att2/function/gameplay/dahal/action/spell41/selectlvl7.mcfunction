...
execute if score @s SPELL41_SLCT matches 7 run function att2:gameplay/dahal/launcher/spell_41/get
...
scoreboard players operation @s SPELL41_COST = SP41_7 DAHAL_COST
