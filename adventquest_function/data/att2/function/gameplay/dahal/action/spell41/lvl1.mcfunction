...
execute as @a[distance=..2] at @s run particle minecraft:dust{color:[0.9,0.6,0.7],scale:0.7} ~ ~ ~ 1 1 1 0 5 normal
execute as @a[distance=..2] at @s run particle minecraft:witch ~ ~ ~ 1 0.5 1 0 10 normal
#set spell effect score
scoreboard players operation SPELL41_HER CAL = lvl1 SPELL41_HER
scoreboard players operation SPELL41_SPD CAL = lvl1 SPELL41_SPD
scoreboard players operation SPELL41_TIMER CAL = lvl1 SPELL41_TIMER
#TIMER
...
#dahal
##dahal_cost
scoreboard players operation @s DAHAL -= SP41_1 DAHAL_COST
scoreboard players operation #DAHAL_TICK_COST CAL = SP41_1 DAHAL_COST
