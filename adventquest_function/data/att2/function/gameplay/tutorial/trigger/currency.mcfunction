...
##trigger
advancement grant @s[scores={LANGUAGE=0}] only att2:tutorial/currency/0
advancement grant @s[scores={LANGUAGE=1}] only att2:tutorial/currency/1
advancement grant @s[scores={LANGUAGE=2}] only att2:tutorial/currency/2
advancement grant @s[scores={LANGUAGE=3..10}] only att2:tutorial/currency/1
advancement grant @s[scores={LANGUAGE=11}] only att2:tutorial/currency/11
...
##remove tag
tag @s remove TutorialDelayCurrency
