...
##trigger
advancement grant @s[scores={LANGUAGE=0}] only att2:tutorial/rune_enchantment/0
advancement grant @s[scores={LANGUAGE=1}] only att2:tutorial/rune_enchantment/1
advancement grant @s[scores={LANGUAGE=2}] only att2:tutorial/rune_enchantment/2
advancement grant @s[scores={LANGUAGE=3..10}] only att2:tutorial/rune_enchantment/1
advancement grant @s[scores={LANGUAGE=11}] only att2:tutorial/rune_enchantment/11
...
##remove tag
tag @s remove TutorialDelayRuneEnchantment

##set once
advancement grant @s only att2:tutorial/trigger/rune_enchantment