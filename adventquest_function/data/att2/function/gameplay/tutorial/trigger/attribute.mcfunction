...
##trigger
advancement grant @s[scores={LANGUAGE=0}] only att2:tutorial/attribute/0
advancement grant @s[scores={LANGUAGE=1}] only att2:tutorial/attribute/1
advancement grant @s[scores={LANGUAGE=2}] only att2:tutorial/attribute/2
advancement grant @s[scores={LANGUAGE=3..10}] only att2:tutorial/attribute/1
advancement grant @s[scores={LANGUAGE=11}] only att2:tutorial/attribute/11
...
##remove tag
tag @s remove TutorialDelayAttribute

##set once
advancement grant @s only att2:tutorial/trigger/attribute