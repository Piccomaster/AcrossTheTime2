...
advancement revoke @s only att2:tutorial/stock/2
advancement revoke @s only att2:tutorial/stock/11
##trigger
advancement grant @s[scores={LANGUAGE=0}] only att2:tutorial/stock/0
advancement grant @s[scores={LANGUAGE=1}] only att2:tutorial/stock/1
advancement grant @s[scores={LANGUAGE=2}] only att2:tutorial/stock/2
advancement grant @s[scores={LANGUAGE=3..10}] only att2:tutorial/stock/1
advancement grant @s[scores={LANGUAGE=11}] only att2:tutorial/stock/11
...
##remove tag
tag @s remove TutorialDelayStock

##set once
advancement grant @s only att2:tutorial/trigger/stock