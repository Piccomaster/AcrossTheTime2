...
advancement revoke @s only att2:tutorial/keys/2
advancement revoke @s only att2:tutorial/keys/11
##trigger
advancement grant @s[scores={LANGUAGE=0}] only att2:tutorial/keys/0
advancement grant @s[scores={LANGUAGE=1}] only att2:tutorial/keys/1
advancement grant @s[scores={LANGUAGE=2}] only att2:tutorial/keys/2
advancement grant @s[scores={LANGUAGE=3..10}] only att2:tutorial/keys/1
advancement grant @s[scores={LANGUAGE=11}] only att2:tutorial/keys/11
...
##remove tag
tag @s remove TutorialDelayKeys
