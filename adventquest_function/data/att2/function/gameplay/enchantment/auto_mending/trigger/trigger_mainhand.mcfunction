...
execute if predicate att2_pre:test_hold/rarity/mainhand/epi if score @s TOOLS_EPI matches 1.. run function att2:gameplay/shop/mending/tools/repair_mainhand
execute if predicate att2_pre:test_hold/rarity/mainhand/epi_set if score @s TOOLS_EPI matches 1.. run function att2:gameplay/shop/mending/tools/repair_mainhand
...
execute if predicate att2_pre:test_hold/rarity/mainhand/leg_armset if score @s TOOLS_LEG matches 1.. run function att2:gameplay/shop/mending/tools/repair_mainhand
