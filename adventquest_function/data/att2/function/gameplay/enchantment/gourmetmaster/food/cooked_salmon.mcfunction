...
execute unless score @s FOODID matches 16 run scoreboard players add @s GOURMETMASTER 3
execute if score @s FOODID matches 16 run scoreboard players remove @s GOURMETMASTER 6
#set GOURMETMASTER ID
scoreboard players set @s FOODID 16
...
#reset
advancement revoke @s only att2_test:enchantment/gourmetmaster/cooked_salmon