...
execute if data entity @s SelectedItem.components."minecraft:potion_contents".custom_effects[{id:"minecraft:invisibility"}].amplifier store result score temp_value_3 CAL irun data get entity @s SelectedItem.components."minecraft:potion_contents".custom_effects[{id:"minecraft:invisibility"}].amplifier
