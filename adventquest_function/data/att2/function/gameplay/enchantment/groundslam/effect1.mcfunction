...
particle item{item:"minecraft:dirt"} ~ ~0.5 ~ 0 0 0 0.5 30 normal
particle item{item:"minecraft:gray_concrete"} ~ ~0.5 ~ 0 0 0 0.5 30 normal
particle item{item:"minecraft:iron_block"} ~ ~1 ~ 1.5 0.3 1.5 0 30 normal
