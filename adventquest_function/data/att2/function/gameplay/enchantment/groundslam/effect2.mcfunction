...
particle item{item:"minecraft:white_concrete"} ~ ~ ~ 1 0.3 1 0 30 normal
particle item{item:"minecraft:magenta_stained_glass"} ~ ~ ~ 1 0.3 1 0 30 normal
particle item{item:"minecraft:bone_block"} ~ ~ ~ 1 0.3 1 0 30 normal
particle item{item:"minecraft:calcite"} ~ ~ ~ 1 0.3 1 0 30 normal
particle dust_pillar{block_state:"minecraft:bone_block"} ~ ~ ~ 1 0.3 1 0 30 normal
#motion
