...
#get lvl data
execute store result score selflessaid ENCHANTMENT run data get entity 0428dc94-000a-09dc-04a1-935c00000001 equipment.mainhand.components."minecraft:enchantments"."att2_enchantment:selflessaid"
...
#test Conditions
execute store success score TEST ENCHANTMENT run enchant @e[tag=GET,limit=1,type=armor_stand,predicate=!att2_pre:enchantment/test_hold/myt,predicate=att2_pre:enchantment/test_hold/chest] att2_enchantment:selflessaid
execute unless score selflessaid ENCHANTMENT matches 1.. if score TEST ENCHANTMENT matches 0 run scoreboard players reset selflessaid ENCHANTMENT
execute if score TEST ENCHANTMENT matches 1.. run data remove entity 0428dc94-000a-09dc-04a1-935c00000001 equipment.mainhand.components."minecraft:enchantments"."att2_enchantment:selflessaid"
#feedback error
...
execute unless score selflessaid ENCHANTMENT matches 0.. if data entity 0428dc94-000a-09dc-04a1-935c00000001 equipment.mainhand run function att2:dialogs/gameplay/enchantment/item_error
...
execute if score TEST ENCHANTMENT matches 0 unless score selflessaid ENCHANTMENT matches 0.. if entity @e[tag=GET,limit=1,type=armor_stand,predicate=!att2_pre:enchantment/test_hold/myt,predicate=att2_pre:enchantment/test_hold/chest] run function att2:dialogs/gameplay/enchantment/conflict_error
...
execute if score selflessaid ENCHANTMENT matches 0.. run function att2:dialogs/gameplay/enchantment/data_show/selflessaid