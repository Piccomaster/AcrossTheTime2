...
#get lvl data
execute store result score heart_protection ENCHANTMENT run data get entity 0428dc94-000a-09dc-04a1-935c00000001 equipment.mainhand.components."minecraft:enchantments"."att2_enchantment:heart_protection"
...
#test Conditions
execute store success score TEST ENCHANTMENT run enchant @e[tag=GET,limit=1,type=armor_stand,predicate=!att2_pre:enchantment/test_hold/myt,predicate=att2_pre:enchantment/test_hold/chest] att2_enchantment:heart_protection
execute unless score heart_protection ENCHANTMENT matches 1.. if score TEST ENCHANTMENT matches 0 run scoreboard players reset heart_protection ENCHANTMENT
execute if score TEST ENCHANTMENT matches 1.. run data remove entity 0428dc94-000a-09dc-04a1-935c00000001 equipment.mainhand.components."minecraft:enchantments"."att2_enchantment:heart_protection"
#feedback error
...
execute unless score heart_protection ENCHANTMENT matches 0.. if data entity 0428dc94-000a-09dc-04a1-935c00000001 equipment.mainhand run function att2:dialogs/gameplay/enchantment/item_error
...
execute if score TEST ENCHANTMENT matches 0 unless score heart_protection ENCHANTMENT matches 0.. if entity @e[tag=GET,limit=1,type=armor_stand,predicate=!att2_pre:enchantment/test_hold/myt,predicate=att2_pre:enchantment/test_hold/chest] run function att2:dialogs/gameplay/enchantment/conflict_error
...
execute if score heart_protection ENCHANTMENT matches 0.. run function att2:dialogs/gameplay/enchantment/data_show/heart_protection