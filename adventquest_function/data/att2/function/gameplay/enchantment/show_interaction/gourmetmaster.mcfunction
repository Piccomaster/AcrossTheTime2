...
#get lvl data
execute store result score gourmetmaster ENCHANTMENT run data get entity 0428dc94-000a-09dc-04a1-935c00000001 equipment.mainhand.components."minecraft:enchantments"."att2_enchantment:gourmetmaster"
...
#test Conditions
execute store success score TEST ENCHANTMENT run enchant @e[tag=GET,limit=1,type=armor_stand,predicate=!att2_pre:enchantment/test_hold/myt,predicate=att2_pre:enchantment/test_hold/head] att2_enchantment:gourmetmaster
execute unless score gourmetmaster ENCHANTMENT matches 1.. if score TEST ENCHANTMENT matches 0 run scoreboard players reset gourmetmaster ENCHANTMENT
execute if score TEST ENCHANTMENT matches 1.. run data remove entity 0428dc94-000a-09dc-04a1-935c00000001 equipment.mainhand.components."minecraft:enchantments"."att2_enchantment:gourmetmaster"
#feedback error
...
execute unless score gourmetmaster ENCHANTMENT matches 0.. if data entity 0428dc94-000a-09dc-04a1-935c00000001 equipment.mainhand run function att2:dialogs/gameplay/enchantment/item_error
...
execute if score TEST ENCHANTMENT matches 0 unless score gourmetmaster ENCHANTMENT matches 0.. if entity @e[tag=GET,limit=1,type=armor_stand,predicate=!att2_pre:enchantment/test_hold/myt,predicate=att2_pre:enchantment/test_hold/head] run function att2:dialogs/gameplay/enchantment/conflict_error
...
#merge enchantment gourmetmaster
...
execute if score gourmetmaster ENCHANTMENT matches 0.. run function att2:dialogs/gameplay/enchantment/data_show/gourmetmaster