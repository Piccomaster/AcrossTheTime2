...
#item modify entity @s weapon.mainhand {function:"set_attributes",modifiers:[{amount:1,attribute:"attack_damage",id:"1000slay_attack_damage",operation:"add_value",slot:"mainhand"},{amount:-1,attribute:"max_health",id:"1000slay_max_health",operation:"add_multiplied_total",slot:"mainhand"}],replace:false}
