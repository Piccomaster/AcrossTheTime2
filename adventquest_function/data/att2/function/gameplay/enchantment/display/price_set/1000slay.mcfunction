...
##LVL 0
execute if score 1000slay ENCHANTMENT matches 0 run scoreboard players operation esc_cost ENCHANTMENT = 0 CAL
execute if score 1000slay ENCHANTMENT matches 0 run scoreboard players operation rune_cost ENCHANTMENT = 0 CAL
##LVL 1 
