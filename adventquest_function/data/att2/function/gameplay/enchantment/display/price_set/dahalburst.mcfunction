...
##LVL 2
execute if score now_lvl_show ENCHANTMENT matches 2 run scoreboard players operation esc_reduce ENCHANTMENT = dahalburst_esc_2 ENCHANTMENT_DATA
execute if score now_lvl_show ENCHANTMENT matches 2 run scoreboard players operation rune_reduce ENCHANTMENT = dahalburst_rune_2 ENCHANTMENT_DATA
###LVL3
execute if score now_lvl_show ENCHANTMENT matches 3 run scoreboard players operation esc_reduce ENCHANTMENT = dahalburst_esc_3 ENCHANTMENT_DATA
execute if score now_lvl_show ENCHANTMENT matches 3 run scoreboard players operation rune_reduce ENCHANTMENT = dahalburst_rune_3 ENCHANTMENT_DATA
##LVL 4
...
##LVL 0
execute if score dahalburst ENCHANTMENT matches 0 run scoreboard players operation esc_cost ENCHANTMENT = 0 CAL
execute if score dahalburst ENCHANTMENT matches 0 run scoreboard players operation rune_cost ENCHANTMENT = 0 CAL
##LVL 1 
...
##LVL 2
execute if score dahalburst ENCHANTMENT matches 2 run scoreboard players operation esc_cost ENCHANTMENT = dahalburst_esc_2 ENCHANTMENT_DATA
execute if score dahalburst ENCHANTMENT matches 2 run scoreboard players operation rune_cost ENCHANTMENT = dahalburst_rune_2 ENCHANTMENT_DATA
##LVL3
execute if score dahalburst ENCHANTMENT matches 3 run scoreboard players operation esc_cost ENCHANTMENT = dahalburst_esc_3 ENCHANTMENT_DATA
execute if score dahalburst ENCHANTMENT matches 3 run scoreboard players operation rune_cost ENCHANTMENT = dahalburst_rune_3 ENCHANTMENT_DATA
##LVL 4
