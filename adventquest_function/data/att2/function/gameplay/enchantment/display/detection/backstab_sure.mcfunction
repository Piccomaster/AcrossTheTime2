...
execute if score backstab ENCHANTMENT matches 1.. unless score backstab ENCHANTMENT > now_lvl_show ENCHANTMENT run return run function att2:dialogs/gameplay/enchantment/lvl_up_max
execute if score backstab ENCHANTMENT matches 0 run return run function att2:dialogs/gameplay/enchantment/no_zero
