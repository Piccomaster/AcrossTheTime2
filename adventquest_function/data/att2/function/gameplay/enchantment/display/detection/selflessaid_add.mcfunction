...
execute if score selflessaid ENCHANTMENT matches 5 run function att2:dialogs/gameplay/enchantment/lvl_max
execute if score selflessaid ENCHANTMENT matches 0..4 run function att2:gameplay/enchantment/effect/lvl_add
