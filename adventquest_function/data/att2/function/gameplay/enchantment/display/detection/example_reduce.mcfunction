...
execute if score XXX ENCHANTMENT > now_lvl_show ENCHANTMENT if score XXX ENCHANTMENT matches 2.. store result storage att2:enchantment end_lvl_show int 1 run scoreboard players get XXX ENCHANTMENT
#cal and set Materials cost
scoreboard players operation esc_cost ENCHANTMENT = XXX ENCHANTMENT
...
scoreboard players operation rune_cost ENCHANTMENT = XXX ENCHANTMENT
