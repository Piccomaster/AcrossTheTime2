...
execute if score bloodreaver ENCHANTMENT matches 1.. unless score bloodreaver ENCHANTMENT > now_lvl_show ENCHANTMENT run return run function att2:dialogs/gameplay/enchantment/lvl_up_max
execute if score bloodreaver ENCHANTMENT matches 0 run return run function att2:dialogs/gameplay/enchantment/no_zero
