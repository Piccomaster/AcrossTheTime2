...
execute if score groundslam ENCHANTMENT matches 0 run function att2:dialogs/gameplay/enchantment/no_zero
...
execute if score groundslam ENCHANTMENT matches 1.. unless score groundslam ENCHANTMENT > now_lvl_show ENCHANTMENT run function att2:dialogs/gameplay/enchantment/lvl_up_max
#RESET
