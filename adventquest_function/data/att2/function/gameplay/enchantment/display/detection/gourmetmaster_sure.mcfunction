...
execute if score sure ENCHANTMENT matches 2 if score gourmetmaster ENCHANTMENT matches 0 run function att2:dialogs/gameplay/enchantment/no_zero
execute if score sure ENCHANTMENT matches 2 if score gourmetmaster ENCHANTMENT matches 1.. run function att2:dialogs/gameplay/enchantment/sure2
...
#return maco
execute if score sure ENCHANTMENT matches 2 if score gourmetmaster ENCHANTMENT matches 1.. if score ready ENCHANTMENT matches 0 run function att2:gameplay/enchantment/add_enchantment/gourmetmaster with storage att2:enchantment
execute if score sure ENCHANTMENT matches 2 if score gourmetmaster ENCHANTMENT matches 1.. unless score ready ENCHANTMENT matches 0 run function att2:dialogs/gameplay/enchantment/lack_material
#RESET
