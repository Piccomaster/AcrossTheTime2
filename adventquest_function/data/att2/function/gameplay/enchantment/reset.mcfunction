...
scoreboard players reset greatsword ENCHANTMENT

scoreboard players reset groundslam ENCHANTMENT

scoreboard players reset combohit ENCHANTMENT
scoreboard players reset backstab ENCHANTMENT

scoreboard players reset armorbreak ENCHANTMENT
...
scoreboard players reset speartoss ENCHANTMENT
...
scoreboard players reset esc_count ENCHANTMENT
scoreboard players reset end_lvl_show ENCHANTMENT
scoreboard players reset now_lvl_show ENCHANTMENT
#tag reset
