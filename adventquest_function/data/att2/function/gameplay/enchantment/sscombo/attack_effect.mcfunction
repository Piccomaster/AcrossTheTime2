...
#damage run
execute if score @s SSCOMBO matches 5.. at @s anchored eyes positioned ^ ^ ^3 as @e[distance=..4,team=hostile,scores={GAMELEVEL=0..}] run function att2:gameplay/enchantment/sscombo/damage with storage att2:temp
#reset
