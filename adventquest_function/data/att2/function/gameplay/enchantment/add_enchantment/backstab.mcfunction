...
#advancement test
function att2:advancement/test_all/enchantments/backstab
#add enchantment
data remove entity 0428dc94-000a-09dc-04a1-935c00000001 equipment.mainhand.components."minecraft:enchantments"."att2_enchantment:backstab"
$enchant 0428dc94-000a-09dc-04a1-935c00000001 att2_enchantment:backstab $(backstab)