...
#add enchantment
data remove entity 0428dc94-000a-09dc-04a1-935c00000001 equipment.mainhand.components."minecraft:enchantments"."att2_enchantment:dahalburst"
$enchant 0428dc94-000a-09dc-04a1-935c00000001 att2_enchantment:dahalburst $(dahalburst)