...
#start enchantment
execute if score runeharden ENCHANTMENT matches 1.. run function att2:gameplay/enchantment/remove_interaction
execute if score runeharden ENCHANTMENT matches 1.. run scoreboard players set add_progress ENCHANTMENT 1
#reduce Materials
