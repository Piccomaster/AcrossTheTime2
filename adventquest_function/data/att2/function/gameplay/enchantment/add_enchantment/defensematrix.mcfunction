...
#merge item
data merge entity 0428dc94-000a-09dc-04a1-935c00000001 {equipment:{mainhand:{components:{"minecraft:blocks_attacks":{block_delay_seconds:0,block_sound:"item.shield.block",damage_reductions:[{base:1,factor:1,horizontal_blocking_angle:180}],disable_cooldown_scale:1,item_damage:{base:1,factor:0.2,threshold:1}}}}}}
