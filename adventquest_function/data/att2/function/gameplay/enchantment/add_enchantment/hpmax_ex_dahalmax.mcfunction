...
#add enchantment
data remove entity 0428dc94-000a-09dc-04a1-935c00000001 equipment.mainhand.components."minecraft:enchantments"."att2_enchantment:hpmax_ex_dahalmax"
$enchant 0428dc94-000a-09dc-04a1-935c00000001 att2_enchantment:hpmax_ex_dahalmax $(hpmax_ex_dahalmax)