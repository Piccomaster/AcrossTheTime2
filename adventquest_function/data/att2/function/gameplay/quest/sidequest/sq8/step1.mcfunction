...
execute in minecraft:overworld if data block -5094 73 -5060 LootTable positioned -5094 74 -5061 run function att2:gameplay/quest/mainquest/show_secondary_objective
execute in minecraft:overworld if data block -5092 73 -5060 LootTable positioned -5092 74 -5061 run function att2:gameplay/quest/mainquest/show_secondary_objective
