...
execute in minecraft:overworld if data block -4516 40 -4205 LootTable positioned -4513 37 -4207 run function att2:gameplay/quest/mainquest/show_secondary_objective