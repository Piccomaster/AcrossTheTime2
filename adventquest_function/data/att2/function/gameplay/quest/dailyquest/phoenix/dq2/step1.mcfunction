...
execute unless score phoenix_dailyquest_2_open_chest DAILYQUEST matches 1.. at @e[distance=..100,type=marker,tag=ChestMarker,limit=7,sort=nearest,predicate=att2_pre:location/angband/angor_ruin] positioned ~ ~-1 ~ run function att2:gameplay/gps/dailyquest/show_secondary_objective {color:12562813}
execute if score phoenix_dailyquest_2_open_chest DAILYQUEST matches 1 at @e[distance=..100,type=marker,tag=ChestMarker,limit=6,sort=nearest,predicate=att2_pre:location/angband/angor_ruin] positioned ~ ~-1 ~ run function att2:gameplay/gps/dailyquest/show_secondary_objective {color:12562813}
execute if score phoenix_dailyquest_2_open_chest DAILYQUEST matches 2 at @e[distance=..100,type=marker,tag=ChestMarker,limit=5,sort=nearest,predicate=att2_pre:location/angband/angor_ruin] positioned ~ ~-1 ~ run function att2:gameplay/gps/dailyquest/show_secondary_objective {color:12562813}
execute if score phoenix_dailyquest_2_open_chest DAILYQUEST matches 3 at @e[distance=..100,type=marker,tag=ChestMarker,limit=4,sort=nearest,predicate=att2_pre:location/angband/angor_ruin] positioned ~ ~-1 ~ run function att2:gameplay/gps/dailyquest/show_secondary_objective {color:12562813}
execute if score phoenix_dailyquest_2_open_chest DAILYQUEST matches 4 at @e[distance=..100,type=marker,tag=ChestMarker,limit=3,sort=nearest,predicate=att2_pre:location/angband/angor_ruin] positioned ~ ~-1 ~ run function att2:gameplay/gps/dailyquest/show_secondary_objective {color:12562813}
execute if score phoenix_dailyquest_2_open_chest DAILYQUEST matches 5 at @e[distance=..100,type=marker,tag=ChestMarker,limit=2,sort=nearest,predicate=att2_pre:location/angband/angor_ruin] positioned ~ ~-1 ~ run function att2:gameplay/gps/dailyquest/show_secondary_objective {color:12562813}
execute if score phoenix_dailyquest_2_open_chest DAILYQUEST matches 6 at @e[distance=..100,type=marker,tag=ChestMarker,limit=1,sort=nearest,predicate=att2_pre:location/angband/angor_ruin] positioned ~ ~-1 ~ run function att2:gameplay/gps/dailyquest/show_secondary_objective {color:12562813}