...
tellraw @s [{translate:att2.dailyquest.bow_kill.progress,color:"yellow",with:[{score:{name:ryliath_dailyquest_9_spell_kill,objective:DAILYQUEST},color:"gray"},{score:{name:ryliath_dailyquest_9_spell_kill_requirement,objective:DAILYQUEST},color:"dark_gray"}]}]
