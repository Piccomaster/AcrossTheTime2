...
execute if entity @s[scores={DIMENSION=1}] in minecraft:overworld as @e[type=armor_stand,tag=newGPS] at @s anchored feet facing -6021 131 -4277 run function att2:gameplay/gps/tp_arrow
...
execute if entity @s[scores={DIMENSION=0}] in minecraft:overworld as @e[type=armor_stand,tag=newGPS] at @s anchored feet facing -7507 124 -4304 run function att2:gameplay/gps/tp_arrow
