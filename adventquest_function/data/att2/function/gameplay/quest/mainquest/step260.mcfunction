...
execute if entity @s[scores={DIMENSION=1}] in minecraft:overworld as @e[type=armor_stand,tag=newGPS] at @s anchored feet facing -6022 200 -4292 run function att2:gameplay/gps/tp_arrow
