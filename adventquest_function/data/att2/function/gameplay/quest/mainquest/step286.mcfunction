...
execute in minecraft:overworld as @e[type=zombified_piglin,tag=newGPS] at @s anchored feet facing 1543.0 15 1495.0 run function att2:gameplay/gps/tp_arrow