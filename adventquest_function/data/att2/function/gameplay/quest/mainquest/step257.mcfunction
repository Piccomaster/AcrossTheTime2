...
execute if entity @s[scores={DIMENSION=1}] in minecraft:overworld as @e[type=zombified_piglin,tag=newGPS] at @s anchored feet facing -6041 137 -4314 run function att2:gameplay/gps/tp_arrow
...
execute if entity @s[scores={DIMENSION=0}] in minecraft:overworld as @e[type=zombified_piglin,tag=newGPS] at @s anchored feet facing -7544 153 -4313 run function att2:gameplay/gps/tp_arrow
