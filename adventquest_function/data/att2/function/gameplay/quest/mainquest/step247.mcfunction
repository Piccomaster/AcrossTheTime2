...
execute if entity @s[scores={DIMENSION=1}] in minecraft:overworld as @e[type=zombified_piglin,tag=newGPS] at @s anchored feet facing -6003 109 -4302 run function att2:gameplay/gps/tp_arrow
...
execute if entity @s[scores={DIMENSION=0}] in minecraft:overworld as @e[type=zombified_piglin,tag=newGPS] at @s anchored feet facing -7505 111 -4299 run function att2:gameplay/gps/tp_arrow
