...
execute if entity @s[scores={DIMENSION=1}] in minecraft:overworld as @e[type=zombified_piglin,tag=newGPS] at @s anchored feet facing -6000 161 -4272 run function att2:gameplay/gps/tp_arrow
