...
execute if entity @s[scores={DIMENSION=1}] in minecraft:overworld as @e[type=armor_stand,tag=newGPS] at @s anchored feet facing -5954 116 -4388 run function att2:gameplay/gps/tp_arrow
execute in minecraft:overworld if data block -5954 116 -4388 LootTable positioned -5958 124 -4383 run function att2:gameplay/quest/mainquest/show_secondary_objective
...
execute if entity @s[scores={DIMENSION=0}] in minecraft:overworld as @e[type=armor_stand,tag=newGPS] at @s anchored feet facing -7456 125 -4390 run function att2:gameplay/gps/tp_arrow
