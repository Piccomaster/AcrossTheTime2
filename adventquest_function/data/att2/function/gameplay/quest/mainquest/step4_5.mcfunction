...
execute in minecraft:overworld as @e[type=zombified_piglin,tag=newGPS] at @s anchored feet facing entity 00000000-0000-003a-0000-00000000003a eyes run function att2:gameplay/gps/tp_arrow