...
execute if entity @s[scores={DIMENSION=1}] in minecraft:overworld as @e[type=zombified_piglin,tag=newGPS] at @s anchored feet facing -5934 117 -4377 run function att2:gameplay/gps/tp_arrow
...
execute if entity @s[scores={DIMENSION=0}] in minecraft:overworld as @e[type=zombified_piglin,tag=newGPS] at @s anchored feet facing -7450 117 -4357 run function att2:gameplay/gps/tp_arrow
