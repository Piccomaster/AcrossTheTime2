...
execute if entity @s[scores={DIMENSION=1}] in minecraft:overworld as @e[type=armor_stand,tag=newGPS] at @s anchored feet facing -5869 94 -4544 run function att2:gameplay/gps/tp_arrow
...
execute if entity @s[scores={DIMENSION=0}] in minecraft:overworld as @e[type=armor_stand,tag=newGPS] at @s anchored feet facing -7330 78 -4555 run function att2:gameplay/gps/tp_arrow