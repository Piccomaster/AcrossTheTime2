...
execute in minecraft:the_end as @e[type=zombified_piglin,tag=newGPS] at @s anchored feet facing -1239 178 -607 run function att2:gameplay/gps/tp_arrow
...
execute in minecraft:the_end positioned -1239 28 -497 run function att2:gameplay/quest/mainquest/show_secondary_objective
