...
execute as @a[gamemode=adventure] at @s run function att2:gameplay/enveffect/temperature/go
...
execute if score tic TIMECOUNTER matches 11 run function att2:gameplay/enveffect/symbol/go
