...
scoreboard players operation @s SPD_EXT < 0 CAL
scoreboard players operation @s HAS_EXT = @s ENTEMPERATURE
scoreboard players operation @s HAS_EXT < 0 CAL
scoreboard players operation @s STR_EXT = @s ENTEMPERATURE
scoreboard players operation @s STR_EXT < 0 CAL
...
execute if score @s TEMPERATURE matches 50.. run return fail
