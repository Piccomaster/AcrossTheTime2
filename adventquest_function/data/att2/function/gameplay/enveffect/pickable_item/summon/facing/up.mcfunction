...
##tp item_display
execute as @n[distance=..10,type=minecraft:interaction,tag=New,tag=PickableItem] at @s anchored eyes positioned ^ ^ ^0.05 run tp @e[distance=..10,type=minecraft:item_display,tag=New,tag=PickableItem] ~ ~ ~ ~ ~