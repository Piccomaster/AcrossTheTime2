...
execute as @p[scores={GAMELEVEL=50..}] run xp add @s 15000
execute as @p[scores={LEVELMASTER=50..99}] run xp add @s 20000
execute as @p[scores={LEVELMASTER=100..149}] run xp add @s 25000
execute as @p[scores={LEVELMASTER=150..199}] run xp add @s 30000
execute as @p[scores={LEVELMASTER=200..249}] run xp add @s 40000
execute as @p[scores={LEVELMASTER=250..299}] run xp add @s 50000
execute as @p[scores={LEVELMASTER=300..}] run xp add @s 100000
