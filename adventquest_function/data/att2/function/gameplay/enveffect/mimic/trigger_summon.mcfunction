...
#SUMMON
execute if score trigger MIMIC matches 1900.. as @s at @s unless entity @e[distance=..0,tag=MIMIC,type=slime] run function att2:gameplay/enveffect/mimic/summon
#Fallback
