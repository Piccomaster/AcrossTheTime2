...
execute if score reward MIMIC matches ..50 run loot spawn ~ ~1 ~ loot att2:chest/reg1
execute if score reward MIMIC matches ..50 run loot spawn ~ ~1 ~ loot att2:chest/reg1
execute if score reward MIMIC matches ..50 run loot spawn ~ ~1 ~ loot att2:chest/reg1


execute if score reward MIMIC matches ..75 run loot spawn ~ ~1 ~ loot att2:chest/reg1
execute if score reward MIMIC matches ..75 run loot spawn ~ ~1 ~ loot att2:chest/reg1
execute if score reward MIMIC matches ..75 run loot spawn ~ ~1 ~ loot att2:chest/reg1
execute if score reward MIMIC matches ..75 run loot spawn ~ ~1 ~ loot att2:chest/reg1
