...
execute if score reward MIMIC matches ..50 run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score reward MIMIC matches ..50 run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score reward MIMIC matches ..50 run loot spawn ~ ~1 ~ loot att2:chest/reg3


execute if score reward MIMIC matches ..75 run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score reward MIMIC matches ..75 run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score reward MIMIC matches ..75 run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score reward MIMIC matches ..75 run loot spawn ~ ~1 ~ loot att2:chest/reg3
