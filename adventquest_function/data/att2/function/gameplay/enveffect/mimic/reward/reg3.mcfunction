...
loot spawn ~ ~1 ~ loot att2:chest/reg3
loot spawn ~ ~1 ~ loot att2:chest/reg3
loot spawn ~ ~1 ~ loot att2:chest/reg3

execute if score #LUC CAL matches 2.. run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score #LUC CAL matches 4.. run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score #LUC CAL matches 6.. run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score #LUC CAL matches 8.. run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score #LUC CAL matches 10.. run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score #LUC CAL matches 12.. run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score #LUC CAL matches 14.. run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score #LUC CAL matches 16.. run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score #LUC CAL matches 18.. run loot spawn ~ ~1 ~ loot att2:chest/reg3
execute if score #LUC CAL matches 20.. run loot spawn ~ ~1 ~ loot att2:chest/reg3
