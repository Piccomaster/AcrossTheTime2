...
execute if score reward MIMIC matches 76..100 run loot spawn ~ ~1 ~ loot att2:chest/reg2
execute if score reward MIMIC matches 76..100 run loot spawn ~ ~1 ~ loot att2:chest/reg2
execute if score reward MIMIC matches 76..100 run loot spawn ~ ~1 ~ loot att2:chest/reg2
execute if score reward MIMIC matches 76..100 run loot spawn ~ ~1 ~ loot att2:chest/reg2

execute if score reward MIMIC matches 101.. run loot spawn ~ ~1 ~ loot att2:chest/reg2
execute if score reward MIMIC matches 101.. run loot spawn ~ ~1 ~ loot att2:chest/reg2
execute if score reward MIMIC matches 101.. run loot spawn ~ ~1 ~ loot att2:chest/reg2
execute if score reward MIMIC matches 101.. run loot spawn ~ ~1 ~ loot att2:chest/reg2
execute if score reward MIMIC matches 101.. run loot spawn ~ ~1 ~ loot att2:chest/reg2
