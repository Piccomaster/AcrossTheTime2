...
#test health
execute store result score now_health MIMIC run scoreboard players get @n[distance=..0,type=slime,tag=MIMIC] ENEMYHEALTH
execute store result score max_health MIMIC run attribute @n[distance=..0,type=slime,tag=MIMIC] max_health get
#random event trigger (5 good event)+(5 bad event)
execute store result score 1RNG10 RNG run random value 1..10
execute if score 1RNG10 RNG matches 1 at @n[distance=..0,type=slime,tag=MIMIC] run function att2:gameplay/enveffect/mimic/rng_event/1
...
#reduce health
scoreboard players operation percent_cal MIMIC = @n[distance=..0,type=slime,tag=MIMIC] MIMIC
...
#test will die
execute if score reduce_health MIMIC >= now_health MIMIC if entity @n[distance=..0,type=slime,tag=MIMIC,tag=Reg1] at @n[distance=..0,type=slime,tag=MIMIC] run function att2:gameplay/enveffect/mimic/reward/reg1
execute if score reduce_health MIMIC >= now_health MIMIC if entity @n[distance=..0,type=slime,tag=MIMIC,tag=Reg2] at @n[distance=..0,type=slime,tag=MIMIC] run function att2:gameplay/enveffect/mimic/reward/reg2
execute if score reduce_health MIMIC >= now_health MIMIC if entity @n[distance=..0,type=slime,tag=MIMIC,tag=Reg3] at @n[distance=..0,type=slime,tag=MIMIC] run function att2:gameplay/enveffect/mimic/reward/reg3
execute if score reduce_health MIMIC >= now_health MIMIC if entity @n[distance=..0,type=slime,tag=MIMIC,tag=Reg4] at @n[distance=..0,type=slime,tag=MIMIC] run function att2:gameplay/enveffect/mimic/reward/reg4
#reduce health
scoreboard players operation @n[distance=..0,type=slime,tag=MIMIC] ENEMYHEALTH = remain_health MIMIC
