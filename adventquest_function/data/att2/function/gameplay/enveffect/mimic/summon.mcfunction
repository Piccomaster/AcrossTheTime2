...
#summon mimic
summon minecraft:slime ~ ~ ~ {Tags:["New","MIMIC","LVL0","PlayerAlly"],DeathLootTable:"att2:empty",Size:1,Silent:1b,active_effects:[{id:invisibility,amplifier:1,duration:-1,show_particles:0b},{id:fire_resistance,amplifier:0,duration:-1,show_particles:0b},{id:resistance,amplifier:4,duration:-1,show_particles:0b}],attributes:[{id:max_health,base:50}],Health:50,Passengers:[{id:"minecraft:item_display",item:{id:"minecraft:chest",count:1},Tags:["MIMIC","New"],item_display:"head",transformation:{translation:[0f,-0.45f,0f],scale:[1f,1f,1f]},teleport_duration:20}],equipment:{head:{id:"diamond_helmet",components:{enchantments:{"att2_enchantment:tick/mob_initialize":1,"att2_enchantment:tick/misc/mimic":1},attribute_modifiers:[],unbreakable:{},item_model:"nothing",equippable:{slot:head}}}},PersistenceRequired:1b}
#set scale value
data merge entity @e[distance=..10,tag=MIMIC,tag=New,type=item_display,limit=1] {transformation:{translation:[0f,-0.45f,0f],scale:[1f,1f,1f]},glow_color_override:-1,Glowing:1b}
#set DIMENSION->LOOT
