...
execute if score 1RNG10 RNG matches 1..10 run function att2:summon/reg_3/golemarcher1_classx {class:CLASS11}
...
execute if score 1RNG10 RNG matches 1..6 run function att2:summon/reg_3/golemarcher2_classx {class:CLASS13}
execute if score 1RNG10 RNG matches 1..5 run function att2:summon/reg_3/golem2_classx {class:CLASS14}
execute if score 1RNG10 RNG matches 1..4 run function att2:summon/reg_3/golemarcher3_classx {class:CLASS14}
...
execute if score 1RNG10 RNG matches 1 run function att2:summon/reg_3/golemarcher4_classx {class:CLASS16}
