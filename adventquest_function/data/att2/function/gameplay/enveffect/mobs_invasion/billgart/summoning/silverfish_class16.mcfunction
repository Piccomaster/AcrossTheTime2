...
execute if score 1RNG10 RNG matches 1..10 run function att2:summon/reg_3/silverfish0_classx {class:CLASS10}
execute if score 1RNG10 RNG matches 1..10 run function att2:summon/reg_3/silverfish0_classx {class:CLASS11}
execute if score 1RNG10 RNG matches 1..10 run function att2:summon/reg_3/silverfish1_classx {class:CLASS11}
execute if score 1RNG10 RNG matches 1..9 run function att2:summon/reg_3/silverfish1_classx {class:CLASS12}
execute if score 1RNG10 RNG matches 1..8 run function att2:summon/reg_3/silverfish1_classx {class:CLASS12}
execute if score 1RNG10 RNG matches 1..7 run function att2:summon/reg_3/silverfish2_classx {class:CLASS13}
execute if score 1RNG10 RNG matches 1..6 run function att2:summon/reg_3/silverfish2_classx {class:CLASS13}
execute if score 1RNG10 RNG matches 1..5 run function att2:summon/reg_3/silverfish2_classx {class:CLASS14}
execute if score 1RNG10 RNG matches 1..4 run function att2:summon/reg_3/silverfish3_classx {class:CLASS14}
execute if score 1RNG10 RNG matches 1..3 run function att2:summon/reg_3/silverfish3_classx {class:CLASS15}
...
##spread
spreadplayers ~ ~ 1 7 under 40 false @e[distance=..7,tag=LVL0]