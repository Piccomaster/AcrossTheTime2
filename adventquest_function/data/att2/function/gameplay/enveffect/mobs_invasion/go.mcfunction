...
execute if score Invasion TIMER matches 0.. if entity @e[type=chest_minecart,tag=invasion_chest] as @e[type=chest_minecart,tag=invasion_chest] at @s run function att2:gameplay/enveffect/mobs_invasion/chest_effect
execute if score Invasion TIMER matches 0.. as @e[type=chest_minecart,tag=invasion_chest,scores={INVASION=..0}] at @s run kill @s
