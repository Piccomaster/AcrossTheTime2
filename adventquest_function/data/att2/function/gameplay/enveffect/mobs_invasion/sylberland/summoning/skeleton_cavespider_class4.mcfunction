...
execute if score 1RNG10 RNG matches 1..10 run function att2:summon/reg_1/cavespider0_classx {class:CLASS1}
execute if score 1RNG10 RNG matches 1..9 run function att2:summon/reg_1/cavespider0_classx {class:CLASS1}
execute if score 1RNG10 RNG matches 1..8 run function att2:summon/reg_1/cavespider0_classx {class:CLASS1}
execute if score 1RNG10 RNG matches 1..7 run function att2:summon/reg_1/cavespider0_classx {class:CLASS2}
...
execute if score 1RNG10 RNG matches 1..3 run function att2:summon/reg_1/cavespider0_classx {class:CLASS3}
