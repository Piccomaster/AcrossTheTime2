...
execute if score level DIFFICULTY matches 0 run damage @s 30 att2_damage:magic by @p
execute if score level DIFFICULTY matches 1 run damage @s 40 att2_damage:magic by @p
execute if score level DIFFICULTY matches 2 run damage @s 50 att2_damage:magic by @p