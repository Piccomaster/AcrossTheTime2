...
playsound minecraft:block.vault.open_shutter ambient @a ~ ~ ~ 3 0.8
particle minecraft:glow ~ ~ ~ 1.6 1.6 1.6 0 50 normal
particle minecraft:flash{color:[0.13,0.63,0.55,1]} ~ ~ ~ 1.6 1.6 1.6 0 32 normal
