...
playsound minecraft:block.vault.open_shutter ambient @a ~ ~ ~ 3 0.7
particle minecraft:glow ~ ~ ~ 1.4 1.4 1.4 0 40 normal
particle minecraft:flash{color:[0.13,0.63,0.55,1]} ~ ~ ~ 1.2 1.2 1.2 0 24 normal
