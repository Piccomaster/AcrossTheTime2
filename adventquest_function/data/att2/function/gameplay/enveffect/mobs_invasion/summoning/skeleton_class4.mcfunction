...
execute if score 1RNG10 RNG matches 1..10 run function att2:summon/reg_1/skeleton0_classx {class:CLASS1}
execute if score 1RNG10 RNG matches 1..10 run function att2:summon/reg_1/skeleton2_classx {class:CLASS1}
...
execute if score 1RNG10 RNG matches 1..7 run function att2:summon/reg_1/skeleton0_classx {class:CLASS2}
execute if score 1RNG10 RNG matches 1..6 run function att2:summon/reg_1/skeleton2_classx {class:CLASS2}
execute if score 1RNG10 RNG matches 1..5 run function att2:summon/reg_1/skeleton1_classx {class:CLASS2}
execute if score 1RNG10 RNG matches 1..4 run function att2:summon/reg_1/skeleton3_classx {class:CLASS2}
execute if score 1RNG10 RNG matches 1..3 run function att2:summon/reg_1/skeleton1_classx {class:CLASS3}
