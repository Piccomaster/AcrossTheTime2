...
execute if score 1RNG10 RNG matches 1..7 run function att2:summon/reg_4/phantom2_classx {class:CLASS8}
execute if score 1RNG10 RNG matches 1..6 run function att2:summon/reg_4/phantom2_classx {class:CLASS8}
...
execute if score 1RNG10 RNG matches 1..3 run function att2:summon/reg_4/phantom3_classx {class:CLASS9}
execute if score 1RNG10 RNG matches 1..2 run function att2:summon/reg_4/phantom3_classx {class:CLASS9}
execute if score 1RNG10 RNG matches 1 run function att2:summon/reg_4/blaze4_classx {class:CLASS16}
execute if score 1RNG10 RNG matches 1 run function att2:summon/reg_4/phantom4_classx {class:CLASS16}
