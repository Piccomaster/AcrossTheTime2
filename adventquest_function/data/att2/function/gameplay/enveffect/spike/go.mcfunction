...
execute as @a[tag=!impaled] at @s if block ~ ~ ~ minecraft:purple_carpet run function att2:gameplay/enveffect/spike/damage
execute as @a[tag=impaled] at @s unless block ~ ~ ~ minecraft:purple_carpet run tag @s remove impaled
execute as @a[tag=!impaled] at @s if block ~ ~ ~ minecraft:purple_carpet run tag @s add impaled
