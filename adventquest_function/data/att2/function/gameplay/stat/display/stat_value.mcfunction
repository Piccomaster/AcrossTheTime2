...
#DAR
execute if score @s DAR_DISPLAY matches 1.. run data modify storage att2:stat_display dar set value {translate:att2.stat.display.dar.value,color:"gray",with:[{score:{name:"DAHAL_REGEN",objective:"CAL"},color:green}]}
#HUN
