...
scoreboard players operation @s[scores={TIMER_HUN_TOT=..0}] TIMER_HUN_TOT = malus_4 HUN_DATA
#get score
scoreboard players operation #TIMER_HUN_TOT HUN_DATA = #malus_4 HUN_DATA
