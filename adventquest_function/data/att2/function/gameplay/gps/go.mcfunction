...
##new display timer
execute if score tic TIMECOUNTER matches 5 as @e[type=minecraft:item_display,tag=DailyQuest,scores={GPS_TIMER=0..}] at @s run function att2:gameplay/gps/dailyquest/go