...
##tip
execute on passengers if entity @s[type=player,tag=HorseRace] run function att2:gameplay/horse_racing/time_record/eolorion/time_over
...
##spread @s
spreadplayers ~ ~ 3 7 under 71 false @s
...
##dailyquest trigger
##eolorion
execute on passengers if entity @s[type=player,tag=HorseRace] if score Rank HORSERACE matches ..3 if score eolorion_dailyquest_9 DAILYQUEST matches 4 run function att2:cinematic/dailyquest/eolorion/9/step4
execute on passengers if entity @s[type=player,tag=HorseRace] if score Rank HORSERACE matches 4.. if score eolorion_dailyquest_9 DAILYQUEST matches 4 run function att2:cinematic/dailyquest/eolorion/9/step5
...
tellraw @a[distance=..20] [{translate:att2.dailyquest.horse_racing.complete_the_race.options.1,click_event:{action:run_command,command:"/trigger ScoreTrigger set 3401"},hover_event:{action:show_text,value:[{translate:att2.dailyquest.horse_racing.complete_the_race.options.1.hover_event}]}}]