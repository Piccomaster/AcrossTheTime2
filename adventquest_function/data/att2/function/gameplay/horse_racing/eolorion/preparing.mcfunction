...
##forbidden
function att2:gameplay/horse_racing/eolorion/forbidden

##particle
execute if score preparation_time HORSERACE matches ..20 run particle scrape -5361 143 -5898 0 0.5 1.5 0 100 normal
execute if score preparation_time HORSERACE matches 21..40 run particle scrape -5361 143 -5898 1.5 1.0 0 0 100 normal
execute if score preparation_time HORSERACE matches 41..60 run particle scrape -5361 143 -5898 1.5 1.5 0 0 100 normal
execute if score preparation_time HORSERACE matches 61..80 run particle scrape -5361 143 -5898 1.5 2.0 0 0 100 normal
execute if score preparation_time HORSERACE matches 81..100 run particle scrape -5361 143 -5898 1.5 2.5 0 0 100 normal
execute if score preparation_time HORSERACE matches 101..120 run particle scrape -5361 143 -5898 1.5 3.0 0 0 100 normal
execute if score preparation_time HORSERACE matches 121..140 run particle scrape -5361 143 -5898 1.5 3.5 0 0 100 normal
execute if score preparation_time HORSERACE matches 141..160 run particle scrape -5361 143 -5898 1.5 4.0 0 0 100 normal
execute if score preparation_time HORSERACE matches 161..180 run particle scrape -5361 143 -5898 1.5 4.5 0 0 100 normal
execute if score preparation_time HORSERACE matches 181..200 run particle scrape -5361 143 -5898 1.5 5.0 0 0 100 normal
execute if score preparation_time HORSERACE matches 201.. run particle dust_color_transition{from_color:[0.76,0.18,0.18],scale:1,to_color:[0.67,0,0]} -5361 143 -5898 1.5 5 0 0 100 normal
...
execute in overworld positioned -5621 75 -4588 run function att2:gameplay/horse_racing/eolorion/start
##reset forbidden
function att2:gameplay/horse_racing/eolorion/remove_forbidden