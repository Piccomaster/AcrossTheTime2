...
##reduce more event time
scoreboard players operation #reduce_time CAL = #ailvl CAL
scoreboard players operation #reduce_time CAL *= 40 CAL
scoreboard players operation @s HORSERACE_RANDOM_EVENT -= #reduce_time CAL
##random select
