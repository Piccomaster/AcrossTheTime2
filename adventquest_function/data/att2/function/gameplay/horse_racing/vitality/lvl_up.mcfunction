...
##give item_a
execute as @p[distance=..0] at @s run loot give @s loot att2:item_data/misc/horse_racing/special_item_a
execute as @p[distance=..0] at @s run loot give @s loot att2:item_data/misc/horse_racing/special_item_a
execute as @p[distance=..0] at @s run loot give @s loot att2:item_data/misc/horse_racing/special_item_b
execute as @p[distance=..0] at @s run loot give @s loot att2:item_data/misc/horse_racing/special_item_b
##sound
