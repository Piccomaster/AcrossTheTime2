...
execute in overworld as 00000000-0000-120a-0000-00000000120a at @s run data modify entity 00000000-0000-120a-0000-00000000120a data.rotation set value [-145,0]
##summon interaction
