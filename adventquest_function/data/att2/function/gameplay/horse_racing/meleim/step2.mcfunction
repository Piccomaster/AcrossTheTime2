...
execute in overworld as 00000000-0000-039a-0000-00000000039a at @s run data modify entity 00000000-0000-039a-0000-00000000039a data.rotation set value [90,0]
