...
##tip
execute on passengers if entity @s[type=player,tag=HorseRace] run function att2:gameplay/horse_racing/time_record/meleim/time_over
...
##dailyquest trigger
##meleim
execute on passengers if entity @s[type=player,tag=HorseRace] if score Rank HORSERACE matches ..3 if score meleim_dailyquest_9 DAILYQUEST matches 4 run function att2:cinematic/dailyquest/meleim/9/step4
execute on passengers if entity @s[type=player,tag=HorseRace] if score Rank HORSERACE matches 4.. if score meleim_dailyquest_9 DAILYQUEST matches 4 run function att2:cinematic/dailyquest/meleim/9/step5
##reset horse data
...
execute on passengers if entity @s[type=player] run tellraw @s [{translate:att2.dailyquest.horse_racing.complete_the_race.options.1,click_event:{action:run_command,command:"/trigger ScoreTrigger set 3390"},hover_event:{action:show_text,value:[{translate:att2.dailyquest.horse_racing.complete_the_race.options.1.hover_event}]}}]