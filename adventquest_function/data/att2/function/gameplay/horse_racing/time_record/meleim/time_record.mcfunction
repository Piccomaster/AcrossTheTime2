...
##sync score
scoreboard players operation meleim_rt HORSERACE = time_t HORSERACE
scoreboard players operation meleim_rs HORSERACE = time_s HORSERACE
scoreboard players operation meleim_rm HORSERACE = time_m HORSERACE