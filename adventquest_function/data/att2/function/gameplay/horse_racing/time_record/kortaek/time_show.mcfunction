...
tellraw @s {translate:att2.dailyquest.horse_racing.time_record.kortaek.time,with:[{score:{name:"kortaek_rm",objective:HORSERACE},color:"yellow"},{score:{name:"kortaek_rs",objective:HORSERACE},color:"yellow"}]}
