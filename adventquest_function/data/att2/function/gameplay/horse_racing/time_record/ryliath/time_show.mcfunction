...
tellraw @s {translate:att2.dailyquest.horse_racing.time_record.ryliath.time,with:[{score:{name:"ryliath_rm",objective:HORSERACE},color:"yellow"},{score:{name:"ryliath_rs",objective:HORSERACE},color:"yellow"}]}
