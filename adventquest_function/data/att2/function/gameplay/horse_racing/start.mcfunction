...
execute as @a[tag=HorseRace] at @s run function att2:gameplay/horse_racing/record_ride

##spread
spreadplayers ~ ~ 1 3 under 86 false @e[type=#minecraft:rideable,tag=HorseRace]