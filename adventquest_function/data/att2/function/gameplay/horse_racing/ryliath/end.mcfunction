...
##tip
execute on passengers if entity @s[type=player,tag=HorseRace] run function att2:gameplay/horse_racing/time_record/ryliath/time_over
...
##dailyquest trigger
##ryliath
execute on passengers if entity @s[type=player,tag=HorseRace] if score Rank HORSERACE matches ..3 if score ryliath_dailyquest_11 DAILYQUEST matches 4 run function att2:cinematic/dailyquest/ryliath/11/step4
execute on passengers if entity @s[type=player,tag=HorseRace] if score Rank HORSERACE matches 4.. if score ryliath_dailyquest_11 DAILYQUEST matches 4 run function att2:cinematic/dailyquest/ryliath/11/step5
...
execute on passengers if entity @s[type=player] run tellraw @s [{translate:att2.dailyquest.horse_racing.complete_the_race.options}]
execute on passengers if entity @s[type=player] run tellraw @s [{translate:att2.dailyquest.horse_racing.complete_the_race.options.1,click_event:{action:run_command,command:"/trigger ScoreTrigger set 3396"},hover_event:{action:show_text,value:[{translate:att2.dailyquest.horse_racing.complete_the_race.options.1.hover_event}]}}]