...
execute on vehicle if entity @s[tag=RIDE] run data modify entity @s attributes set value [{id:max_health,base:0,modifiers:[{id:"minecraft:true_health",amount:40}]},{id:movement_speed,base:0.20},{id:safe_fall_distance,base:777},{id:jump_strength,base:0.8}]
