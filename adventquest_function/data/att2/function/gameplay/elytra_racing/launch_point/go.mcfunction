...
##test if unlock
execute unless score @s ElytraRacing matches 1.. run function att2:gameplay/elytra_racing/launch_point/unlock_detection
...
scoreboard players set @a[distance=..5,scores={ElytraRacingTime=..20}] ElytraRacingTime 20
