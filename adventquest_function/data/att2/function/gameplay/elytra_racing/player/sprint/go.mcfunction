...
##test onground
execute if predicate att2_pre:player/onground run return run function att2:gameplay/elytra_racing/player/mistake/on_ground
##remove score
execute if score @s ElytraRacingSprintTime matches 3 run playsound block.respawn_anchor.charge block @a ~ ~ ~ 1 1
