#############################################################
#Made by Adventquest                                        
#function att2:gameplay/elytra_racing/ai/kert               
#############################################################
...
##test near next pos
execute if entity @n[distance=..5,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Kert,predicate=att2_pre:score/elytra_racing/next_pos] run function att2:gameplay/elytra_racing/ai/next_pos
...
execute if score @s ElytraRacing < #max_pos CAL run tp @n[type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Kert,predicate=att2_pre:score/elytra_racing/next_pos]
##facing next pos
execute on passengers run rotate @s facing entity @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Kert,predicate=att2_pre:score/elytra_racing/next_pos] eyes

execute if score #offset CAL matches 0 at @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Kert,predicate=att2_pre:score/elytra_racing/next_pos] positioned ~ ~ ~ run rotate @s facing ~ ~ ~
execute if score #offset CAL matches 1 at @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Kert,predicate=att2_pre:score/elytra_racing/next_pos] positioned ~1 ~ ~1 run rotate @s facing ~ ~ ~
execute if score #offset CAL matches 2 at @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Kert,predicate=att2_pre:score/elytra_racing/next_pos] positioned ~-1 ~ ~-1 run rotate @s facing ~ ~ ~
execute if score #offset CAL matches 3 at @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Kert,predicate=att2_pre:score/elytra_racing/next_pos] positioned ~-1 ~ ~1 run rotate @s facing ~ ~ ~
execute if score #offset CAL matches 4 at @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Kert,predicate=att2_pre:score/elytra_racing/next_pos] positioned ~1 ~ ~-1 run rotate @s facing ~ ~ ~
