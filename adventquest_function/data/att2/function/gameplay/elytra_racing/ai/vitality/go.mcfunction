...
scoreboard players operation #Speed_Add CAL = #ailvl CAL
scoreboard players add #Speed_Add CAL 1
scoreboard players operation #Speed CAL *= #Speed_Add CAL
scoreboard players add #Speed CAL 18
