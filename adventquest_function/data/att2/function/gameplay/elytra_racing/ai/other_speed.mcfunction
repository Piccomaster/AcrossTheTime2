#############################################################
#Made by Adventquest                                        
#function att2:gameplay/elytra_racing/ai/other_speed        
#############################################################
...
##add attribute id
attribute @s movement_speed modifier add horse_race_other_speed 0 add_value
##CAL sprint speed
scoreboard players operation #Other_Speed CAL = @s HORSERACE_OTHER_SPEED_TIMER
execute store result entity @s attributes[{id:"minecraft:movement_speed"}].modifiers[{id:"minecraft:horse_race_other_speed"}].amount double 0.0025 run scoreboard players get #Other_Speed CAL
...
attribute @s movement_speed modifier remove horse_race_other_speed