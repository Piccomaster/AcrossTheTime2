#############################################################
#Made by Adventquest                                        
#function att2:gameplay/elytra_racing/ai/plain              
#############################################################
...
##test near next pos
execute if entity @n[distance=..5,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Plain,predicate=att2_pre:score/elytra_racing/next_pos] run function att2:gameplay/elytra_racing/ai/next_pos

##get score
scoreboard players set #max_pos CAL 0
scoreboard players operation #max_pos CAL > @a[scores={ElytraRacingSelect=5}] ElytraRacing
scoreboard players remove #max_pos CAL 1
execute if score @s ElytraRacing < #max_pos CAL run tp @n[type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Plain,predicate=att2_pre:score/elytra_racing/next_pos]
##facing next pos
execute on passengers run rotate @s facing entity @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Plain,predicate=att2_pre:score/elytra_racing/next_pos] eyes

execute if score #offset CAL matches 0 at @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Plain,predicate=att2_pre:score/elytra_racing/next_pos] positioned ~ ~ ~ run rotate @s facing ~ ~ ~
execute if score #offset CAL matches 1 at @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Plain,predicate=att2_pre:score/elytra_racing/next_pos] positioned ~1 ~ ~1 run rotate @s facing ~ ~ ~
execute if score #offset CAL matches 2 at @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Plain,predicate=att2_pre:score/elytra_racing/next_pos] positioned ~-1 ~ ~-1 run rotate @s facing ~ ~ ~
execute if score #offset CAL matches 3 at @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Plain,predicate=att2_pre:score/elytra_racing/next_pos] positioned ~-1 ~ ~1 run rotate @s facing ~ ~ ~
execute if score #offset CAL matches 4 at @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Plain,predicate=att2_pre:score/elytra_racing/next_pos] positioned ~1 ~ ~-1 run rotate @s facing ~ ~ ~
...
kill @e[type=mannequin,tag=AI,tag=ElytraRace,tag=Plain]
