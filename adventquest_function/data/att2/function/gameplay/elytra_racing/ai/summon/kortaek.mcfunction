#############################################################
#Made by Adventquest                                        
#function att2:gameplay/elytra_racing/ai/summon/kortaek     
#############################################################
