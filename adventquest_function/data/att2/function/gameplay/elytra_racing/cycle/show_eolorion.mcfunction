...
#facing
rotate @s facing entity @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Eolorion,predicate=att2_pre:score/elytra_racing/next_pos]

##
execute at @s as @p[tag=TEMP] run function att2:gameplay/elytra_racing/cycle/particle/eolorion
