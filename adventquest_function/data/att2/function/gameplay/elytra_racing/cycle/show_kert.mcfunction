...
##normal
execute at @s as @p[tag=TEMP] run function att2:gameplay/elytra_racing/cycle/particle/kert
##SuperDash
execute at @s if score #rotation1 CAL matches -90..-80 as @p[tag=TEMP] run function att2:gameplay/elytra_racing/cycle/particle/kert_super_dash