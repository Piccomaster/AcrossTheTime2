...
##update light
execute at @s run function att2:gameplay/elytra_racing/cycle/show_light
...
#facing
execute at @s run rotate @s facing entity @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Asunark,predicate=att2_pre:score/elytra_racing/next_pos]

##
execute at @s as @p[tag=TEMP] run function att2:gameplay/elytra_racing/cycle/particle/asunark
