...
##update pos
execute if score @s ElytraRacing matches 1..458 unless entity @n[distance=..50,type=marker,tag=ElytraRace,tag=Worlest,tag=ElytraRoute,predicate=att2_pre:score/elytra_racing/next_pos] run function att2:gameplay/elytra_racing/player/mistake/too_far
...
##test end
execute unless score @s ElytraRacing matches 458.. run return fail
execute in overworld positioned -4918 140 -5478 unless entity @s[distance=..5] run return fail

##end effect
execute in overworld positioned -4918 140 -5478 run tp @s -4919 140 -5477
