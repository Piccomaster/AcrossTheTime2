...
#luck
execute if score @s LUC_TOT matches 2.. run loot spawn ~ ~ ~ loot att2:chest/reg1
execute if score @s LUC_TOT matches 4.. run loot spawn ~ ~ ~ loot att2:chest/reg1
execute if score @s LUC_TOT matches 6.. run loot spawn ~ ~ ~ loot att2:chest/reg1
