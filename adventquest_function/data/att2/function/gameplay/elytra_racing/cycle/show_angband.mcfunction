...
#facing
rotate @s facing entity @n[distance=..50,type=marker,tag=ElytraRace,tag=ElytraRoute,tag=Angband,predicate=att2_pre:score/elytra_racing/next_pos]
##cal SuperDash
...
##normal
execute at @s as @p[tag=TEMP] run function att2:gameplay/elytra_racing/cycle/particle/angband
##SuperDash
execute at @s if score #rotation1 CAL matches -90..-80 as @p[tag=TEMP] run function att2:gameplay/elytra_racing/cycle/particle/angband_super_dash