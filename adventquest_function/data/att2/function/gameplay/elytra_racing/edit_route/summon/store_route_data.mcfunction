#############################################################
#Made by Adventquest                                        
#function att2:gameplay/elytra_racing/edit_route/summon/store_route_data
#############################################################
...
##append
$data modify storage att2:elytra_racing route_$(route_id) append from storage att2:elytra_racing temp