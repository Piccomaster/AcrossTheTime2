...
execute as @e[type=armor_stand,tag=showing,tag=circle,tag=following] at @s positioned ~ ~ ~ align xz run data modify entity @s Marker set value 1
execute as @e[type=armor_stand,tag=showing,tag=circle,tag=following] at @s positioned ~ ~ ~ align xz run data modify entity @s Invisible set value 1
execute as @e[type=armor_stand,tag=showing,tag=circle,tag=following] at @s positioned ~ ~ ~ align xz run tp @s ~0.5 ~ ~0.5 ~ ~
