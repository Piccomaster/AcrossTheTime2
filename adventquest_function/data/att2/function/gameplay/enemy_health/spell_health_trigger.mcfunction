...
##cal damage
function att2:gameplay/enemy_health/health_cal/spell_damage
#get max_health
...
##back damage
execute on attacker run function att2:gameplay/enemy_health/data/spell_trigger
##absorption_health
...
execute if score #absorption_health CAL matches 1.. run function att2:gameplay/enemy_health/show_absorption_health_reduce/spell
...
##tip
execute as @s[type=!bat] at @s run function att2:gameplay/enemy_health/show_health_reduce/spell
##update healthbar
