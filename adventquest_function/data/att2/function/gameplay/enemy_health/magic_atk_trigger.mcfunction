...
execute if score #absorption_health CAL matches 1.. run function att2:gameplay/enemy_health/show_health_reduce/magic
...
execute if score @s ENEMYHEALTH matches ..0 at @s on attacker run return run damage @n[distance=..0,team=hostile] 7777777777777777 att2_damage:player_attack by @s
