...
##cal damage
function att2:gameplay/enemy_health/health_cal/arrow_damage
#get max_health
...
execute if score @s ENEMYHEALTH matches ..0 at @s on attacker run return run damage @n[distance=..0] 7777777777777777 att2_damage:arrow by @s
