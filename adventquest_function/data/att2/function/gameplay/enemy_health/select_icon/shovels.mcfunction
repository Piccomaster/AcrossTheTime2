...
execute if items entity @s weapon.mainhand minecraft:diamond_shovel[custom_data~{Rarity:myt,EquipmentID:loneshadow}] run return run data modify storage att2:enemy_health icon set value "item/custom/loneshadow"
