...
execute if score #absorption_health CAL matches 1.. run function att2:gameplay/enemy_health/show_absorption_health_reduce/fire
...
##tip
execute as @s[type=!bat] at @s run function att2:gameplay/enemy_health/show_health_reduce/fire
##update healthbar
function att2:gameplay/healthbar/detection_enemy
scoreboard players set #reduce_health CAL 0
execute if score @s ENEMYHEALTH matches ..0 run tag @s add killed
execute if score @s ENEMYHEALTH matches ..0 at @s on attacker run return run damage @n[distance=..0,team=hostile] 7777777777777777 att2_damage:fire by @s
