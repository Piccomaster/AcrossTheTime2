...
##get atk damage
scoreboard players operation #DMG CAL = finalDG SPDG
#tellraw @a ["初始伤害: ",{score:{name:"#DMG",objective:"CAL"}}]

##protection
function att2:gameplay/enemy_health/health_cal/cal_protection
##magic_protection
function att2:gameplay/enemy_health/health_cal/cal_magic_protection
##resistance
...
#tellraw @a ["法术伤害: ",{score:{name:"#DMG",objective:"CAL"}}]