...
execute if score black_fading TIMER matches 1 as @a[scores={NUMEROJOUEUR=1}] at @s run summon minecraft:armor_stand ^ ^ ^1.6 {Tags:["BlackFading"],NoBasePlate:1,Invisible:1,NoGravity:1,Marker:1,ShowArms:0,DisabledSlots:2039552,equipment:{{},{},{},{}}}
