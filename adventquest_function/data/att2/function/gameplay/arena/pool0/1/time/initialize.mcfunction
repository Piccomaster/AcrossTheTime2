...
scoreboard players set pool0_1_rt BOSS_TIME 7777777
scoreboard players set pool0_1_rs BOSS_TIME 7777777
scoreboard players set pool0_1_rm BOSS_TIME 7777777
