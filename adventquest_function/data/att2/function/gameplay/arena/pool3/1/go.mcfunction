...
execute if score Pool3_A1 ARENA matches 0.. as @e[type=vex,x=4905,y=70,z=-4947,dx=190,dy=30,dz=130,tag=!ArenaMinion] at @s unless score @s CLASSLEVEL matches 1.. run function att2:gameplay/arena/vex_tag
execute if score Pool3_A1 ARENA matches 0.. as @e[type=vex,x=4905,y=70,z=-4947,dx=190,dy=30,dz=130,tag=!Empty,scores={CLASSLEVEL=1..}] at @s run data merge entity @s {DeathLootTable:"att2:empty",Tags:["Empty"]}
