...
execute if score pool4_total_m BOSS_TIME matches ..59 if score level DIFFICULTY matches 1.. run advancement grant @a only att2:challenge/arena_hard_timerecord