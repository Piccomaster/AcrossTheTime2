...
# Shadow
execute if score Pool1_A6 ARENA matches 0.. as @e[x=4734,y=70,z=-4965,dx=75,dy=56,dz=-71,tag=ShadowBoss,limit=1] store result bossbar minecraft:shadow value run scoreboard players get @s 
