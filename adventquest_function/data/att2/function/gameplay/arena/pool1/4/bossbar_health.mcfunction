...
execute if score Pool1_A4 ARENA matches 0.. unless entity @e[x=4828,y=71,z=-5038,dx=78,dy=33,dz=76,tag=Karon,limit=1] run bossbar remove minecraft:karon
...
execute if score Pool1_A4 ARENA matches 0.. unless entity @e[x=4828,y=71,z=-5038,dx=78,dy=33,dz=76,tag=Rodmat,limit=1] run bossbar remove minecraft:rodmat
...
execute if score Pool1_A4 ARENA matches 0.. unless entity @e[x=4828,y=71,z=-5038,dx=78,dy=33,dz=76,tag=Ulkoggumi,limit=1] run bossbar remove minecraft:ulkoggumi
