...
execute if score Pool1_A7 ARENA matches 0.. unless entity @e[x=5292,y=70,z=-5040,dx=80,dy=55,dz=80,tag=Asurok,limit=1] run bossbar remove minecraft:asurok
...
execute if score Pool1_A7 ARENA matches 0.. unless entity @e[x=5292,y=70,z=-5040,dx=80,dy=55,dz=80,tag=Torkant,limit=1] run bossbar remove minecraft:torkant
...
execute if score Pool1_A7 ARENA matches 0.. unless entity @e[x=5292,y=70,z=-5040,dx=80,dy=55,dz=80,tag=Blobby,limit=1] run bossbar remove minecraft:blobby
