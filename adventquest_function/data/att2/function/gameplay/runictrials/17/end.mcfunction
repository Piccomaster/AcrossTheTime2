...
execute positioned -4417 72.5 -4456 as @e[type=minecraft:armor_stand,tag=RunicBlackFire,distance=..5] at @s run kill @s
execute positioned -4417 72.5 -4456 as @e[type=minecraft:marker,tag=RunicTrial,distance=..5] at @s run kill @s
