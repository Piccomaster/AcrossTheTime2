...
# effet
execute as @a[x=-4666,y=78,z=-5286,distance=..15,gamemode=adventure] at @s run function att2:gameplay/runictrials/effect_start
execute as @e[x=-4666,y=78,z=-5286,distance=..15,tag=NewInvo] run function att2:gameplay/invocation/action/summon
summon minecraft:lightning_bolt -4666 79 -5292

# checkpoint
execute in minecraft:overworld run spawnpoint @a -4666 74 -5295