...
execute positioned -5081 105.5 -6375 as @e[type=minecraft:armor_stand,tag=RunicBlackFire,distance=..5] at @s run kill @s
execute positioned -5081 105.5 -6375 as @e[type=minecraft:marker,tag=RunicTrial,distance=..5] at @s run kill @s
