...
execute if block -4812 61 -5561 minecraft:cyan_candle[lit=false] if score candle7_5 CANDLE_STATE matches 1 run function att2:gameplay/runictrials/7/candle1_off
execute if block -4823 57 -5542 minecraft:cyan_candle[lit=false] if score candle7_6 CANDLE_STATE matches 1 run function att2:gameplay/runictrials/7/candle2_off
execute if block -4823 57 -5562 minecraft:cyan_candle[lit=false] if score candle7_7 CANDLE_STATE matches 1 run function att2:gameplay/runictrials/7/candle3_off
execute if block -4828 62 -5552 minecraft:cyan_candle[lit=false] if score candle7_8 CANDLE_STATE matches 1 run function att2:gameplay/runictrials/7/candle4_off
