...
execute positioned -4165 73.5 -5506 as @e[type=minecraft:armor_stand,tag=RunicBlackFire,distance=..5] at @s run kill @s
execute positioned -4165 73.5 -5506 as @e[type=minecraft:marker,tag=RunicTrial,distance=..5] at @s run kill @s
