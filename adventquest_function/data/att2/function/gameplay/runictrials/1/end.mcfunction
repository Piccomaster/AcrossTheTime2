...
# summon
execute positioned -4778 54 -5374 run function att2:summon/reg_1/withertrialminion_class4
execute positioned -4787 55 -5367 run function att2:summon/reg_1/withertrialminion_class2
execute positioned -4787 55 -5381 run function att2:summon/reg_1/withertrialminion_class1
