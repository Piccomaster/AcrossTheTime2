...
#range damage
execute if score #lvl CAL matches 1 at @s positioned ~-1.0 ~-1.0 ~-1.0 as @e[dx=2,dy=2,dz=2,team=hostile,type=!bat,scores={GAMELEVEL=0..}] run function att2:gameplay/bow/arrow_damage
...
execute if score #lvl CAL matches 3 at @s positioned ~-2.0 ~-2.0 ~-2.0 as @e[dx=4,dy=4,dz=4,team=hostile,type=!bat,scores={GAMELEVEL=0..}] run function att2:gameplay/bow/arrow_damage
