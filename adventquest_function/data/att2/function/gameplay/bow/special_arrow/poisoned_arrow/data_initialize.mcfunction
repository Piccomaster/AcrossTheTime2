...
##7-9
execute store result score #lvl CAL run data get storage att2:bow data.item.components."minecraft:custom_data".poisoned_arrow
...
summon armor_stand ~ ~ ~ {Tags:["PoisonedArrow","New"],attributes:[{id:scale,base:0.01}],Invisible:true,Marker:true,equipment:{head:{id:"diamond_helmet",components:{enchantments:{"att2_enchantment:tick/special_arrow/poisoned_arrow":1},attribute_modifiers:[],unbreakable:{},item_model:"nothing",equippable:{slot:head}}}}}
##snyc rotation
