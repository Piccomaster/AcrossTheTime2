...
function att2:summon/bat_chest_loot_experience_bottle {C:5,T:5,Reg:Reg2,Time:10}
function att2:summon/bat_chest_loot_experience_bottle {C:5,T:5,Reg:Reg2,Time:10}
execute if score level DIFFICULTY matches 0.. run function att2:summon/bat_chest_loot_experience_bottle {C:5,T:5,Reg:Reg2,Time:10}
execute if score level DIFFICULTY matches 1.. run function att2:summon/bat_chest_loot_experience_bottle {C:5,T:5,Reg:Reg2,Time:10}
execute if score level DIFFICULTY matches 2.. run function att2:summon/bat_chest_loot_experience_bottle {C:5,T:5,Reg:Reg2,Time:10}
