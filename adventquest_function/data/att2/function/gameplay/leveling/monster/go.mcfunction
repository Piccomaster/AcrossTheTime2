...
#execute at @a as @e[distance=..60,tag=LVL0,type=!item,type=!player,type=!#minecraft:map_entity] at @s run function att2:gameplay/leveling/monster/initialize/initnewmonster
