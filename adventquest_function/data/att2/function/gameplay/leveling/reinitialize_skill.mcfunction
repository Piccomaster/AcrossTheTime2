...
execute if score Mainquest SIDEQUEST matches 17.. run scoreboard players add @s SKILLPOINT 5
execute if score Mainquest SIDEQUEST matches 29.. run scoreboard players add @s SKILLPOINT 5
execute if score Mainquest SIDEQUEST matches 50.. run scoreboard players add @s SKILLPOINT 5
execute if score Mainquest SIDEQUEST matches 120.. run scoreboard players add @s SKILLPOINT 5
execute if score Mainquest SIDEQUEST matches 180.. run scoreboard players add @s SKILLPOINT 5
execute if score Mainquest SIDEQUEST matches 219.. run scoreboard players add @s SKILLPOINT 5
execute if score Mainquest SIDEQUEST matches 280.. run scoreboard players add @s SKILLPOINT 5