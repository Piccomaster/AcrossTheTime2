...
title @s subtitle {text:"° ",color:"gray",extra:[{"translate":"att2.leveling.master.subtitle"},{score:{name:"@s",objective:"LEVELMASTER"},color:"green"},{text:" °",color:"gray"}]}
...
##record max level
scoreboard players operation Max LEVELMASTER > @a LEVELMASTER