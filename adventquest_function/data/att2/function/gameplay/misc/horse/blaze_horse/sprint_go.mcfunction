...
execute if score #damage_trigger CAL matches 0 at @s positioned ~-5 ~-5 ~-5 as @e[dx=10,dy=10,dz=10,scores={GAMELEVEL=0..},team=hostile,type=!bat] at @s run function att2:gameplay/misc/horse/blaze_horse/damage
##particle
