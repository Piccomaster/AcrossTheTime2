...
#detection discover
execute unless score eolorion_pos_1 FISH_DISCOVER_COUNT matches 1.. run scoreboard players add TOTAL FISH_DISCOVER_COUNT 1
execute unless score eolorion_pos_1 FISH_DISCOVER_COUNT matches 1.. run tag @s add Discovered
execute unless score eolorion_pos_1 FISH_DISCOVER_COUNT matches 1.. run scoreboard players set eolorion_pos_1 FISH_DISCOVER_COUNT 1
##dailyquest trigger
