...
#detection discover
execute unless score river_pos_16 FISH_DISCOVER_COUNT matches 1.. run scoreboard players add TOTAL FISH_DISCOVER_COUNT 1
execute unless score river_pos_16 FISH_DISCOVER_COUNT matches 1.. run tag @s add Discovered
execute unless score river_pos_16 FISH_DISCOVER_COUNT matches 1.. run scoreboard players set river_pos_16 FISH_DISCOVER_COUNT 1
##dailyquest trigger
