...
#detection discover
execute unless score river_pos_32 FISH_DICOVER_COUNT matches 1.. run scoreboard players add TOTAL FISH_DICOVER_COUNT 1
execute unless score river_pos_32 FISH_DICOVER_COUNT matches 1.. run scoreboard players set river_pos_32 FISH_DICOVER_COUNT 1
#random pos (+-3M)
