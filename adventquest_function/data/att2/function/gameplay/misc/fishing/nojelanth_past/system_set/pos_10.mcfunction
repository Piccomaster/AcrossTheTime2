...
execute in overworld positioned -7463 23 -4343 if entity @a[distance=..30] unless entity @e[tag=FISH_SPOT,type=armor_stand,distance=..20] run summon armor_stand -7464 23 -4336 {Tags:["FISH_SPOT"],Marker:true,Invisible:true,NoGravity:true}