...
#detection discover
execute unless score nojelanth_past_pos_5 FISH_DISCOVER_COUNT matches 1.. run scoreboard players add TOTAL FISH_DISCOVER_COUNT 1
execute unless score nojelanth_past_pos_5 FISH_DISCOVER_COUNT matches 1.. run tag @s add Discovered
execute unless score nojelanth_past_pos_5 FISH_DISCOVER_COUNT matches 1.. run scoreboard players set nojelanth_past_pos_5 FISH_DISCOVER_COUNT 1
##dailyquest trigger
