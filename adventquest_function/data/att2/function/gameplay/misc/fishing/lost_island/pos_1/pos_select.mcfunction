...
#detection discover
execute unless score lost_island_pos_1 FISH_DISCOVER_COUNT matches 1.. run scoreboard players add TOTAL FISH_DISCOVER_COUNT 1
execute unless score lost_island_pos_1 FISH_DISCOVER_COUNT matches 1.. run tag @s add Discovered
execute unless score lost_island_pos_1 FISH_DISCOVER_COUNT matches 1.. run scoreboard players set lost_island_pos_1 FISH_DISCOVER_COUNT 1
##dailyquest trigger
