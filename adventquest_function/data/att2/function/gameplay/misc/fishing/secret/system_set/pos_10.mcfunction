...
execute in overworld positioned -5342 31 -3931 if entity @a[distance=..30] unless entity @e[tag=FISH_SPOT,type=armor_stand,distance=..20] run summon armor_stand -5339 32 -3936 {Tags:["FISH_SPOT"],Marker:true,Invisible:true,NoGravity:true}