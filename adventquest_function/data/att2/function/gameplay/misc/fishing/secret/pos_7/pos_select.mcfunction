...
#detection discover
execute unless score secret_pos_7 FISH_DISCOVER_COUNT matches 1.. run scoreboard players add TOTAL FISH_DISCOVER_COUNT 1
execute unless score secret_pos_7 FISH_DISCOVER_COUNT matches 1.. run tag @s add Discovered
execute unless score secret_pos_7 FISH_DISCOVER_COUNT matches 1.. run scoreboard players set secret_pos_7 FISH_DISCOVER_COUNT 1
##dailyquest trigger
