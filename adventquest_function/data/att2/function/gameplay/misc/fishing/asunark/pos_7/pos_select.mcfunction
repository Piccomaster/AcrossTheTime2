...
#detection discover
execute unless score asunark_pos_7 FISH_DISCOVER_COUNT matches 1.. run scoreboard players add TOTAL FISH_DISCOVER_COUNT 1
execute unless score asunark_pos_7 FISH_DISCOVER_COUNT matches 1.. run tag @s add Discovered
execute unless score asunark_pos_7 FISH_DISCOVER_COUNT matches 1.. run scoreboard players set asunark_pos_7 FISH_DISCOVER_COUNT 1
##dailyquest trigger
