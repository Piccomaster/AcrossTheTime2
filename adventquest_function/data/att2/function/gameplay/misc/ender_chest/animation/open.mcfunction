...
##open animation
data merge entity @n[distance=..1,type=item_display,tag=Head] {transformation:{translation:[0.0,0.0,-0.25],right_rotation:[-1.0,0.0,0.0,1.0],left_rotation:[0.0,0.0,0.0,1.0]},start_interpolation:0,interpolation_duration:5,teleport_duration:5}
