...
scoreboard players set @s[scores={GAMELEVEL=16..30,STR_PO=..2}] STR_PO 2
scoreboard players set @s[scores={GAMELEVEL=16..30,STR_PO=..2}] STR_PO 2
scoreboard players set @s[scores={GAMELEVEL=16..30,STR_PO=..2}] STR_PO 2
scoreboard players set @s[scores={GAMELEVEL=16..30,STR_PO=..2}] STR_PO 2

scoreboard players set @s[scores={GAMELEVEL=31..,STR_PO=..3}] STR_PO 3
scoreboard players set @s[scores={GAMELEVEL=31..,STR_PO=..3}] STR_PO 3
scoreboard players set @s[scores={GAMELEVEL=31..,STR_PO=..3}] STR_PO 3
scoreboard players set @s[scores={GAMELEVEL=31..,STR_PO=..3}] STR_PO 3
#add spd
scoreboard players set @s[scores={GAMELEVEL=1..15,SPD_PO=..2}] SPD_PO 2
scoreboard players set @s[scores={GAMELEVEL=1..15,SPD_PO=..2}] SPD_PO 2
scoreboard players set @s[scores={GAMELEVEL=1..15,SPD_PO=..2}] SPD_PO 2
scoreboard players set @s[scores={GAMELEVEL=1..15,SPD_PO=..2}] SPD_PO 2

scoreboard players set @s[scores={GAMELEVEL=16..30,SPD_PO=..3}] SPD_PO 3
scoreboard players set @s[scores={GAMELEVEL=16..30,SPD_PO=..3}] SPD_PO 3
scoreboard players set @s[scores={GAMELEVEL=16..30,SPD_PO=..3}] SPD_PO 3
scoreboard players set @s[scores={GAMELEVEL=16..30,SPD_PO=..3}] SPD_PO 3

scoreboard players set @s[scores={GAMELEVEL=31..,SPD_PO=..4}] SPD_PO 4
scoreboard players set @s[scores={GAMELEVEL=31..,SPD_PO=..4}] SPD_PO 4
scoreboard players set @s[scores={GAMELEVEL=31..,SPD_PO=..4}] SPD_PO 4
scoreboard players set @s[scores={GAMELEVEL=31..,SPD_PO=..4}] SPD_PO 4
