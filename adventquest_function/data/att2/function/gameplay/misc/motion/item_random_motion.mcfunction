...
execute store result storage att2:score motion[0] double 0.1 run random value -0.5..0.5
execute store result storage att2:score motion[1] double 0.1 run random value 1..2
execute store result storage att2:score motion[2] double 0.1 run random value -0.5..0.5
