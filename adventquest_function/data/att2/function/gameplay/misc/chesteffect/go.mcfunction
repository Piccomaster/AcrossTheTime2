...
##1
execute if score Range CHESTEFFECT matches 1 at @a as @e[distance=..20,type=marker,tag=ChestMarker,tag=Select,limit=20,sort=nearest] run tag @e[distance=..20,type=marker,tag=ChestMarker,tag=Select] remove Select
...
##2
execute if score Range CHESTEFFECT matches 2 at @a as @e[distance=..40,type=marker,tag=ChestMarker,tag=Select,limit=20,sort=nearest] run tag @e[distance=..40,type=marker,tag=ChestMarker,tag=Select] remove Select
...
##4
execute if score Range CHESTEFFECT matches 4 at @a as @e[distance=..80,type=marker,tag=ChestMarker,tag=Select,limit=20,sort=nearest] run tag @e[distance=..80,type=marker,tag=ChestMarker,tag=Select] remove Select
