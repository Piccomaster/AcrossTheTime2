...
##
execute if entity @p[distance=..6] as @s[tag=!Open] at @a[distance=..6] anchored eyes positioned ^ ^ ^4 as @s[distance=..4] at @s run execute as @e[distance=..0.1,type=item_display,tag=ChestDisplay] run data modify entity @s Glowing set value 1
