...
execute if predicate att2_pre:item_color/unk run particle minecraft:dust{color:[1,0.33,1],scale:0.5} ~ ~0.5 ~ 0.1 0.2 0.1 1 7 normal

execute if predicate att2_pre:item_color/myt run particle minecraft:dust{color:[0,1,1],scale:0.75} ~ ~1.5 ~ 0.05 1 0.05 0 20 normal