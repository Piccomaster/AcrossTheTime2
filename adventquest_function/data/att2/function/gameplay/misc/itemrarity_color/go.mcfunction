...
##equipment
#com
execute if score com itemcolor matches 1 if score @s itemcolor matches 1 run return run particle minecraft:dust{color:[0.5,0.5,0.5],scale:0.4} ~ ~1 ~ 0.05 0.3 0.05 0 6 normal
#unc
execute if score unc itemcolor matches 1 if score @s itemcolor matches 2 run return run particle minecraft:dust{color:[0.0,0.6,0.0],scale:0.4} ~ ~1 ~ 0.05 0.4 0.05 0 8 normal
#rar
execute if score rar itemcolor matches 1 if score @s itemcolor matches 3 run return run particle minecraft:dust{color:[0.0,0.5,1.0],scale:0.4} ~ ~1 ~ 0.05 0.5 0.05 0 7 normal
#epi
execute if score epi itemcolor matches 1 if score @s itemcolor matches 4 run return run particle minecraft:dust{color:[0.65,0.05,1.0],scale:0.5} ~ ~1.5 ~ 0.05 0.6 0.05 0 8 normal
#epi_esc
execute if score epi itemcolor matches 1 if score @s itemcolor matches 5 run return run particle minecraft:dust{color:[1,0,1],scale:0.5} ~ ~1.5 ~ 0.05 0.65 0.05 0 9 normal
#epi_set
execute if score epi itemcolor matches 1 if score @s itemcolor matches 6 run return run particle minecraft:dust{color:[0.45,0.0,0.55],scale:0.5} ~ ~1.5 ~ 0.05 0.7 0.05 0 10 normal
#leg
execute if score leg itemcolor matches 1 if score @s itemcolor matches 7 run return run particle minecraft:dust{color:[1,0.45,0.1],scale:0.6} ~ ~1.5 ~ 0.05 0.8 0.05 0 12 normal
#leg_armset
execute if score leg itemcolor matches 1 if score @s itemcolor matches 8 run return run particle minecraft:dust{color:[0.75,0.25,0.0],scale:0.6} ~ ~1.5 ~ 0.05 0.85 0.05 0 14 normal
#ult
execute if score ult itemcolor matches 1 if score @s itemcolor matches 9 run return run particle minecraft:dust{color:[0.25,1.0,0.0],scale:0.65} ~ ~1.5 ~ 0.05 0.9 0.05 0 15 normal
...
#myt
execute if score other itemcolor matches 1 if score @s itemcolor matches 10 run return run particle minecraft:dust{color:[0,1,1],scale:0.75} ~ ~1.5 ~ 0.05 1 0.05 0 18 normal
