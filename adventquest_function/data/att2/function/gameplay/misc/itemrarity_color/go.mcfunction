...
execute if score #run itemcolor matches 1 as @e[type=item,limit=100,tag=!HPDISPLAY,sort=random] at @s if entity @p[distance=..50] run function att2:gameplay/misc/itemrarity_color/particle