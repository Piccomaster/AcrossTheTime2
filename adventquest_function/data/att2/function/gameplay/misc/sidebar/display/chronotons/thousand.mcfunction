...
scoreboard players display numberformat line_4 Sidebar_Display fixed [{score:{name:"#Chronotons_int",objective:Sidebar_Display},color:"#FFDF20"},{text:".",color:"#FFDF20"},{score:{name:"#Chronotons_float",objective:Sidebar_Display},color:"#FFDF20"},{translate:att2.sidebar.unit.thousand,color:"#FFDF20"}]