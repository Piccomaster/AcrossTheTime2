...
#Set the end point
execute as 00000002-0000-0002-0000-000200000013 at @s run function att2:gameplay/misc/map/route_select/add_end with storage att2:route
...
scoreboard players set @s DEST 20
