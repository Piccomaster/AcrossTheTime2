...
#summon marker
summon minecart ~ ~10 ~ {Tags:["ROUTE_RIDE","invminecarts.invisible_minecart","New"],Invulnerable:true,NoGravity:true,Silent:true,Motion:[0,0,0]}
...
#set score
scoreboard players operation @e[distance=..20,type=minecart,tag=ROUTE_RIDE,tag=New] OWNER = @s NUMEROJOUEUR
#remove tag
