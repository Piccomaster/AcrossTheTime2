...
execute if score @s AUTO_PATH matches 1.. unless score RIDING CAL matches 1 run function att2:gameplay/misc/map/auto_path/ride_stop with storage att2:route
...
#reset
execute if score @s AUTO_PATH_TIMER matches ..0 run function att2:gameplay/misc/map/auto_path/reset with storage att2:route
scoreboard players reset RIDING CAL