...
execute if score @s AUTO_PATH matches 1..2 run function att2:gameplay/misc/map/auto_path/ride_keep with storage att2:route
#make minecart no motion
execute if score tic TIMECOUNTER matches 5 run function att2:gameplay/misc/map/auto_path/data_keep with storage att2:route
#detection way point
