...
###worlest
scoreboard players set RYLIATH DEST 0
scoreboard players set SQ3_HOUSE DEST 1
scoreboard players set RYLIATH_CAVE DEST 0
scoreboard players set WORLEST_MINE_WEST DEST 0
scoreboard players set JARAT DEST 0
scoreboard players set MUSHROMM_CAVE DEST 0
scoreboard players set GONON_HOTEL DEST 0
scoreboard players set WORLEST_RUIN DEST 0
##Volcano/kert
scoreboard players set VOLCANO_NORTH DEST 0
scoreboard players set KERT DEST 0
scoreboard players set SATHONK DEST 0
scoreboard players set KORTAEK DEST 0
scoreboard players set NOJELANTH DEST 0
scoreboard players set KERT_MINE DEST 0
#####north forest
scoreboard players set EOL DEST 0
scoreboard players set EOLORION_FOOTHILL DEST 0
scoreboard players set EOLORION DEST 0
###### North EAST
...
##OWSASTR
scoreboard players set PHILIPO_HOUSE DEST 0
scoreboard players set LILITH_HOUSE DEST 0
scoreboard players set OWSASTR_WAYPOINT DEST 0
scoreboard players set OWSASTR_TEMPLE DEST 0
