...
filled_map[map_decorations={"sq28":{rotation:180.0f,type:"red_x",x:-4900.0d,z:-4380.0d}},map_id=25,custom_name={translate:att2.sq28.map},lore=[{translate:item.quest.lore}]] 1
