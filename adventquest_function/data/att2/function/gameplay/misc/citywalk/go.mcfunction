...
execute as @s[scores={DIMENSION=1},x=-3824,z=-5920,dx=206,dz=143] run function att2:gameplay/misc/citywalk/meleim
#if success -> Stop the command below
execute if score TRUE CAL matches 1 run return 0
...
##reset
execute if score TRUE CAL matches 0 run scoreboard players set @s CITYWALK 0