...
##test fiying effect
execute if score @s SuperDash matches 100..200 run return run function att2:gameplay/misc/super_dash/dash

##test if full
execute if score @s SuperDash matches 30.. run return run function att2:gameplay/misc/super_dash/launch
##test elytra
