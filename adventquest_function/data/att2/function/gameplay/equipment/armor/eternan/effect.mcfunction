...
particle minecraft:dust{color:[0.94,0.69,0.23],scale:1} ~ ~ ~ 1 1 1 0.1 20 normal @s
#particle
particle dust_color_transition{from_color:[0.94,0.69,0.23],scale:1,to_color:[1,0.54,0.02]} ~ ~ ~ 1 1 1 0.1 20 normal @s
