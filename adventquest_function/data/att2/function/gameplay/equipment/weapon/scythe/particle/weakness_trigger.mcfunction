...
particle minecraft:falling_lava ~ ~ ~ 0.25 0.25 0.25 0 20 normal
particle minecraft:crit ~ ~ ~ 0.25 0.25 0.25 0.1 40 normal
particle minecraft:damage_indicator ~ ~ ~ 0.1 0.1 0.1 0.1 10 normal
...
##particle
particle minecraft:sweep_attack ~ ~ ~ 0.3 0.3 0.3 0 8 force
##sound
