...
##limit
execute as @s[tag=Once] run return run function att2:gameplay/equipment/weapon/axe/attack
...
execute as @n[distance=..5,type=spectral_arrow,tag=New] at @s run tp @s ^ ^ ^0.1
