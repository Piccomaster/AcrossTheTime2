...
item replace block 0 0 0 container.0 from entity @s weapon.offhand {function:set_components,components:{minimum_attack_charge:0.5,swing_animation:{type:stab}}}
#replace mainhand -> offhand 
item replace entity @s weapon.offhand from entity @s weapon.mainhand {function:set_components,components:{minimum_attack_charge:0.5,swing_animation:{type:stab}}}
item replace entity @s weapon.mainhand from block 0 0 0 container.0 {function:set_components,components:{minimum_attack_charge:0.5,swing_animation:{type:stab}}}
