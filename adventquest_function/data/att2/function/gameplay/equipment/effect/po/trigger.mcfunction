...
execute if data storage att2:potion data.components."minecraft:potion_contents"{custom_effects:[{id:"minecraft:absorption"}]} run effect clear @s minecraft:absorption
...
execute store result score #CRT CAL run data get storage att2:potion data.components."minecraft:custom_data".CRT
execute store result score #SPD CAL run data get storage att2:potion data.components."minecraft:custom_data".SPD
execute store result score #HAS CAL run data get storage att2:potion data.components."minecraft:custom_data".HAS
execute store result score #HER CAL run data get storage att2:potion data.components."minecraft:custom_data".HER
execute store result score #DAR CAL run data get storage att2:potion data.components."minecraft:custom_data".DAR
execute store result score #LUC CAL run data get storage att2:potion data.components."minecraft:custom_data".LUC
execute store result score #HUN CAL run data get storage att2:potion data.components."minecraft:custom_data".HUN

execute store result score #STR_TIME CAL run data get storage att2:potion data.components."minecraft:custom_data".STR_TIME
execute store result score #RES_TIME CAL run data get storage att2:potion data.components."minecraft:custom_data".RES_TIME
execute store result score #CRT_TIME CAL run data get storage att2:potion data.components."minecraft:custom_data".CRT_TIME
execute store result score #SPD_TIME CAL run data get storage att2:potion data.components."minecraft:custom_data".SPD_TIME
execute store result score #HAS_TIME CAL run data get storage att2:potion data.components."minecraft:custom_data".HAS_TIME
execute store result score #HER_TIME CAL run data get storage att2:potion data.components."minecraft:custom_data".HER_TIME
execute store result score #DAR_TIME CAL run data get storage att2:potion data.components."minecraft:custom_data".DAR_TIME
execute store result score #LUC_TIME CAL run data get storage att2:potion data.components."minecraft:custom_data".LUC_TIME
execute store result score #HUN_TIME CAL run data get storage att2:potion data.components."minecraft:custom_data".HUN_TIME
