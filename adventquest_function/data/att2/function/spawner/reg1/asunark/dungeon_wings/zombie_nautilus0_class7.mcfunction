####################################	*#
#Spawner for att2:summon/reg_1/zombie_nautilus0_classx {class:CLASS6}	#
####################################	*#
...
##set value
data modify entity @s data.summon set value "function att2:summon/reg_1/zombie_nautilus0_classx {class:CLASS7}"
##set summon timer
