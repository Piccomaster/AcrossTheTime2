...
##sound
execute if score @s SPAWNER_TIMER matches 20 run playsound minecraft:block.sand.step ambient @a ~ ~ ~ 1.2 1
execute if score @s SPAWNER_TIMER matches 15 run playsound minecraft:block.sand.step ambient @a ~ ~ ~ 1.2 1
execute if score @s SPAWNER_TIMER matches 10 run playsound minecraft:block.deepslate.place ambient @a ~ ~ ~ 1.2 1
execute if score @s SPAWNER_TIMER matches 5 run playsound minecraft:block.deepslate.place ambient @a ~ ~ ~ 1.2 1
