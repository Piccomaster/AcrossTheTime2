...
#ithax
#interfacer
execute in overworld positioned -7411.5 156.0 -6019.0 if entity @a[distance=..50] run kill @e[distance=..1,type=armor_stand]
...
#first green pass
execute in overworld positioned -7411.2 155.1 -6003.0 if entity @a[distance=..50] run kill @e[distance=..2,type=armor_stand]
execute in overworld positioned -7411.2 155.1 -6003.0 if entity @a[distance=..50] unless entity @e[distance=..2,type=armor_stand,tag=MINOR_PASS] run summon armor_stand ~ ~ ~ {Tags:["MINOR_PASS"],Rotation:[0.0f,0.0f],Pos:[-7411.2,155.1,-6003.0],Invulnerable:true,Invisible:true,ShowArms:true,NoGravity:true,Pose:{RightArm:[10.0f,40.0f,180.0f]},equipment:{mainhand:{id:"minecraft:iron_nugget",components:{custom_data:{EquipmentType:'misc',Rarity:'que'},custom_name:{translate:'item.quest.minor_pass.name'},lore:[{translate:'item.quest.lore'}],tooltip_style:"minecraft:rarity/quest/quest"}}}}
#second green pass
execute in overworld positioned -7452.2 155.1 -5928.0 if entity @a[distance=..50] run kill @e[distance=..2,type=armor_stand]
execute in overworld positioned -7452.2 155.1 -5928.0 if entity @a[distance=..50] unless entity @e[distance=..2,type=armor_stand,tag=MINOR_PASS] run summon armor_stand ~ ~ ~ {Tags:["MINOR_PASS"],Rotation:[0.0f,0.0f],Pos:[-7452.2,155.1,-5928.0],Invulnerable:true,Invisible:true,ShowArms:true,NoGravity:true,Pose:{RightArm:[10.0f,40.0f,180.0f]},equipment:{mainhand:{id:"minecraft:iron_nugget",components:{custom_data:{EquipmentType:'misc',Rarity:'que'},custom_name:{translate:'item.quest.minor_pass.name'},lore:[{translate:'item.quest.lore'}],tooltip_style:"minecraft:rarity/quest/quest"}}}}
#third green pass
execute in overworld positioned -7421.2 155.1 -5952.0 if entity @a[distance=..50] run kill @e[distance=..2,type=armor_stand]
execute in overworld positioned -7421.2 155.1 -5952.0 if entity @a[distance=..50] unless entity @e[distance=..2,type=armor_stand,tag=MINOR_PASS] run summon armor_stand ~ ~ ~ {Tags:["MINOR_PASS"],Rotation:[0.0f,0.0f],Pos:[-7421.2,155.1,-5952.0],Invulnerable:true,Invisible:true,ShowArms:true,NoGravity:true,Pose:{RightArm:[10.0f,40.0f,180.0f]},equipment:{mainhand:{id:"minecraft:iron_nugget",components:{custom_data:{EquipmentType:'misc',Rarity:'que'},custom_name:{translate:'item.quest.minor_pass.name'},lore:[{translate:'item.quest.lore'}],tooltip_style:"minecraft:rarity/quest/quest"}}}}
#first red pass
execute in overworld positioned -7407.8 160.1 -5979.5 if entity @a[distance=..50] run kill @e[distance=..2,type=armor_stand]
execute in overworld positioned -7407.8 160.1 -5979.5 if entity @a[distance=..50] unless entity @e[distance=..2,type=armor_stand,tag=MAJOR_PASS] run summon armor_stand ~ ~ ~ {Tags:["MAJOR_PASS"],Rotation:[0.0f,0.0f],Pos:[-7407.8,160.1,-5979.5],Invulnerable:true,Invisible:true,ShowArms:true,NoGravity:true,Pose:{RightArm:[10.0f,40.0f,180.0f]},equipment:{mainhand:{id:"minecraft:prismarine_shard",components:{custom_data:{EquipmentType:'misc',Rarity:'que'},custom_name:{translate:'item.quest.major_pass.name'},lore:[{translate:'item.quest.lore'}],tooltip_style:"minecraft:rarity/quest/quest"}}}}
#second red pass
execute in overworld positioned -7452.8 155.1 -5895.5 if entity @a[distance=..50] run kill @e[distance=..2,type=armor_stand]
execute in overworld positioned -7452.8 155.1 -5895.5 if entity @a[distance=..50] unless entity @e[distance=..2,type=armor_stand,tag=MAJOR_PASS] run summon armor_stand ~ ~ ~ {Tags:["MAJOR_PASS"],Rotation:[0.0f,0.0f],Pos:[-7452.8,155.1,-5895.5],Invulnerable:true,Invisible:true,ShowArms:true,NoGravity:true,Pose:{RightArm:[10.0f,40.0f,180.0f]},equipment:{mainhand:{id:"minecraft:prismarine_shard",components:{custom_data:{EquipmentType:'misc',Rarity:'que'},custom_name:{translate:'item.quest.major_pass.name'},lore:[{translate:'item.quest.lore'}],tooltip_style:"minecraft:rarity/quest/quest"}}}}

##body
execute in overworld positioned -7405.25 161.40 -5978.20 if entity @a[distance=..50] run kill @e[distance=..2,type=armor_stand]
execute in overworld positioned -7405.25 161.40 -5978.20 if entity @a[distance=..50] unless entity @e[distance=..2,type=armor_stand] run summon minecraft:armor_stand -7405.25 161.40 -5978.20 {NoGravity: 1b, Brain: {memories: {}}, HurtByTimestamp: 0, Invulnerable: 1b, FallFlying: 0b, ShowArms: 1b, PortalCooldown: 0, AbsorptionAmount: 0.0f, DisabledSlots: 2039583, DeathTime: 0s, Pose: {RightArm: [354.0f, 8.0f, 0.0f], LeftLeg: [84.0f, 176.0f, 0.0f], Head: [70.0f, 0.0f, 0.0f], LeftArm: [336.0f, 0.0f, 3.0f], RightLeg: [274.0f, 0.0f, 0.0f], Body: [0.0f, 182.0f, 0.0f]}, Invisible: 0b, Tags: ["Corps"], Motion: [0.0d, 0.0d, 0.0d], Small: 0b, Health: 20.0f, equipment: {head: {components: {"minecraft:profile": {name: "", id: [I; -1507832801, 1673150680, -2069725402, 1167858614], properties: [{name: "textures", value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjViODFlMTc0N2IzMDQwODAxMDY5NzY4YjdjZWU4NWEzMmZlMGVhNTc4ZDdhNDg4NzgzYzc3NzhlNzJkN2U3In19fQ=="}]}}, count: 1, id: "minecraft:player_head"}, feet: {components: {"minecraft:dyed_color": 4869972}, count: 1, id: "minecraft:leather_boots"}, chest: {components: {"minecraft:dyed_color": 4869972}, count: 1, id: "minecraft:leather_chestplate"}, legs: {components: {"minecraft:dyed_color": 4869972}, count: 1, id: "minecraft:leather_leggings"}}, fall_distance: 0.0d, Air: 300s, OnGround: 0b, Rotation: [90.0f, 0.0f], Fire: 0s, NoBasePlate: 1b, attributes: [{id: "minecraft:waypoint_transmit_range", base: 0.0d}, {id: "minecraft:movement_speed", base: 0.699999988079071d}, {id: "minecraft:knockback_resistance", base: 0.0d}, {id: "minecraft:max_health", base: 20.0d}, {id: "minecraft:armor", base: 0.0d}, {id: "minecraft:armor_toughness", base: 0.0d}], HurtTime: 0s}
