...
##α command
execute unless score elytra_racing_update SYSTEM matches 1.. run function att2:gameplay/elytra_racing/initialize

scoreboard players set elytra_racing_update SYSTEM 1
