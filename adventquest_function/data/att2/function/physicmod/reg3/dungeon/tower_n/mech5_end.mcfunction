...
setblock -1239 63 -692 minecraft:air destroy
setblock -1239 63 -691 minecraft:emerald_block destroy
setblock -1222 58 -699 minecraft:redstone_wire destroy
setblock -1223 60 -699 minecraft:slime_block destroy
