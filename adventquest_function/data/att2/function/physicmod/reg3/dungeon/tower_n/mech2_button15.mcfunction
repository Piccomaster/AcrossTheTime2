...
setblock -1210 37 -755 minecraft:diamond_block destroy
setblock -1211 37 -756 minecraft:diamond_block destroy
setblock -1210 37 -754 minecraft:stone_button[facing=south] destroy
setblock -1212 37 -756 minecraft:stone_button[facing=west] destroy
