...
setblock -1232 37 -755 minecraft:diamond_block destroy
setblock -1231 37 -756 minecraft:diamond_block destroy
setblock -1232 37 -754 minecraft:stone_button[facing=south] destroy
setblock -1230 37 -756 minecraft:stone_button[facing=east] destroy
