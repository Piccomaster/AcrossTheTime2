...
setblock -1232 37 -734 minecraft:stone_button[facing=south] destroy
setblock -1232 37 -738 minecraft:stone_button[facing=north] destroy
setblock -1232 37 -735 minecraft:diamond_block destroy
setblock -1232 37 -737 minecraft:diamond_block destroy
