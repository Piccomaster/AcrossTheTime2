...
setblock -1329 78 -555 minecraft:air destroy

setblock -1326 80 -553 minecraft:iron_trapdoor[facing=west,open=true] destroy
setblock -1328 80 -553 minecraft:iron_trapdoor[facing=south,open=true] destroy
