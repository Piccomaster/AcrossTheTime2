...
setblock -4976 98 -4450 minecraft:air destroy
clone -4984 89 -4452 -4983 95 -4448 -4973 92 -4452 replace force

setblock -4972 98 -4449 minecraft:iron_trapdoor[open=true,facing=east] destroy
setblock -4972 98 -4451 minecraft:iron_trapdoor[open=true,facing=east] destroy
