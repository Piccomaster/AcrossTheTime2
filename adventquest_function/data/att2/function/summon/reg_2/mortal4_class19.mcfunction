...
summon minecraft:zombified_piglin ~ ~ ~ {attributes:[{id:movement_speed,base:0.22}],Tags:["LVL0","CLASS19","Reg2","Undead"],AngerTime:1000000,drop_chances:{mainhand:0,offhand:0,feet:0,legs:0,chest:0,head:0,body:0,saddle:0},equipment:{mainhand:{id:"minecraft:golden_pickaxe",count:1},offhand:legs:{id:"minecraft:golden_leggings",count:1},chest:{id:"minecraft:golden_chestplate",count:1},head:{id:"minecraft:leather_helmet",count:1,components:{dyed_color:9589788}}}}