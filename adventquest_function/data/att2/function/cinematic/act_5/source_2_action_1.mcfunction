...
execute positioned 1543.0 43 1495.0 as @e[type=end_crystal,distance=..5] at @s run data merge entity @s {beam_target:[I;1543,20,1495]}
execute as 00000000-0000-022b-0000-00000000022b at @s run teleport @s 1543.0 20 1495.0
execute as 00000000-0000-022b-0000-00000000022b run data merge entity @s {NoAI:1b}
