...
execute if score Real0 TIMER matches 600 at 00000000-0000-022b-0000-00000000022b as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2934"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 700 run function att2:dialogs/mainquest/act_5/ch1_serile_18
execute if score Real0 TIMER matches 700 at 00000000-0000-022b-0000-00000000022b as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2913"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 850 run function att2:dialogs/mainquest/act_5/ch1_player_11
execute if score Real0 TIMER matches 850 at 00000000-0000-022b-0000-00000000022b as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2935"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 900 run function att2:dialogs/mainquest/act_5/ch1_serile_19
execute if score Real0 TIMER matches 900 at 00000000-0000-022b-0000-00000000022b as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2952"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 950 run function att2:dialogs/mainquest/act_5/ch1_player_12
execute if score Real0 TIMER matches 950 at 00000000-0000-022b-0000-00000000022b as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2915"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 1250 run function att2:dialogs/mainquest/act_5/ch1_serile_20
execute if score Real0 TIMER matches 1250 at 00000000-0000-022b-0000-00000000022b as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2949"},hover_event:{action:show_text,value:"..."}}
