...
execute if score Real0 TIMER matches 30 at 00000000-0000-001a-0000-00000000001a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Real0 TIMER matches ..98 run scoreboard players set Real0 TIMER 99"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 100 run function att2:dialogs/mainquest/act_5/ch1_player_4
execute if score Real0 TIMER matches 100 at 00000000-0000-001a-0000-00000000001a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Real0 TIMER matches ..198 run scoreboard players set Real0 TIMER 199"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 200 at 00000000-0000-001a-0000-00000000001a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Real0 TIMER matches ..298 run scoreboard players set Real0 TIMER 299"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 300 run function att2:dialogs/mainquest/act_5/ch1_player_5
execute if score Real0 TIMER matches 300 at 00000000-0000-001a-0000-00000000001a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Real0 TIMER matches ..448 run scoreboard players set Real0 TIMER 449"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 450 at 00000000-0000-001a-0000-00000000001a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Real0 TIMER matches ..598 run scoreboard players set Real0 TIMER 599"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 600 run function att2:dialogs/mainquest/act_5/ch1_player_6
execute if score Real0 TIMER matches 600 at 00000000-0000-001a-0000-00000000001a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Real0 TIMER matches ..698 run scoreboard players set Real0 TIMER 699"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 700 at 00000000-0000-001a-0000-00000000001a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Real0 TIMER matches ..998 run scoreboard players set Real0 TIMER 999"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 1000 run function att2:dialogs/mainquest/act_5/ch1_player_7
execute if score Real0 TIMER matches 1000 at 00000000-0000-001a-0000-00000000001a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Real0 TIMER matches ..1148 run scoreboard players set Real0 TIMER 1149"},hover_event:{action:show_text,value:"..."}}
