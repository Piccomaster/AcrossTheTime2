...
execute if score Real0 TIMER matches 1 positioned 2143 96 1945 run function att2:summon/pnj/serile_old
execute if score Real0 TIMER matches 1 run scoreboard players set 00000000-0000-001a-0000-00000000001a TALKING_LIMIT -1
execute if score Real0 TIMER matches 1 positioned 2143 96 1945 run tp 00000000-0000-001a-0000-00000000001a ~ ~ ~
