...
execute if score Real0 TIMER matches 10 as @a run function att2:gameplay/checkpoint/telluron_future/hill_valley2
...
execute if score Real0 TIMER matches 25 run effect give @a minecraft:regeneration 120 6 true
execute if score Real0 TIMER matches 40 as @e[type=minecraft:zombie,x=1995,y=96,z=2055,distance=..7] run data merge entity @s {Silent:0b,NoAI:0b,drop_chances:{mainhand:0,offhand:0,feet:0,legs:0,chest:0,head:0,body:0,saddle:0},DeathLootTable:"att2:empty",equipment:{feet:{id:"minecraft:leather_boots",count:1,components:{dyed_color:5526612}},legs:{id:"minecraft:leather_leggings",count:1,components:{dyed_color:5526612}},chest:{id:"minecraft:leather_chestplate",count:1,components:{dyed_color:5526612}},head:{id:"minecraft:leather_helmet",count:1,components:{unbreakable:{},dyed_color:11839558}}},CustomName:"ZOMBIE"}
