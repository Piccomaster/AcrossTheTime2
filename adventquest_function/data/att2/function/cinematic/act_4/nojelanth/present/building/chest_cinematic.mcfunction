...
execute if score Real0 TIMER matches 1 run data modify storage att2:performance rotation set value [135,40]

execute if score Real0 TIMER matches 1 positioned -5926 126 -4368 as @a[x=-5934,y=118,z=-4377,distance=..100] run function att2:gameplay/speceffect/disincarnate/start/real0
execute if score Real0 TIMER matches 1..99 run tp @n[type=text_display,tag=Real0] -5926 126 -4368 135 40
