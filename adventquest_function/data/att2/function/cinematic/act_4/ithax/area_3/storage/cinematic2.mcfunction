...
execute if score Real0 TIMER matches 1 positioned -7456 158 -5919 as @a[x=-7456,y=157,z=-5919,distance=..100] run function att2:gameplay/speceffect/disincarnate/start/real0
execute if score Real0 TIMER matches 1..149 run tp @n[type=text_display,tag=Real0] -7456 158 -5919 0 10
