...
execute if score Real0 TIMER matches 1..100 run data modify storage att2:performance rotation set value [135,10]

execute if score Real0 TIMER matches 1 positioned -7433 159 -5875 as @a[x=-7450,y=160,z=-5880,distance=..100] run function att2:gameplay/speceffect/disincarnate/start/real0
execute if score Real0 TIMER matches 1..99 run tp @n[type=text_display,tag=Real0] -7433 159 -5875 135 10
