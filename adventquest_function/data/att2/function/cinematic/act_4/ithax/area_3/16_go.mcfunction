...
execute if score Real0 TIMER matches 250..405 run function att2:gameplay/speceffect/disincarnate/keep/real0
execute if score Real0 TIMER matches 250..405 run data modify storage att2:performance rotation set value [180,0]
...
execute if score Real0 TIMER matches 5 as @a[scores={DIMENSION=3}] at @s run tp @s -7419 125 -5743 180 0
...
execute if score Real0 TIMER matches 225 in minecraft:overworld run spawnpoint @a[x=-7414,y=140,z=-5715,distance=..200] -7414 140 -5715
execute if score Real0 TIMER matches 250 positioned -7423 129 -5736 as @a[x=-7424,y=130,z=-5750,distance=..300] run function att2:gameplay/speceffect/disincarnate/start/real0
execute if score Real0 TIMER matches 250..299 run tp @n[type=text_display,tag=Real0] -7423 129 -5736 165 25
execute if score Real0 TIMER matches 300 run stopsound @a
execute if score Real0 TIMER matches 300..339 run tp @n[type=text_display,tag=Real0] -7420 134 -5728 160 25
execute if score Real0 TIMER matches 320 run particle minecraft:explosion_emitter -7434 127 -5743 5 5 5 0 50 force
execute if score Real0 TIMER matches 340..399 run tp @n[type=text_display,tag=Real0] -7414 142 -5715 160 20
