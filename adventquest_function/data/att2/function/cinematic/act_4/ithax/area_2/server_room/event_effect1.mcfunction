...
execute in overworld run tp @a[gamemode=adventure,x=-7431,y=157,z=-5947,distance=..100] -7428 156 -5947
execute in overworld as @a[x=-7431,y=157,z=-5947,distance=..100] run function att2:gameplay/checkpoint/telluron_farfuture/ithax3
