...
execute if score Real0 TIMER matches 1..150 run data modify storage att2:performance rotation set value [-90,0]

execute if score Real0 TIMER matches 1 positioned -7444 158 -5947 as @a[x=-7444,y=156,z=-5947,distance=..100] run function att2:gameplay/speceffect/disincarnate/start/real0
execute if score Real0 TIMER matches 1 positioned -7445 156 -5947 run function att2:sound/mobs/guardian_creepy
execute if score Real0 TIMER matches 1..29 run tp @n[type=text_display,tag=Real0] -7444 158 -5947 -90 0
execute if score Real0 TIMER matches 30..59 run tp @n[type=text_display,tag=Real0] -7444 158 -5947 0 0
execute if score Real0 TIMER matches 60..149 run tp @n[type=text_display,tag=Real0] -7446 158 -5947 90 0
...
execute if score Real0 TIMER matches 60 as @a[gamemode=spectator,scores={Performance=0}] run scoreboard players set @s TIMER_SPD_EXT 50
...
execute if score Real0 TIMER matches 140 run spawnpoint @a[x=-7444,y=156,z=-5947,distance=..200] -7438 156 -5947
