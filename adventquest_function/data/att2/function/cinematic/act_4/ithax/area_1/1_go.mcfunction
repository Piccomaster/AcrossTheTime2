...
execute if score Real0 TIMER matches 0 in overworld as @a[x=-7448,y=158,z=-6021,distance=..100] run function att2:gameplay/checkpoint/telluron_farfuture/ithax0
...
execute if score Real0 TIMER matches 5 run tp @a[gamemode=adventure,x=-7448,y=158,z=-6021,distance=..100] -7448 158 -6021
