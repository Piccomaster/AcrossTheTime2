...
execute if score Real0 TIMER matches 1 positioned -7411 160 -5989 as @a[x=-7420,y=161,z=-5998,distance=..100] run function att2:gameplay/speceffect/disincarnate/start/real0
execute if score Real0 TIMER matches 1..29 run tp @n[type=text_display,tag=Real0] -7411 160 -5989 -90 0
execute if score Real0 TIMER matches 30..59 run tp @n[type=text_display,tag=Real0] -7408 160 -5989 -90 0
...
execute if score Real0 TIMER matches 60..149 run tp @n[type=text_display,tag=Real0] -7373 159 -6006 65 5
