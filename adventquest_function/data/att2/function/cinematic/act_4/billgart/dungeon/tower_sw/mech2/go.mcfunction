...
execute if score End0 TIMER matches 1..350 run function att2:gameplay/speceffect/disincarnate/keep/end0
execute if score End0 TIMER matches 1..350 run data modify storage att2:performance rotation set value [-100,0]

execute if score End0 TIMER matches 1 in minecraft:the_end positioned -1351 67 -550 as @a[x=-1361,y=55,z=-541,distance=..100] run function att2:gameplay/speceffect/disincarnate/start/end0
execute if score End0 TIMER matches 1..79 in minecraft:the_end run tp @n[type=text_display,tag=End0] -1351 67 -550 -100 0
...
execute if score End0 TIMER matches 80..199 in minecraft:the_end run tp @n[type=text_display,tag=End0] -1339 60 -560 30 10
...
execute if score End0 TIMER matches 200..249 in minecraft:the_end run tp @n[type=text_display,tag=End0] -1354 57 -544 62 15
...
execute if score End0 TIMER matches 250..349 in minecraft:the_end run tp @n[type=text_display,tag=End0] -1351 67 -534 120 40
execute if score End0 TIMER matches 250 at @a run function att2:sound/misc/resolution
execute if score End0 TIMER matches 350 as @a[gamemode=spectator,scores={Performance=20}] run function att2:gameplay/speceffect/disincarnate/end/end0
