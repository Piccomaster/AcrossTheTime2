...
execute positioned -1230 21 -730 run function att2:summon/reg_3/golem2_classx {class:CLASS14}
execute positioned -1227 21 -730 run function att2:summon/reg_3/golem1_classx {class:CLASS13}
execute positioned -1224 21 -730 run function att2:summon/reg_3/golem3_classx {class:CLASS15}
