...
execute if score Real0 TIMER matches 50 at 00000000-0000-095a-0000-00000000095a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2920"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 300 at 00000000-0000-095a-0000-00000000095a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2921"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 400 at 00000000-0000-095a-0000-00000000095a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2931"},hover_event:{action:show_text,value:"..."}}
