...
execute if score Real0 TIMER matches 50 at 00000000-0000-003a-0000-00000000003a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2937"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 250 at 00000000-0000-003a-0000-00000000003a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2921"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 400 run function att2:dialogs/mainquest/act_4/ch5_player_7
execute if score Real0 TIMER matches 400 at 00000000-0000-003a-0000-00000000003a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2910"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 500 at 00000000-0000-003a-0000-00000000003a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2931"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 800 at 00000000-0000-003a-0000-00000000003a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2935"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 900 at 00000000-0000-003a-0000-00000000003a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2932"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 1000 at 00000000-0000-003a-0000-00000000003a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2938"},hover_event:{action:show_text,value:"..."}}
