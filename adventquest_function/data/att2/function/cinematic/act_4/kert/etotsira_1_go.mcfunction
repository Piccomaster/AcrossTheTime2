...
execute if score Real0 TIMER matches 20 positioned -5810 66 -4592 as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2933"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 200 positioned -5810 66 -4592 as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2910"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 500 positioned -5810 66 -4592 as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2936"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 750 run function att2:dialogs/mainquest/act_4/ch5_player_10
execute if score Real0 TIMER matches 750 positioned -5810 66 -4592 as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2912"},hover_event:{action:show_text,value:"..."}}
