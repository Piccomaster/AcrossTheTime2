...
execute if score Real0 TIMER matches 1..350 run data modify storage att2:performance rotation set value [25,30]

execute if score Real0 TIMER matches 1 positioned -5681 121 -6379 as @a[x=-5684,y=111,z=-6369,distance=..100] run function att2:gameplay/speceffect/disincarnate/start/real0
execute if score Real0 TIMER matches 1..79 run tp @n[type=text_display,tag=Real0] -5681 121 -6379 25 30
...
execute if score Real0 TIMER matches 80..159 run tp @n[type=text_display,tag=Real0] -5679 129 -6364 135 25
...
execute if score Real0 TIMER matches 160..239 run tp @n[type=text_display,tag=Real0] -5683 144 -6367 -115 15
...
execute if score Real0 TIMER matches 240..349 run tp @n[type=text_display,tag=Real0] -5606 142 -6369 -90 0
