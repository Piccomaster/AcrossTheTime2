...
execute if score Real0 TIMER matches 20 at 00000000-0000-127a-0000-00000000127a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2950"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 50 at 00000000-0000-127a-0000-00000000127a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2930"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 150 run function att2:dialogs/mainquest/act_4/ch4_player_5
execute if score Real0 TIMER matches 150 at 00000000-0000-127a-0000-00000000127a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2923"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 250 at 00000000-0000-127a-0000-00000000127a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2910"},hover_event:{action:show_text,value:"..."}}
