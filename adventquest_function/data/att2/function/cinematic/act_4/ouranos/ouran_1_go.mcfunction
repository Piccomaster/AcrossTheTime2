...
execute if score Real0 TIMER matches 1..500 run function att2:gameplay/speceffect/disincarnate/keep/real0
execute if score Real0 TIMER matches 1 run data modify storage att2:performance rotation set value [-90,40]

execute if score Real0 TIMER matches 1 positioned 7603 103 6772 as @a[x=7608,y=100,z=6772,distance=..100] run function att2:gameplay/speceffect/disincarnate/start/real0
execute if score Real0 TIMER matches 1..159 run tp @n[type=text_display,tag=Real0] 7603 103 6772 -90 40
...
execute if score Real0 TIMER matches 70 run kill @e[x=7608,y=99,z=6772,distance=..2,type=minecraft:item,nbt={Item:{id:"minecraft:sunflower",count:1}}]
...
execute if score Real0 TIMER matches 130 run kill @e[x=7608,y=99,z=6772,distance=..2,type=minecraft:item,nbt={Item:{id:"minecraft:sunflower",count:1}}]
execute if score Real0 TIMER matches 160..499 run tp @n[type=text_display,tag=Real0] 7569 128 6772 -90 0
execute if score Real0 TIMER matches 180 at @a[gamemode=spectator,scores={Performance=0}] run function att2:sound/misc/emerald_growing
execute if score Real0 TIMER matches 180 run function att2:physicmod/reg4/ouran_portal_left
execute if score Real0 TIMER matches 200 at @a[gamemode=spectator,scores={Performance=0}] run function att2:sound/misc/emerald_growing
execute if score Real0 TIMER matches 200 run function att2:physicmod/reg4/ouran_portal_right
execute if score Real0 TIMER matches 230 at @a[gamemode=spectator,scores={Performance=0}] run function att2:sound/misc/bell_ouranos
...
execute if score Real0 TIMER matches 370 at @a[gamemode=spectator,scores={Performance=0}] run function att2:sound/door/simple_glassdoor
execute if score Real0 TIMER matches 380 run function att2:physicmod/reg4/ouran_portal_center7
execute if score Real0 TIMER matches 380 at @a[gamemode=spectator,scores={Performance=0}] run function att2:sound/door/structure_falling
execute if score Real0 TIMER matches 390 run function att2:physicmod/reg4/ouran_portal_center8
execute if score Real0 TIMER matches 390 at @a[gamemode=spectator,scores={Performance=0}] run function att2:sound/door/structure_falling
execute if score Real0 TIMER matches 400 run function att2:physicmod/reg4/ouran_portal_center9
execute if score Real0 TIMER matches 400 at @a[gamemode=spectator,scores={Performance=0}] run function att2:sound/door/structure_falling
execute if score Real0 TIMER matches 410 run function att2:physicmod/reg4/ouran_portal_center10
execute if score Real0 TIMER matches 410 at @a[gamemode=spectator,scores={Performance=0}] run function att2:sound/door/structure_falling
execute if score Real0 TIMER matches 450 at @a[gamemode=spectator,scores={Performance=0}] run function att2:sound/misc/resolution
execute if score Real0 TIMER matches 500 as @a[gamemode=spectator,scores={Performance=0}] run function att2:gameplay/speceffect/disincarnate/end/real0
