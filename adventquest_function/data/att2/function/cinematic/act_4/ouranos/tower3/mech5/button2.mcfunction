...
particle minecraft:item{item:"minecraft:yellow_stained_glass"} 7715 158 5948 5 0 5 0.1 500 normal
particle minecraft:item{item:"minecraft:yellow_stained_glass"} 7715 158 5964 5 0 5 0.1 500 normal
