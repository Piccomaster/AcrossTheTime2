...
execute if score Real0 TIMER matches 101 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 79"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 501 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 82"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 700 run function att2:dialogs/mainquest/act_4/ch4_player_44
execute if score Real0 TIMER matches 701 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 83"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 801 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 84"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 950 run function att2:dialogs/mainquest/act_4/ch4_player_45
execute if score Real0 TIMER matches 951 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 85"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 1101 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 87"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 1151 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 88"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 1650 run function att2:dialogs/mainquest/act_4/ch4_player_47
execute if score Real0 TIMER matches 1651 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 89"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 1751 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 90"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 2051 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 92"},hover_event:{action:show_text,value:"..."}}
