...
execute if score Real0 TIMER matches 10 at 00000000-0000-084a-0000-00000000084a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2923"},hover_event:{action:show_text,value:"..."}}
execute if score Real0 TIMER matches 250 run function att2:dialogs/mainquest/act_4/ch3_player_1
execute if score Real0 TIMER matches 250 at 00000000-0000-084a-0000-00000000084a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2942"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real0 TIMER matches 350 at 00000000-0000-084a-0000-00000000084a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2951"},hover_event:{action:show_text,value:"..."}}
