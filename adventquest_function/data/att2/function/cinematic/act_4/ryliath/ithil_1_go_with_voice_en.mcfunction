...
execute if score Real0 TIMER matches 914 as 00000000-0000-094a-0000-00000000094a at @s run data modify entity 00000000-0000-094a-0000-00000000094a data.rotation set value [180,0]
