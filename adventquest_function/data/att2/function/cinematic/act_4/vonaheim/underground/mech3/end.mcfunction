...
execute positioned -5614 81 -6358 run function att2:summon/reg_1/vindicator1_classx {class:CLASS9}
execute positioned -5614 81 -6358 run function att2:summon/reg_1/vindicator2_classx {class:CLASS9}
execute positioned -5614 81 -6358 run function att2:summon/reg_1/vindicator3_classx {class:CLASS10}
execute positioned -5614 81 -6358 run function att2:summon/reg_1/vindicator5_classx {class:CLASS11}
