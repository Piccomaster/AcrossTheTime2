...
execute positioned -5623 97 -6382 run function att2:summon/reg_1/skeleton1_classx {class:CLASS9}
execute positioned -5623 97 -6382 run function att2:summon/reg_1/skeleton1_classx {class:CLASS9}
execute positioned -5623 97 -6382 run function att2:summon/reg_1/skeletonarcher4_classx {class:CLASS10}
execute positioned -5623 97 -6382 run function att2:summon/reg_1/skeletonarcher4_classx {class:CLASS10}
execute positioned -5623 97 -6382 run function att2:summon/reg_1/vindicator5_classx {class:CLASS11}
