...
execute if score center_s_mech5 VONAHEIM matches 2 if block -5614 167 -6350 air run function att2:cinematic/act_4/vonaheim/center_s/mech5/launch_cinematic
# Cinematic
