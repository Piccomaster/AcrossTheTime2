...
execute if score center_s_mech5 VONAHEIM matches 2 if score 00000000-0000-006b-0000-00000000006b ENEMYABHEALTH matches ..0 run function att2:cinematic/act_4/vonaheim/center_s/mech5/launch_cinematic
