...
execute as @s[nbt={Inventory:[{id:"minecraft:clay_ball",components:{"minecraft:custom_name":{translate:'item.quest.gem_of_time.name'}}}]}] run setblock -5024 63 -5040 minecraft:redstone_block
