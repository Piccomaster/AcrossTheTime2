...
execute if score Real0 TIMER matches 1..400 run function att2:gameplay/speceffect/disincarnate/keep/real0
execute if score Real0 TIMER matches 1..400 run data modify storage att2:performance rotation set value [25,30]

execute if score Real0 TIMER matches 1 positioned -5541 121 -6379 as @a[x=-5544,y=111,z=-6369,distance=..100] run function att2:gameplay/speceffect/disincarnate/start/real0
execute if score Real0 TIMER matches 1..79 run tp @n[type=text_display,tag=Real0] -5541 121 -6379 25 30
...
execute if score Real0 TIMER matches 80..159 run tp @n[type=text_display,tag=Real0] -5539 129 -6374 45 25
...
execute if score Real0 TIMER matches 160..239 run tp @n[type=text_display,tag=Real0] -5546 143 -6367 105 10
...
execute if score Real0 TIMER matches 240..299 run tp @n[type=text_display,tag=Real0] -5612 130 -6367 135 30
...
execute if score Real0 TIMER matches 300..399 run tp @n[type=text_display,tag=Real0] -5615 121 -6387 -90 -80
...
execute if score Real0 TIMER matches 400 as @a[gamemode=spectator,scores={Performance=0}] run function att2:gameplay/speceffect/disincarnate/end/real0
