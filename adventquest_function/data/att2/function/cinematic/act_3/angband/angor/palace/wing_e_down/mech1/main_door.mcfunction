...
execute in minecraft:the_nether positioned 3581 44 4497 run function att2:summon/reg_2/mortal2_classx {class:CLASS9}
execute in minecraft:the_nether positioned 3579 44 4497 run function att2:summon/reg_2/mortal3_classx {class:CLASS10}
execute in minecraft:the_nether positioned 3577 44 4497 run function att2:summon/reg_2/mortal4_classx {class:CLASS9}
