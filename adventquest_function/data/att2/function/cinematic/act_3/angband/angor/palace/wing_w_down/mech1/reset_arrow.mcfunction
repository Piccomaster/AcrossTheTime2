...
execute in minecraft:the_nether run summon minecraft:item 3476 37 4482 {Item:{components:{"minecraft:custom_data":{EquipmentType:'arrow',Rarity:'misc'}},id:"minecraft:arrow",count:1}}
