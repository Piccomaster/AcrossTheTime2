...
execute if score Neth0 TIMER matches 2450 run tellraw @a[scores={DIMENSION=6}] {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Neth0 TIMER matches ..2598 run scoreboard players set Neth0 TIMER 2599"},hover_event:{action:show_text,value:"..."}}
...
execute if score Neth0 TIMER matches 2600 run tellraw @a[scores={DIMENSION=6}] {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Neth0 TIMER matches ..2818 run scoreboard players set Neth0 TIMER 2819"},hover_event:{action:show_text,value:"..."}}
