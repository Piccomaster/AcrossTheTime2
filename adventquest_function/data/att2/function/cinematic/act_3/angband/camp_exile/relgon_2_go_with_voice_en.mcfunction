...
execute if score Neth0 TIMER matches 1470 run tellraw @a {"text":"[-->]","color":"green","click_event":{"action":"run_command","command":"/execute if score Neth0 TIMER matches ..1649 run scoreboard players set Neth0 TIMER 1649"},"hover_event":{"action":"show_text","value":"..."}}
