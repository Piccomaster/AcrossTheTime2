...
execute if score Neth0 TIMER matches 100 run scoreboard players set 00000000-0000-008a-0000-00000000008a TALKING 1
execute if score Neth0 TIMER matches 100 run scoreboard players set 00000000-0000-008a-0000-00000000008a TALKING_TIMER 1500
