...
data modify entity 00000000-0000-001a-0000-00000000001a data.rotation set value [-90,0]
...
data modify entity 00000000-0000-006a-0000-00000000006a data.rotation set value [45,0]
...
data modify entity 00000000-0000-008a-0000-00000000008a data.rotation set value [135,0]
