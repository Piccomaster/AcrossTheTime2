...
##add update score
execute if score eolorion_cycle_time DAILYQUEST matches ..0 run scoreboard players add eolorion_update_count DAILYQUEST 1
execute if score eolorion_cycle_time DAILYQUEST matches ..0 run scoreboard players operation eolorion_cycle_time DAILYQUEST = eolorion_cycle_time_set DAILYQUEST
