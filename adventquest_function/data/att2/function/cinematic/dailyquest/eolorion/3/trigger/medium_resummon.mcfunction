...
#limit
execute unless score eolorion_dailyquest_3_medium_ores_resummon DAILYQUEST matches 1.. run return 0
##test location
...
tag @s remove Clear
##remove score
scoreboard players remove eolorion_dailyquest_3_medium_ores_resummon DAILYQUEST 1
##resummon
