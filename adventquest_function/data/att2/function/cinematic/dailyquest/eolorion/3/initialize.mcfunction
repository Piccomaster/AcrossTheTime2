...
scoreboard players set eolorion_dailyquest_3_rewards_chronoton DAILYQUEST 100
scoreboard players set eolorion_dailyquest_3_rewards_xp DAILYQUEST 500
...
scoreboard players set eolorion_dailyquest_3_fail_chronoton DAILYQUEST 50
