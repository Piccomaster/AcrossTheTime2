...
scoreboard players set eolorion_dailyquest_7_rewards_reputation DAILYQUEST 5
scoreboard players set eolorion_dailyquest_7_rewards_city_donation DAILYQUEST 20

scoreboard players set eolorion_dailyquest_7_fail_chronoton DAILYQUEST 300
