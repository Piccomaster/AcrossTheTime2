...
##Cal chronoton
scoreboard players operation rewards_chronotons DAILYQUEST = eolorion_dailyquest_7_rewards_chronoton DAILYQUEST
scoreboard players operation @a CHRONOTON += rewards_chronotons DAILYQUEST

##Cal xp
scoreboard players operation rewards_xp DAILYQUEST = eolorion_dailyquest_7_rewards_xp DAILYQUEST
...
##Cal reputation
scoreboard players operation rewards_reputation DAILYQUEST = eolorion_dailyquest_7_rewards_reputation DAILYQUEST
scoreboard players operation heros REPUTATION += rewards_reputation DAILYQUEST
##Cal city_donation
scoreboard players operation rewards_city_donation DAILYQUEST = eolorion_dailyquest_7_rewards_city_donation DAILYQUEST
scoreboard players operation eolorion_city_donation DAILYQUEST += rewards_city_donation DAILYQUEST

##tip
tellraw @a [{translate:att2.dailyquest.eolorion.completed},{translate:att2.dailyquest.eolorion.7.name,color:"blue"}]
...
scoreboard players set eolorion_dailyquest_7_completed DAILYQUEST 1
