...
##update cooldown
execute store result score fireball_duel_bob_l_cooldown DAILYQUEST run random value 60..80
##rng
execute store result score #RNG CAL run random value 1..100
##summon fire ball
execute if score #RNG CAL matches 1..70 as 00000000-0000-088a-0000-00000000088a at @s run return run function att2:cinematic/dailyquest/eolorion/5/fireball_duel/summon/bob_l_fire_ball_1
execute if score #RNG CAL matches 1..70 as 00000000-0000-088a-0000-00000000088a at @s run return run function att2:cinematic/dailyquest/eolorion/5/fireball_duel/summon/bob_l_fire_ball_1
execute if score #RNG CAL matches 71..90 as 00000000-0000-088a-0000-00000000088a at @s run return run function att2:cinematic/dailyquest/eolorion/5/fireball_duel/summon/bob_l_fire_ball_2
...
execute if score #RNG CAL matches 91..100 as 00000000-0000-088a-0000-00000000088a at @s run return run function att2:cinematic/dailyquest/eolorion/5/fireball_duel/summon/bob_l_fire_ball_1