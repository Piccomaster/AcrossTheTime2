...
##effect
execute as @n[distance=..0.5,type=item_display,tag=BobL,tag=FireBallDuel] run function att2:cinematic/dailyquest/eolorion/5/fireball_duel/trigger/big_fire_ball_explosion
##explosion
