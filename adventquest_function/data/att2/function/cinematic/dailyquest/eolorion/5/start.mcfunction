...
function att2:cinematic/dailyquest/eolorion/5/initialize
##tip
tellraw @a [{translate:att2.dailyquest.eolorion.accepted},{translate:att2.dailyquest.eolorion.5.name,color:"blue"}]
tellraw @a [{translate:att2.dailyquest.requirements},{text:"\n"},{translate:att2.dailyquest.eolorion.5.requirements,color:"#53EAFD"}]
tellraw @a [{translate:att2.dailyquest.rewards}]
tellraw @a [{translate:att2.dailyquest.rewards.add.chronotons,with:[{score:{name:eolorion_dailyquest_5_rewards_chronoton,objective:DAILYQUEST},color:"yellow"}]}]
tellraw @a [{translate:att2.dailyquest.rewards.add.xp,with:[{score:{name:eolorion_dailyquest_5_rewards_xp,objective:DAILYQUEST},color:"green"}]}]
tellraw @a [{translate:att2.dailyquest.rewards.add.reputation,with:[{score:{name:eolorion_dailyquest_5_rewards_reputation,objective:DAILYQUEST},color:"dark_green"}]}]
tellraw @a [{translate:att2.dailyquest.rewards.add.eolorion.city_donation,with:[{score:{name:eolorion_dailyquest_5_rewards_city_donation,objective:DAILYQUEST},color:"blue"}]}]
##sound
