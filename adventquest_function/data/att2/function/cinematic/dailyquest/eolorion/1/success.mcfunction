...
##Cal chronoton
scoreboard players operation rewards_chronotons DAILYQUEST = eolorion_dailyquest_1_rewards_chronoton DAILYQUEST
scoreboard players operation @a CHRONOTON += rewards_chronotons DAILYQUEST

##Cal xp
scoreboard players operation rewards_xp DAILYQUEST = eolorion_dailyquest_1_rewards_xp DAILYQUEST
...
##Cal reputation
scoreboard players operation rewards_reputation DAILYQUEST = eolorion_dailyquest_1_rewards_reputation DAILYQUEST
scoreboard players operation heros REPUTATION += rewards_reputation DAILYQUEST
##Cal city_donation
scoreboard players operation rewards_city_donation DAILYQUEST = eolorion_dailyquest_1_rewards_city_donation DAILYQUEST
...
##reset
function att2:cinematic/dailyquest/eolorion/1/reset
##add quest completed count
scoreboard players add eolorion_dailyquest_completed_count DAILYQUEST 1
scoreboard players set eolorion_dailyquest_1_completed DAILYQUEST 1
