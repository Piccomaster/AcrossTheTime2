...
##remove reputation
scoreboard players operation heros REPUTATION -= eolorion_dailyquest_1_fail_reputation DAILYQUEST

##remove chronotons
execute if score TOTAL BANK >= eolorion_dailyquest_1_fail_chronoton DAILYQUEST run return run scoreboard players operation TOTAL BANK -= eolorion_dailyquest_1_fail_chronoton DAILYQUEST
scoreboard players operation @s CHRONOTON -= eolorion_dailyquest_1_fail_chronoton DAILYQUEST
