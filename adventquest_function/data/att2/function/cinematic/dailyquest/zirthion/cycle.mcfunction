...
##add update score
execute unless score zirthion_cycle_time DAILYQUEST matches 1.. run function att2:cinematic/dailyquest/zirthion/update_score
##if player nearly -> update
execute unless entity @a[distance=..20] run return 0

##reward limit
execute if score 00001cbe-0000-007b-0000-1ca400000001 DAILYQUEST matches 1.. run function att2:cinematic/dailyquest/zirthion/summon_reward_block
execute if score zirthion_city_donation_accumulated_value DAILYQUEST matches 1.. positioned 7358 120 7329 unless block ~ ~ ~ minecraft:decorated_pot run function att2:cinematic/dailyquest/zirthion/reward_trigger
...
##rng select quest
scoreboard players remove zirthion_update_count DAILYQUEST 1

#######DailyQuest 1 : A small dream.
#random value
execute store result score #RNG CAL run random value 1..100
#set id
data modify storage att2:dailyquest rng_selectid set value 1
#Guarantee Mechanism
execute unless score zirthion_dailyquest_1_completed DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 1
#other limit
execute if score zirthion_dailyquest_1 DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 0
#rng select
...
#######DailyQuest 2 : Eat a hearty meal.
#random value
execute store result score #RNG CAL run random value 1..100
#set id
data modify storage att2:dailyquest rng_selectid set value 2
#Guarantee Mechanism
execute unless score zirthion_dailyquest_2_completed DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 1
#other limit
execute if score zirthion_dailyquest_2 DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 0
#rng select
...
#######DailyQuest 3 : Chaotic Wind Cluster
#random value
execute store result score #RNG CAL run random value 1..100
#set id
data modify storage att2:dailyquest rng_selectid set value 3
#Guarantee Mechanism
execute unless score zirthion_dailyquest_3_completed DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 1
#other limit
execute if score zirthion_dailyquest_3 DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 0
#rng select
...
#######DailyQuest 4 : Aerial assessment
#random value
#execute store result score #RNG CAL run random value 1..100
#set id
#data modify storage att2:dailyquest rng_selectid set value 4
#Guarantee Mechanism
#execute unless score zirthion_dailyquest_4_completed DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 1
#other limit
#execute if score zirthion_dailyquest_4 DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 0
#rng select
...
#Guarantee Mechanism
#execute unless score zirthion_dailyquest_5_completed DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 1
#other limit
#execute if score zirthion_dailyquest_5 DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 0
#rng select
...
#Guarantee Mechanism
#execute unless score zirthion_dailyquest_6_completed DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 1
#other limit
#execute if score zirthion_dailyquest_6 DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 0
#rng select
...
#Guarantee Mechanism
#execute unless score zirthion_dailyquest_7_completed DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 1
#other limit
#execute if score zirthion_dailyquest_7 DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 0
#rng select
...
#Guarantee Mechanism
#execute unless score zirthion_dailyquest_8_completed DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 1
#other limit
#execute if score zirthion_dailyquest_8 DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 0
#rng select
...
#Guarantee Mechanism
#execute unless score zirthion_dailyquest_9_completed DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 1
#other limit
#execute if score zirthion_dailyquest_9 DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 0
#rng select
...
#Guarantee Mechanism
#execute unless score zirthion_dailyquest_10_completed DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 1
#other limit
#execute if score zirthion_dailyquest_10 DAILYQUEST matches 1.. run scoreboard players set #RNG CAL 0
#rng select
