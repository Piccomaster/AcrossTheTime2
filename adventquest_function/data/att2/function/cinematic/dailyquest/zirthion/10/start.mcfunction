...
##set progress
scoreboard players set zirthion_dailyquest_10 DAILYQUEST 1
##initialize quest data
function att2:cinematic/dailyquest/zirthion/10/initialize
##tip
tellraw @a [{translate:att2.dailyquest.zirthion.accepted},{translate:att2.dailyquest.zirthion.10.name}]
...
tellraw @a [{translate:att2.dailyquest.rewards.add.xp,with:[{score:{name:zirthion_dailyquest_10_rewards_xp,objective:DAILYQUEST},color:"green"}]}]
tellraw @a [{translate:att2.dailyquest.rewards.add.reputation,with:[{score:{name:zirthion_dailyquest_10_rewards_reputation,objective:DAILYQUEST},color:"dark_green"}]}]
tellraw @a [{translate:att2.dailyquest.rewards.add.zirthion.city_donation,with:[{score:{name:zirthion_dailyquest_10_rewards_city_donation,objective:DAILYQUEST},color:"blue"}]}]
##sound
