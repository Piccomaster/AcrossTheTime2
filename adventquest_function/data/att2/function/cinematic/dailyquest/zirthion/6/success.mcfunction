...
##Cal chronoton
scoreboard players operation rewards_chronotons DAILYQUEST = zirthion_dailyquest_6_rewards_chronoton DAILYQUEST
scoreboard players operation @a CHRONOTON += rewards_chronotons DAILYQUEST

##Cal xp
scoreboard players operation rewards_xp DAILYQUEST = zirthion_dailyquest_6_rewards_xp DAILYQUEST
...
##Cal reputation
scoreboard players operation rewards_reputation DAILYQUEST = zirthion_dailyquest_6_rewards_reputation DAILYQUEST
scoreboard players operation heros REPUTATION += rewards_reputation DAILYQUEST
##Cal city_donation
scoreboard players operation rewards_city_donation DAILYQUEST = zirthion_dailyquest_6_rewards_city_donation DAILYQUEST
scoreboard players operation zirthion_city_donation DAILYQUEST += rewards_city_donation DAILYQUEST

##tip
tellraw @a [{translate:att2.dailyquest.zirthion.completed},{translate:att2.dailyquest.zirthion.1.name,color:"blue"}]
...
scoreboard players set zirthion_dailyquest_6_completed DAILYQUEST 1
