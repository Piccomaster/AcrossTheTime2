...
function att2:cinematic/dailyquest/zirthion/1/initialize
##tip
tellraw @a [{translate:att2.dailyquest.zirthion.accepted},{translate:att2.dailyquest.zirthion.1.name,color:"blue"}]
tellraw @a [{translate:att2.dailyquest.requirements},{text:"\n"},{translate:att2.dailyquest.zirthion.1.requirements,color:"#53EAFD"}]
tellraw @a [{translate:att2.dailyquest.rewards}]
tellraw @a [{translate:att2.dailyquest.rewards.add.chronotons,with:[{score:{name:zirthion_dailyquest_1_rewards_chronoton,objective:DAILYQUEST},color:"yellow"}]}]
tellraw @a [{translate:att2.dailyquest.rewards.add.xp,with:[{score:{name:zirthion_dailyquest_1_rewards_xp,objective:DAILYQUEST},color:"green"}]}]
tellraw @a [{translate:att2.dailyquest.rewards.add.reputation,with:[{score:{name:zirthion_dailyquest_1_rewards_reputation,objective:DAILYQUEST},color:"dark_green"}]}]
tellraw @a [{translate:att2.dailyquest.rewards.add.zirthion.city_donation,with:[{score:{name:zirthion_dailyquest_1_rewards_city_donation,objective:DAILYQUEST},color:"blue"}]}]
##sound
