...
##chronotons
scoreboard players operation #chronotons CAL = zirthion_city_donation_accumulated_value DAILYQUEST
scoreboard players operation #chronotons CAL *= 2 CAL

##xp
scoreboard players operation #xp CAL = zirthion_city_donation_accumulated_value DAILYQUEST
...
##reset
scoreboard players set zirthion_city_donation_accumulated_value DAILYQUEST 0