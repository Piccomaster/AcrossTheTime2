...
##test max
execute if score zirthion_dailyquest_3_open_rune_chest DAILYQUEST >= zirthion_dailyquest_3_open_rune_chest_requirement DAILYQUEST run return 0
##test over
...
scoreboard players add zirthion_dailyquest_3_open_rune_chest DAILYQUEST 1
