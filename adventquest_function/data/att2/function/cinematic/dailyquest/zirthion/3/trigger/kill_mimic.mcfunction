...
##test max
execute if score zirthion_dailyquest_3_kill_mimic DAILYQUEST >= zirthion_dailyquest_3_kill_mimic_requirement DAILYQUEST run return 0
##test over
...
scoreboard players add zirthion_dailyquest_3_kill_mimic DAILYQUEST 1
