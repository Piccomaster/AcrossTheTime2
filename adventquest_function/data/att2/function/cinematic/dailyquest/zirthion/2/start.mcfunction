...
##set progress
scoreboard players set zirthion_dailyquest_2 DAILYQUEST 1
...
tellraw @a [{translate:att2.dailyquest.rewards.add.xp,with:[{score:{name:zirthion_dailyquest_2_rewards_xp,objective:DAILYQUEST},color:"green"}]}]
tellraw @a [{translate:att2.dailyquest.rewards.add.reputation,with:[{score:{name:zirthion_dailyquest_2_rewards_reputation,objective:DAILYQUEST},color:"dark_green"}]}]
tellraw @a [{translate:att2.dailyquest.rewards.add.zirthion.city_donation,with:[{score:{name:zirthion_dailyquest_2_rewards_city_donation,objective:DAILYQUEST},color:"blue"}]}]
##sound
