...
##Cal chronoton
scoreboard players operation rewards_chronotons DAILYQUEST = zirthion_dailyquest_2_rewards_chronoton DAILYQUEST
scoreboard players operation @a CHRONOTON += rewards_chronotons DAILYQUEST

##Cal xp
scoreboard players operation rewards_xp DAILYQUEST = zirthion_dailyquest_2_rewards_xp DAILYQUEST
...
##Cal reputation
scoreboard players operation rewards_reputation DAILYQUEST = zirthion_dailyquest_2_rewards_reputation DAILYQUEST
scoreboard players operation heros REPUTATION += rewards_reputation DAILYQUEST
##Cal city_donation
scoreboard players operation rewards_city_donation DAILYQUEST = zirthion_dailyquest_2_rewards_city_donation DAILYQUEST
...
scoreboard players set zirthion_dailyquest_2_completed DAILYQUEST 1
