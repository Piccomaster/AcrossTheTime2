...
#limit
execute unless score ryliath_dailyquest_2_small_ores_resummon DAILYQUEST matches 1.. run return 0
##test location
...
##remove score
scoreboard players remove ryliath_dailyquest_2_small_ores_resummon DAILYQUEST 1
##remove tag
tag @s remove Clear
##resummon
