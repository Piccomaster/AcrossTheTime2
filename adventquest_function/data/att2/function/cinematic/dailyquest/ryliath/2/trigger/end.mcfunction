...
tellraw @a[distance=..128] [{translate:att2.dailyquest.mining_b.progress,color:"#C9C900",with:[{score:{name:ryliath_dailyquest_2_mining_b,objective:DAILYQUEST},color:"gray"},{score:{name:ryliath_dailyquest_2_mining_c_requirement,objective:DAILYQUEST},color:"yellow"}]}]
tellraw @a[distance=..128] [{translate:att2.dailyquest.mining_c.progress,color:"#939300",with:[{score:{name:ryliath_dailyquest_2_mining_c,objective:DAILYQUEST},color:"gray"},{score:{name:ryliath_dailyquest_2_mining_b_requirement,objective:DAILYQUEST},color:"yellow"}]}]
