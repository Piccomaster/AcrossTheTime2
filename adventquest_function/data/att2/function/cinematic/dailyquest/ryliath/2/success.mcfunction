...
##Cal chronoton
scoreboard players operation rewards_chronotons DAILYQUEST = ryliath_dailyquest_2_rewards_chronoton DAILYQUEST
scoreboard players operation @a CHRONOTON += rewards_chronotons DAILYQUEST

##Cal xp
scoreboard players operation rewards_xp DAILYQUEST = ryliath_dailyquest_2_rewards_xp DAILYQUEST
...
##Cal reputation
scoreboard players operation rewards_reputation DAILYQUEST = ryliath_dailyquest_2_rewards_reputation DAILYQUEST
scoreboard players operation heros REPUTATION += rewards_reputation DAILYQUEST
##Cal city_donation
scoreboard players operation rewards_city_donation DAILYQUEST = ryliath_dailyquest_2_rewards_city_donation DAILYQUEST
