...
##test if over
execute if score ryliath_dailyquest_2_mining_c DAILYQUEST >= ryliath_dailyquest_2_mining_c_requirement DAILYQUEST run return 0
##test location
execute unless predicate att2_pre:location/sylberland/worlest run return 0

##add score
scoreboard players add ryliath_dailyquest_2_mining_c DAILYQUEST 1
