...
##test max
execute if score phoenix_dailyquest_1_open_rune_chest DAILYQUEST >= phoenix_dailyquest_1_open_rune_chest_requirement DAILYQUEST run return 0
##test over
...
scoreboard players add phoenix_dailyquest_1_open_rune_chest DAILYQUEST 1
