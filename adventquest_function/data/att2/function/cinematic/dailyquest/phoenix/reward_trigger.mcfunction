...
##chronotons
scoreboard players operation #chronotons CAL = phoenix_city_donation_accumulated_value DAILYQUEST
scoreboard players operation #chronotons CAL *= 4 CAL

##xp
scoreboard players operation #xp CAL = phoenix_city_donation_accumulated_value DAILYQUEST
...
##reset
scoreboard players set phoenix_city_donation_accumulated_value DAILYQUEST 0