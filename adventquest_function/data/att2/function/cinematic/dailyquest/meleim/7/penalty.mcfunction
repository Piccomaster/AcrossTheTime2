...
##remove reputation
scoreboard players operation heros REPUTATION -= meleim_dailyquest_7_fail_reputation DAILYQUEST

##remove chronotons
execute if score TOTAL BANK >= meleim_dailyquest_7_fail_chronoton DAILYQUEST run return run scoreboard players operation TOTAL BANK -= meleim_dailyquest_7_fail_chronoton DAILYQUEST
scoreboard players operation @s CHRONOTON -= meleim_dailyquest_7_fail_chronoton DAILYQUEST
