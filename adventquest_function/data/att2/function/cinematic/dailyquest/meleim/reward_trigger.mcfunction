...
##chronotons
scoreboard players operation #chronotons CAL = meleim_city_donation_accumulated_value DAILYQUEST
scoreboard players operation #chronotons CAL *= 2 CAL

##xp
scoreboard players operation #xp CAL = meleim_city_donation_accumulated_value DAILYQUEST
...
##reset
scoreboard players set meleim_city_donation_accumulated_value DAILYQUEST 0