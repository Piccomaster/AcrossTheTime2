...
##set progress
scoreboard players set meleim_dailyquest_1 DAILYQUEST 1
##initialize quest data
function att2:cinematic/dailyquest/meleim/1/initialize
##tip
tellraw @a [{translate:att2.dailyquest.meleim.accepted},{translate:att2.dailyquest.meleim.1.name,color:"blue"}]
tellraw @a [{translate:att2.dailyquest.requirements},{text:"\n"},{translate:att2.dailyquest.meleim.1.requirements,color:"#53EAFD"}]
tellraw @a [{translate:att2.dailyquest.rewards}]
tellraw @a [{translate:att2.dailyquest.rewards.add.chronotons,with:[{score:{name:meleim_dailyquest_1_rewards_chronoton,objective:DAILYQUEST},color:"yellow"}]}]
