...
##vitality
execute if score #RNG CAL matches 1 store result score #Random_Vitality CAL run random value -8..8
...
##speed
execute if score #RNG CAL matches 2 store result score #Random_Speed CAL run random value -80..100
...
##health
execute if score #RNG CAL matches 3 store result score #Random_Health CAL run random value -5..5
...
execute if score #RNG CAL matches 3 on vehicle if entity @s[tag=RIDE] run return run function att2:cinematic/dailyquest/meleim/9/horse_race/health/special_item_a_effect