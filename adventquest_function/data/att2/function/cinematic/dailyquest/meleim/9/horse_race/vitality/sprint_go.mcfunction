...
##reset
execute if score @s HORSERACE_VITALITY_SPRINT matches ..1000 run return run function att2:cinematic/dailyquest/meleim/9/horse_race/vitality/sprint_reset
execute if score @s HORSERACE_VITALITY_SPRINT matches 2000 run return run function att2:cinematic/dailyquest/meleim/9/horse_race/vitality/sprint_reset
execute if score @s HORSERACE_VITALITY_SPRINT matches 3000 run return run function att2:cinematic/dailyquest/meleim/9/horse_race/vitality/sprint_reset
execute if score @s HORSERACE_VITALITY_SPRINT matches 4000 run return run function att2:cinematic/dailyquest/meleim/9/horse_race/vitality/sprint_reset
