...
#############################################################
##( HORSERACE_VITALITY = 100 x vitality_lvl - 60)

##initialize lvl
#scoreboard players add @s HORSERACE_VITALITY_LVL 0
...
##test lvl_up
execute if score #vitality_now_lvl CAL > #vitality_record_lvl CAL run function att2:cinematic/dailyquest/meleim/9/horse_race/vitality/lvl_up

##get player sprint count
scoreboard players operation #HORSERACE_VITALITY_COUNT CAL = @p[distance=..0] HORSERACE_VITALITY
#bossbar_data_update
function att2:cinematic/dailyquest/meleim/9/horse_race/bossbar_data_update with storage att2:score