...
execute if score meleim_dailyquest_5 DAILYQUEST matches 2 if score von CAL matches 1.. if score ehl CAL matches 1.. if score ave CAL matches 1.. run scoreboard players set meleim_dailyquest_5 DAILYQUEST 100
