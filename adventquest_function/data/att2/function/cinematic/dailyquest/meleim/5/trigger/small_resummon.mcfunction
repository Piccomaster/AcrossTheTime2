...
#limit
execute unless score meleim_dailyquest_5_small_ores_resummon DAILYQUEST matches 1.. run return 0
##test location
...
tag @s remove Clear
##remove score
scoreboard players remove meleim_dailyquest_5_small_ores_resummon DAILYQUEST 1
##resummon
