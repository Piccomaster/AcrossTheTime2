...
execute if score meleim_dailyquest_4 DAILYQUEST matches 1..99 run function att2:cinematic/dailyquest/meleim/4/trigger/kill_mimic
...
execute if score zirthion_dailyquest_3 DAILYQUEST matches 1..99 run function att2:cinematic/dailyquest/zirthion/3/trigger/kill_mimic