...
execute if score Real3 TIMER matches 50 run function att2:gameplay/cinematic/misc/trial_dungeon/sections/13/opening
execute if score Real3 TIMER matches 50 run function att2:gameplay/cinematic/misc/trial_dungeon/sections/14/summon
...
execute if score Real3 TIMER matches 101.. run scoreboard players set section13 TRIAL_DUNGEON -1
