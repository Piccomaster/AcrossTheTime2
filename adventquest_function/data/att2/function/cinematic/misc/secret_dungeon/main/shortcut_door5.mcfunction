...
execute positioned -4569 69 -6102 run function att2:summon/reg_1/wardenknight2_classx {class:CLASS18}
execute positioned -4569 69 -6102 as @e[distance=..5] run data merge entity @s {PersistenceRequired:1}
execute positioned -4573 69 -6102 run function att2:summon/reg_1/wardenknight2_classx {class:CLASS18}
