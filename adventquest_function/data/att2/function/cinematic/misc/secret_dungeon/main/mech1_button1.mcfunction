...
execute positioned -4394 50 -6182 run function att2:summon/reg_1/wardenknight0_classx {class:CLASS19}
execute positioned -4392 50 -6182 run function att2:summon/reg_1/wardenknight1_classx {class:CLASS19}
