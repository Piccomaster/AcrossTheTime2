...
#change name
execute unless score set MAINPLAYERNAME matches 1.. run data modify storage att2:id set.text set from storage att2:id temp_name
execute if score set MAINPLAYERNAME matches 1.. run data modify storage att2:id set.text set from storage att2:id name