...
execute if score Real0 TIMER matches 40 run data merge entity @e[x=-4653,y=78,z=-5413,distance=..2,type=minecraft:zombified_piglin,limit=1] {NoAI:0b,Invulnerable:0,AngerTime:1000000}
