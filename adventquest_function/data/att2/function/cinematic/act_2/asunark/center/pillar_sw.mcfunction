...
execute positioned -3472 28 -4910 run function att2:summon/reg_1/skeletonarcher0_classx {class:CLASS7}
execute positioned -3475 28 -4913 run function att2:summon/reg_1/skeletonarcher0_classx {class:CLASS7}
