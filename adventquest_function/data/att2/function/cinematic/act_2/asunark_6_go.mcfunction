...
execute if score Real0 TIMER matches 11..300 run data modify storage att2:performance rotation set value [45,10]
...
execute if score Real0 TIMER matches 11..60 run tp @n[type=text_display,tag=Real0] -3462 31 -4923 45 10
...
execute if score Real0 TIMER matches 61..120 run tp @n[type=text_display,tag=Real0] -3462 31 -4961 135 10
...
execute if score Real0 TIMER matches 121..180 run tp @n[type=text_display,tag=Real0] -3424 31 -4961 -135 10
...
execute if score Real0 TIMER matches 181..240 run tp @n[type=text_display,tag=Real0] -3424 31 -4923 -45 10
...
execute if score Real0 TIMER matches 241..300 run tp @n[type=text_display,tag=Real0] -3457 33 -4913 -152 -30
