...
execute if score Real0 TIMER matches 11..300 run data modify storage att2:performance rotation set value [90,0]

execute if score Real0 TIMER matches 10 positioned -3483 13 -4942 as @a[distance=..100] run function att2:gameplay/speceffect/disincarnate/start/real0
execute if score Real0 TIMER matches 11..59 run tp @n[type=text_display,tag=Real0] -3407 30 -4942 90 0
execute if score Real0 TIMER matches 15 positioned -3443 31 -4942 run function att2:sound/ambience/dungeon1
execute if score Real0 TIMER matches 60..119 run tp @n[type=text_display,tag=Real0] -3425 30 -4942 90 0
execute if score Real0 TIMER matches 120..179 run tp @n[type=text_display,tag=Real0] -3443 28 -4928 0 0
execute if score Real0 TIMER matches 180..239 run tp @n[type=text_display,tag=Real0] -3443 28 -4952 180 0
execute if score Real0 TIMER matches 240..299 run tp @n[type=text_display,tag=Real0] -3477 37 -4958 -50 30
