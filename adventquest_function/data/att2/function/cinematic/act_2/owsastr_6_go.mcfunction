...
execute if score Real0 TIMER matches 10 positioned -4997 72 -4381 as @a[distance=..100] run function att2:gameplay/speceffect/disincarnate/start/real0
...
execute if score Real0 TIMER matches 300 as @a[gamemode=spectator] run function att2:gameplay/speceffect/disincarnate/end/real0
