...
data modify entity 00000000-0000-033a-0000-00000000033a equipment.head.components.enchantments set value {"att2_enchantment:tick/mob_initialize":1}
...
data modify entity 00000000-0000-034a-0000-00000000034a equipment.head.components.enchantments set value {"att2_enchantment:tick/mob_initialize":1}
