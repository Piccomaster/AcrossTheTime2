...
execute positioned -5508 20 -4025 run function att2:summon/reg_1/husk3_classx {class:CLASS20}
execute positioned -5508 20 -4049 run function att2:summon/reg_1/husk4_classx {class:CLASS20}
execute positioned -5520 20 -4037 run function att2:summon/reg_1/husk5_classx {class:CLASS20}
