...
execute as @a run function att2:dialogs/gameplay/misc/map/point/black_forest_mine
execute as @a run function att2:dialogs/gameplay/misc/map/point/black_forest_mine_top_house
