...
data modify entity 00000000-0000-070a-0000-00000000070a equipment.head.components.enchantments set value {"att2_enchantment:tick/mob_initialize":1,"att2_enchantment:tick/misc/pnj_talk":1}
