...
execute if score Real1 TIMER matches 20 at 00000000-0000-089a-0000-00000000089a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3025"},hover_event:{action:show_text,value:"..."}}
