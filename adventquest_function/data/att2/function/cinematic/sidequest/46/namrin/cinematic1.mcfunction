...
execute if score Neth1 TIMER matches 50 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Neth1 TIMER matches ..348 run scoreboard players set Neth1 TIMER 349"},hover_event:{action:show_text,value:"..."}}
...
execute if score Neth1 TIMER matches 500 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Neth1 TIMER matches ..848 run scoreboard players set Neth1 TIMER 849"},hover_event:{action:show_text,value:"..."}}
execute if score Neth1 TIMER matches 850 run function att2:dialogs/sidequest/sq46/namrin_3
execute if score Neth1 TIMER matches 850 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Neth1 TIMER matches ..898 run scoreboard players set Neth1 TIMER 899"},hover_event:{action:show_text,value:"..."}}
execute if score Neth1 TIMER matches 900 run function att2:dialogs/sidequest/sq46/player_4
execute if score Neth1 TIMER matches 900 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Neth1 TIMER matches ..973 run scoreboard players set Neth1 TIMER 974"},hover_event:{action:show_text,value:"..."}}
execute if score Neth1 TIMER matches 975 run function att2:dialogs/sidequest/sq46/namrin_4
execute if score Neth1 TIMER matches 975 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Neth1 TIMER matches ..1048 run scoreboard players set Neth1 TIMER 1049"},hover_event:{action:show_text,value:"..."}}
execute if score Neth1 TIMER matches 1050 run function att2:dialogs/sidequest/sq46/player_5
execute if score Neth1 TIMER matches 1050 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Neth1 TIMER matches ..1098 run scoreboard players set Neth1 TIMER 1099"},hover_event:{action:show_text,value:"..."}}
