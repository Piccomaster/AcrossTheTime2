...
execute if score Real2 TIMER matches 1 run data modify storage att2:performance rotation set value [-50,25]

execute if score Real2 TIMER matches 1 positioned -5115 167 -6756 as @a[x=-5112,y=165,z=-6756,distance=..100] run function att2:gameplay/speceffect/disincarnate/start/real2
execute if score Real2 TIMER matches 1..149 run tp @n[type=text_display,tag=Real2] -5115 167 -6756 -50 25
execute if score Real2 TIMER matches 1..20 run particle minecraft:dust{color:[0,0,0],scale:4} -5112 167 -6756 0.25 0.25 0.25 0 5
execute if score Real2 TIMER matches 10 at @a[gamemode=spectator,scores={Performance=2}] run function att2:sound/mobs/korlaph_evoking2
execute if score Real2 TIMER matches 20 run data merge entity @e[type=minecraft:wither_skeleton,tag=Error,limit=1] {equipment:{}}
execute if score Real2 TIMER matches 20 positioned -5112 165 -6756 run function att2:summon/reg_1/umbra
execute if score Real2 TIMER matches 20..1000 at @e[type=minecraft:wither_skeleton,tag=Crown,limit=1] run particle minecraft:dust{color:[0,0,0],scale:4} ~ ~2.05 ~ 0.1 0.1 0.1 0 5
...
execute if score Real2 TIMER matches 105 at @a[gamemode=spectator,scores={Performance=2}] run function att2:sound/misc/screamer
...
execute if score Real2 TIMER matches 150 as @a[gamemode=spectator,scores={Performance=2}] run function att2:gameplay/speceffect/disincarnate/end/real2
