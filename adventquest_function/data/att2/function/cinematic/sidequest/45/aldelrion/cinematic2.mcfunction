...
execute if score Neth1 TIMER matches 150 at 00000000-0000-149a-0000-00000000149a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2995"},hover_event:{action:show_text,value:"..."}}
