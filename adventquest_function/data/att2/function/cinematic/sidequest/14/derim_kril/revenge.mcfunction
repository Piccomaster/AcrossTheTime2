...
execute positioned 3909 49 3899 run function att2:summon/reg_2/phoenixsoldat1_classx {class:CLASS10}
execute positioned 3909 49 3899 run function att2:summon/reg_2/phoenixsoldat2_classx {class:CLASS10}
