...
execute as @a[nbt={Inventory:[{components:{EquipmentID:"lostpast"}}]}] run clear @s minecraft:bow{EquipmentType:"rangeWeapon",EquipmentID:"lostpast",Rarity:"myt"}
kill @e[type=minecraft:item,nbt={Item:{components:{EquipmentID:"lostpast"}}}]
