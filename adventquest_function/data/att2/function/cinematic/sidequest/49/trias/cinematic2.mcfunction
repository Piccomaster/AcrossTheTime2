...
execute if score Real1 TIMER matches 50 at 00000000-0000-129a-0000-00000000129a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3015"},hover_event:{action:show_text,value:"..."}}
execute if score Real1 TIMER matches 150 run function att2:dialogs/sidequest/sq49/player_1
execute if score Real1 TIMER matches 150 at 00000000-0000-129a-0000-00000000129a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3016"},hover_event:{action:show_text,value:"..."}}
