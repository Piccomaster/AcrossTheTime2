...
execute if score Real2 TIMER matches 100 at 00000000-0000-082a-0000-00000000082a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2958"},hover_event:{action:show_text,value:"..."}}
