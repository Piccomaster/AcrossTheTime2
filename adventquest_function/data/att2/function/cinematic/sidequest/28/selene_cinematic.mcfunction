...
execute if score Real2 TIMER matches 10 at 00000000-0000-082a-0000-00000000082a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2980"},hover_event:{action:show_text,value:"..."}}
execute if score Real2 TIMER matches 80 run function att2:dialogs/sidequest/sq28/selene_9
execute if score Real2 TIMER matches 80 at 00000000-0000-082a-0000-00000000082a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2981"},hover_event:{action:show_text,value:"..."}}
execute if score Real2 TIMER matches 150 run function att2:dialogs/sidequest/sq28/emerald_7
execute if score Real2 TIMER matches 150 at 00000000-0000-082a-0000-00000000082a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2961"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real2 TIMER matches 300 at 00000000-0000-082a-0000-00000000082a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2956"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real2 TIMER matches 700 at 00000000-0000-082a-0000-00000000082a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2982"},hover_event:{action:show_text,value:"..."}}
