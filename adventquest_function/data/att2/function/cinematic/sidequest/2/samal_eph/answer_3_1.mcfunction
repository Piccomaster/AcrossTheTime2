...
data merge entity 00000000-0000-035a-0000-00000000035a {Tags:["LVL0","CLASS2","Reg1","Undead"],AngerTime:1000000,NoAI:0b,Invulnerable:0,Silent:0b,AbsorptionAmount:0,drop_chances:{mainhand:0,offhand:0,feet:0,legs:0,chest:0,head:0,body:0,saddle:0}}
