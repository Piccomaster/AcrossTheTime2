...
execute if score SQ47 SIDEQUEST matches 3 if score cinematic SQ47 matches 4 if entity @a[x=3142,y=67,z=4084,distance=..7,nbt={Inventory:[{components:{"minecraft:custom_data":{EquipmentID:"rukyrion"}}}]}] run function att2:cinematic/sidequest/47/namrin/start_cinematic3
