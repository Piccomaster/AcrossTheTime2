...
execute if score Neth1 TIMER matches 50 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2993"},hover_event:{action:show_text,value:"..."}}
execute if score Neth1 TIMER matches 150 run function att2:dialogs/sidequest/sq47/player_2
execute if score Neth1 TIMER matches 150 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3003"},hover_event:{action:show_text,value:"..."}}
...
execute if score Neth1 TIMER matches 500 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2997"},hover_event:{action:show_text,value:"..."}}
execute if score Neth1 TIMER matches 800 run function att2:dialogs/sidequest/sq47/player_4
execute if score Neth1 TIMER matches 800 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3010"},hover_event:{action:show_text,value:"..."}}
execute if score Neth1 TIMER matches 900 run function att2:dialogs/sidequest/sq47/namrin_4
execute if score Neth1 TIMER matches 900 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3007"},hover_event:{action:show_text,value:"..."}}
execute if score Neth1 TIMER matches 1000 run function att2:dialogs/sidequest/sq47/player_5
execute if score Neth1 TIMER matches 1000 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2998"},hover_event:{action:show_text,value:"..."}}
