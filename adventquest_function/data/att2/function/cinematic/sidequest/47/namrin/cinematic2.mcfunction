...
execute if score Neth1 TIMER matches 170 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Neth1 TIMER matches ..398 run scoreboard players set Neth1 TIMER 399"},hover_event:{action:show_text,value:"..."}}
execute if score Neth1 TIMER matches 400 run function att2:dialogs/sidequest/sq47/namrin_7
execute if score Neth1 TIMER matches 400 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Neth1 TIMER matches ..498 run scoreboard players set Neth1 TIMER 499"},hover_event:{action:show_text,value:"..."}}
execute if score Neth1 TIMER matches 500 run function att2:dialogs/sidequest/sq47/namrin_8
execute if score Neth1 TIMER matches 500 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Neth1 TIMER matches ..748 run scoreboard players set Neth1 TIMER 749"},hover_event:{action:show_text,value:"..."}}
execute if score Neth1 TIMER matches 750 run function att2:dialogs/sidequest/sq47/namrin_9
execute if score Neth1 TIMER matches 750 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/execute if score Neth1 TIMER matches ..848 run scoreboard players set Neth1 TIMER 849"},hover_event:{action:show_text,value:"..."}}
