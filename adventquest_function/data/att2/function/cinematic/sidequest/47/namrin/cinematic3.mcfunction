...
execute if score Neth1 TIMER matches 20 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2993"},hover_event:{action:show_text,value:"..."}}
execute if score Neth1 TIMER matches 150 run function att2:dialogs/sidequest/sq47/namrin_11
execute if score Neth1 TIMER matches 150 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2995"},hover_event:{action:show_text,value:"..."}}
execute if score Neth1 TIMER matches 300 run function att2:dialogs/sidequest/sq47/player_7
execute if score Neth1 TIMER matches 300 at 00000000-0000-006a-0000-00000000006a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3003"},hover_event:{action:show_text,value:"..."}}
