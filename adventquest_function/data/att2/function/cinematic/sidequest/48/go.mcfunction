...
execute if score carry_tear SQ48 matches 0 as @p[x=6630,y=81,z=6811,dx=3,dy=10,dz=3,gamemode=adventure] unless entity @s[nbt={Inventory:[{components:{"minecraft:custom_name":{translate:'item.quest.celestial_tear.name'}}}]}] run function att2:cinematic/sidequest/48/ghost/fly_whithout_tear
