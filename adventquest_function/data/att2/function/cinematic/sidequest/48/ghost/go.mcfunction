...
execute if score tic TIMECOUNTER matches 1 unless entity @e[type=minecraft:ghast,tag=Ghost] positioned 7668.3 190 7189.2 run function att2:summon/reg_4/ghost
execute if entity @e[type=minecraft:ghast,tag=Ghost,scores={ENEMYABHEALTH=..0},x=7668,y=190,z=7189,distance=..50] run function att2:cinematic/sidequest/48/ghost/drop_tear
