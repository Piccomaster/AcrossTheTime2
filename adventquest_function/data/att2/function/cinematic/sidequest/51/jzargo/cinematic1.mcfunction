...
execute if score Real1 TIMER matches 100 at 00000000-0000-089a-0000-00000000089a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3017"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real1 TIMER matches 700 at 00000000-0000-089a-0000-00000000089a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3038"},hover_event:{action:show_text,value:"..."}}
execute if score Real1 TIMER matches 775 run function att2:dialogs/sidequest/sq51/jzargo_4
execute if score Real1 TIMER matches 775 at 00000000-0000-089a-0000-00000000089a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3021"},hover_event:{action:show_text,value:"..."}}
execute if score Real1 TIMER matches 850 run function att2:dialogs/sidequest/sq51/player_4
execute if score Real1 TIMER matches 850 at 00000000-0000-089a-0000-00000000089a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3022"},hover_event:{action:show_text,value:"..."}}
execute if score Real1 TIMER matches 900 run function att2:dialogs/sidequest/sq51/jzargo_5
execute if score Real1 TIMER matches 900 at 00000000-0000-089a-0000-00000000089a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3032"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real1 TIMER matches 1205 at 00000000-0000-089a-0000-00000000089a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3035"},hover_event:{action:show_text,value:"..."}}
execute if score Real1 TIMER matches 1300 run function att2:dialogs/sidequest/sq51/player_6
execute if score Real1 TIMER matches 1300 at 00000000-0000-089a-0000-00000000089a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3039"},hover_event:{action:show_text,value:"..."}}
execute if score Real1 TIMER matches 1375 run function att2:dialogs/sidequest/sq51/jzargo_7
execute if score Real1 TIMER matches 1375 at 00000000-0000-089a-0000-00000000089a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3040"},hover_event:{action:show_text,value:"..."}}
execute if score Real1 TIMER matches 1450 run function att2:dialogs/sidequest/sq51/player_7
execute if score Real1 TIMER matches 1450 at 00000000-0000-089a-0000-00000000089a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3041"},hover_event:{action:show_text,value:"..."}}
