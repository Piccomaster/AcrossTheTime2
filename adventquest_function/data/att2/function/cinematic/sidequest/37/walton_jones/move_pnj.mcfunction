...
data modify entity 00000000-0000-134a-0000-00000000134a data.rotation set value [0,0]
execute in overworld as 00000000-0000-134a-0000-00000000134a at @s run tp @s -4472 72 -4986 0 ~
