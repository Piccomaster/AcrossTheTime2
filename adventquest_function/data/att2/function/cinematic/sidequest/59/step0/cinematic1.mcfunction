...
execute if score cinematic_timer SQ59 matches 5 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3058"},hover_event:{action:show_text,value:"..."}}
...
execute if score cinematic_timer SQ59 matches 50 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3059"},hover_event:{action:show_text,value:"..."}}
execute if score cinematic_timer SQ59 matches 150 run function att2:dialogs/sidequest/sq59/king_missive_1
execute if score cinematic_timer SQ59 matches 150 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3060"},hover_event:{action:show_text,value:"..."}}
execute if score cinematic_timer SQ59 matches 500 run function att2:dialogs/sidequest/sq59/player_2
execute if score cinematic_timer SQ59 matches 500 run tellraw @a {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 3061"},hover_event:{action:show_text,value:"..."}}
