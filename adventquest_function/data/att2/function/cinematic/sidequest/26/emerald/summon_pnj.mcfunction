...
data modify entity 00000000-0000-005a-0000-00000000005a data.rotation set value [180,0]
execute as 00000000-0000-005a-0000-00000000005a at @s run tp @s -3790 70 -5876 180 ~
