...
execute if score Real2 TIMER matches 70 at 00000000-0000-094a-0000-00000000094a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2961"},hover_event:{action:show_text,value:"..."}}
execute if score Real2 TIMER matches 200 run function att2:dialogs/sidequest/sq30/jaris_1
execute if score Real2 TIMER matches 200 at 00000000-0000-094a-0000-00000000094a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2986"},hover_event:{action:show_text,value:"..."}}
execute if score Real2 TIMER matches 450 run function att2:dialogs/sidequest/sq30/ithil_2
execute if score Real2 TIMER matches 450 at 00000000-0000-094a-0000-00000000094a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2987"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real2 TIMER matches 700 at 00000000-0000-094a-0000-00000000094a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2988"},hover_event:{action:show_text,value:"..."}}
execute if score Real2 TIMER matches 800 run function att2:dialogs/sidequest/sq30/ithil_3
execute if score Real2 TIMER matches 800 at 00000000-0000-094a-0000-00000000094a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2989"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real2 TIMER matches 1000 at 00000000-0000-094a-0000-00000000094a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2990"},hover_event:{action:show_text,value:"..."}}
...
execute if score Real2 TIMER matches 1250 at 00000000-0000-094a-0000-00000000094a as @a[distance=..100] run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 2991"},hover_event:{action:show_text,value:"..."}}
