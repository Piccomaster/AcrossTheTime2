...
execute if score Real2 TIMER matches 1..290 run function att2:gameplay/speceffect/disincarnate/keep/real2
...
execute if score Real2 TIMER matches 200 positioned -4375 60 -5054 run particle minecraft:item{item:"minecraft:black_wool"} ~ ~ ~ 0.01 0.01 0.01 1 250 normal
execute if score Real2 TIMER matches 200..289 run tp @n[type=text_display,tag=Real2] -4380 61 -5052 -100 50
execute if score Real2 TIMER matches 225 at @a[gamemode=spectator,scores={Performance=2}] run function att2:sound/dahal/imminent
...
execute if score Real2 TIMER matches 250 at @a[gamemode=spectator,scores={Performance=2}] run function att2:sound/misc/fleshpierced
...
execute if score Real2 TIMER matches 290 as @a[x=-4375,y=60,z=-5054,distance=..50,gamemode=spectator] run function att2:gameplay/speceffect/disincarnate/end/real2
