...
data merge entity 00000000-0000-065a-0000-00000000065a {Tags:["LVL0","CLASS8","Reg1","Undead"],anger_end_time:1000000,AbsorptionAmount:0,Invulnerable:0b,NoAI:0b,equipment:{mainhand:{id:"minecraft:iron_shovel",count:1},offhand:{}}}
