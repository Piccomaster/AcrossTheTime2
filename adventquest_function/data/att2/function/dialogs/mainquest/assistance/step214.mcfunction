...
tellraw @s[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"我终于有了第二个Néleptron。希望Skaolon不要再得寸进尺了...让我们想办法离开这里，并回到Ouranos宫殿的门口。","color":"aqua"}]}