...
tellraw @s[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"我终于拿到了第二块空间宝石。现在我得把它放在Ryliath入口处水池的祭坛上—就像放第一块时那样。","color":"aqua"}]}