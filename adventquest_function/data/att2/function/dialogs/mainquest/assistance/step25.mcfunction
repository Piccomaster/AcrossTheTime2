...
tellraw @s[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"打开中间这扇大门的方法已经很明显了。这里有三个金色的锁，对应着三把大钥匙—我已经有了一把，还得再找两把...它们一定就藏在外面的沼泽里！","color":"aqua"}]}