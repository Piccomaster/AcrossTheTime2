...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[Je ne sais pas, je ne lui ai pas demandé. Mais écoutez, je n'ai pas de temps à perdre à négocier avec vous. Donnez-moi ce sceau, avant que je sévisse ! -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-050a-0000-00000000050a if entity @s[distance=..7] if score phoebius_PNJ DIALOG matches 6 run function att2:dialogs/mainquest/act_3/pnj_phoebius/dialog_11"},"hover_event":{"action":"show_text","value":"Cliquez ici - réponse 1"}}]}
...
tellraw @s[scores={LANGUAGE=4}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[몰라, 물어보지 않았어. 하지만 들어, 협상할 시간 없어. 그 인장 내놔, 그렇지 않으면 내가 가만히 있지 않을 거야! -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-050a-0000-00000000050a if entity @s[distance=..7] if score phoebius_PNJ DIALOG matches 6 run function att2:dialogs/mainquest/act_3/pnj_phoebius/dialog_11"},"hover_event":{"action":"show_text","value":"여기를 클릭 - 답변 1"}}]}

#ARABIC LANGUAGE

tellraw @s[scores={LANGUAGE=5}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[لا أعرف، لم أسأله. لكن استمع، ليس لدي وقت أضيعه في التفاوض معك. أعطني تلك الختمة قبل أن أتخذ إجراءات صارمة! -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-050a-0000-00000000050a if entity @s[distance=..7] if score phoebius_PNJ DIALOG matches 6 run function att2:dialogs/mainquest/act_3/pnj_phoebius/dialog_11"},"hover_event":{"action":"show_text","value":"اضغط هنا - الإجابة 1"}}]}
...
tellraw @s[scores={LANGUAGE=8}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[Ich weiß nicht, ich habe ihn nicht gefragt. Aber hör zu, ich habe keine Zeit, mit dir zu verhandeln. Gib mir das Siegel, bevor ich hart durchgreife! -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-050a-0000-00000000050a if entity @s[distance=..7] if score phoebius_PNJ DIALOG matches 6 run function att2:dialogs/mainquest/act_3/pnj_phoebius/dialog_11"},"hover_event":{"action":"show_text","value":"Klicken Sie hier - Antwort 1"}}]}
...
tellraw @s[scores={LANGUAGE=10}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[Não sei, não perguntei a ele. Mas escuta, não tenho tempo a perder negociando com você. Me dá esse selo, antes que eu fique sério! -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-050a-0000-00000000050a if entity @s[distance=..7] if score phoebius_PNJ DIALOG matches 6 run function att2:dialogs/mainquest/act_3/pnj_phoebius/dialog_11"},"hover_event":{"action":"show_text","value":"Clique aqui - resposta 1"}}]}

#Simplified Chinese LANGUAGE
tellraw @s[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[我不知道也没问他。但给我听好了，我没时间在你这浪费口舌，在我动粗之前把那玩意交出来！-->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-050a-0000-00000000050a if entity @s[distance=..7] if score phoebius_PNJ DIALOG matches 6 run function att2:dialogs/mainquest/act_3/pnj_phoebius/dialog_11"},"hover_event":{"action":"show_text","value":"点击这里 - 回答 1"}}]}