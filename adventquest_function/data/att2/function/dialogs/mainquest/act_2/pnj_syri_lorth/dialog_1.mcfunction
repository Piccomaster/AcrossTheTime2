...
execute if score Mainquest SIDEQUEST matches 31 run tellraw @s {text:"[-->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 642"},hover_event:{action:show_text,value:"..."}}
