...
tellraw @a[scores={LANGUAGE=0}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"Bon je vous suis, mais ne perdons pas de temps...",color:"aqua"}]}
...
tellraw @a[scores={LANGUAGE=1}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"Ok I follow you, but let's not lose time...",color:"aqua"}]}
...
tellraw @a[scores={LANGUAGE=2}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"好吧， 我跟著你， 但我們不要浪費時間...",color:"aqua"}]}
...
tellraw @a[scores={LANGUAGE=3}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"わかりました、ついてきますが、時間を無駄にしませんように...",color:"aqua"}]}
...
tellraw @a[scores={LANGUAGE=4}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"알겠습니다, 따라갑니다만, 시간을 낭비하지 마십시오...",color:"aqua"}]}
...
tellraw @a[scores={LANGUAGE=5}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"حسنًا، أنا أتبعك، لكن لا نضيع الوقت...",color:"aqua"}]}
...
tellraw @a[scores={LANGUAGE=6}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"Хорошо, я за тобой, но не теряем времени...",color:"aqua"}]}
...
tellraw @a[scores={LANGUAGE=7}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"Está bien, te sigo, pero no perdamos tiempo...",color:"aqua"}]}
...
tellraw @a[scores={LANGUAGE=8}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"In Ordnung, ich folge dir, aber lassen wir keine Zeit verlieren...",color:"aqua"}]}
...
tellraw @a[scores={LANGUAGE=9}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"ठीक है, मैं आपका पीछा करता हूँ, लेकिन हम समय बर्बाद नहीं करेंगे...",color:"aqua"}]}
