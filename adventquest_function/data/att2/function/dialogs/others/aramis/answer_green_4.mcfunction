...
tellraw @a[scores={LANGUAGE=1}] {text:" °-° Aramis : ",color:"green",extra:[{text:"Know that this house also gives you access to a grinder that can turn your runes into powder. If you wish, I can use this powder to enhance some of your Dahäl spells.",color:"dark_aqua",extra:[{text:" [See the goods -->]",color:"yellow",click_event:{action:run_command,command:"/trigger ScoreTrigger set 727"},hover_event:{action:show_text,value:"Click here to see what Aramis is selling."}}]}]}
...
tellraw @a[scores={LANGUAGE=2}] {text:" °-° Aramis ：",color:"green",extra:[{text:"請知道，這棟房子讓你能夠使用一台粉碎機，將你的符文磨成粉末。如果你願意，我可以利用這些粉末來強化你的一些 Dahäl 咒語。",color:"dark_aqua",extra:[{text:" [查看商品 -->]",color:"yellow",click_event:{action:run_command,command:"/trigger ScoreTrigger set 727"},hover_event:{action:show_text,value:"點擊這裡查看 Aramis 販售的物品。"}}]}]}
...
tellraw @a[scores={LANGUAGE=3}] {text:" °-° Aramis ：",color:"green",extra:[{text:"この家では、ルーンを粉末にできる粉砕機へアクセスできます。その粉を使えば、私があなたの Dahäl の呪文をいくつか強化できますよ。",color:"dark_aqua",extra:[{text:" [商品を見る -->]",color:"yellow",click_event:{action:run_command,command:"/trigger ScoreTrigger set 727"},hover_event:{action:show_text,value:"ここをクリックすると、Aramis の販売品が見られます。"}}]}]}
...
tellraw @a[scores={LANGUAGE=11}] {text:" °-° Aramis ：",color:"green",extra:[{text:"还有，那栋房子有个符文粉碎机可以供你使用，你可以用符文粉末在我这里强化一些Dahal法术",color:"dark_aqua",extra:[{text:" [查看商品 -->]",color:"yellow",click_event:{action:run_command,command:"/trigger ScoreTrigger set 727"},hover_event:{action:show_text,value:"点击这里查看 Aramis 的法术强化列表"}}]}]}