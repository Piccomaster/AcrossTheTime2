...
tellraw @a[scores={LANGUAGE=0}] {text:" °-° Aramis : ",color:"green",extra:[{text:"Sache que cette maison t'offres également l'accès vers un broyeur permettant de réduire en poudre vos runes. Cette poudre si vous le souhaitez je peux m'en servir pour perfectionner certain de vos sortilèges de Dahäl.",color:"dark_aqua",extra:[{text:" [Voir la marchandise -->]",color:"yellow",click_event:{action:run_command,command:"/function att2:gameplay/shop/seller/aramis_shop_opening"},hover_event:{action:show_text,value:"Cliquez ici pour voir ce que vend Aramis."}}]}]}
...
tellraw @a[scores={LANGUAGE=1}] {text:" °-° Aramis : ",color:"green",extra:[{text:"Know that this house also gives you access to a grinder that can turn your runes into powder. If you wish, I can use this powder to enhance some of your Dahäl spells.",color:"dark_aqua",extra:[{text:" [See the goods -->]",color:"yellow",click_event:{action:run_command,command:"/function att2:gameplay/shop/seller/aramis_shop_opening"},hover_event:{action:show_text,value:"Click here to see what Aramis is selling."}}]}]}
...
tellraw @a[scores={LANGUAGE=2}] {text:" °-° Aramis ：",color:"green",extra:[{text:"請知道，這棟房子讓你能夠使用一台粉碎機，將你的符文磨成粉末。如果你願意，我可以利用這些粉末來強化你的一些 Dahäl 咒語。",color:"dark_aqua",extra:[{text:" [查看商品 -->]",color:"yellow",click_event:{action:run_command,command:"/function att2:gameplay/shop/seller/aramis_shop_opening"},hover_event:{action:show_text,value:"點擊這裡查看 Aramis 販售的物品。"}}]}]}
...
tellraw @a[scores={LANGUAGE=3}] {text:" °-° Aramis ：",color:"green",extra:[{text:"この家では、ルーンを粉末にできる粉砕機へアクセスできます。その粉を使えば、私があなたの Dahäl の呪文をいくつか強化できますよ。",color:"dark_aqua",extra:[{text:" [商品を見る -->]",color:"yellow",click_event:{action:run_command,command:"/function att2:gameplay/shop/seller/aramis_shop_opening"},hover_event:{action:show_text,value:"ここをクリックすると、Aramis の販売品が見られます。"}}]}]}
...
tellraw @a[scores={LANGUAGE=4}] {text:" °-° Aramis : ",color:"green",extra:[{text:"이 집은 룬을 가루로 만드는 분쇄기로 가는 길을 열어줍니다. 원하신다면, 저는 그 가루를 사용해 당신의 일부 Dahäl 주문을 향상시켜 드릴 수 있습니다.",color:"dark_aqua",extra:[{text:" [상품 보기 -->]",color:"yellow",click_event:{action:run_command,command:"/function att2:gameplay/shop/seller/aramis_shop_opening"},hover_event:{action:show_text,value:"여기를 클릭하면 Aramis 가 판매하는 물건을 볼 수 있습니다."}}]}]}
...
tellraw @a[scores={LANGUAGE=5}] {text:" °-° Aramis : ",color:"green",extra:[{text:"اعلم أن هذا المنزل يمنحك الوصول إلى آلة طحن لتحويل الرونات إلى مسحوق. إذا رغبت، يمكنني استخدام هذا المسحوق لتحسين بعض تعويذاتك من Dahäl.",color:"dark_aqua",extra:[{text:" [عرض البضائع -->]",color:"yellow",click_event:{action:run_command,command:"/function att2:gameplay/shop/seller/aramis_shop_opening"},hover_event:{action:show_text,value:"انقر هنا لعرض ما يبيعه Aramis."}}]}]}
...
tellraw @a[scores={LANGUAGE=7}] {text:" °-° Aramis : ",color:"green",extra:[{text:"Debes saber que esta casa te da acceso a una trituradora que convierte tus runas en polvo. Si lo deseas, puedo usar ese polvo para mejorar algunos de tus hechizos de Dahäl.",color:"dark_aqua",extra:[{text:" [Ver mercancía -->]",color:"yellow",click_event:{action:run_command,command:"/function att2:gameplay/shop/seller/aramis_shop_opening"},hover_event:{action:show_text,value:"Haz clic aquí para ver lo que vende Aramis."}}]}]}
...
tellraw @a[scores={LANGUAGE=8}] {text:" °-° Aramis : ",color:"green",extra:[{text:"Wisse, dass dir dieses Haus Zugang zu einer Mühle gibt, die deine Runen zu Pulver zermahlt. Wenn du willst, kann ich dieses Pulver nutzen, um einige deiner Dahäl-Zauber zu verbessern.",color:"dark_aqua",extra:[{text:" [Waren ansehen -->]",color:"yellow",click_event:{action:run_command,command:"/function att2:gameplay/shop/seller/aramis_shop_opening"},hover_event:{action:show_text,value:"Klicke hier, um zu sehen, was Aramis verkauft."}}]}]}
...
tellraw @a[scores={LANGUAGE=9}] {text:" °-° Aramis : ",color:"green",extra:[{text:"जान लो कि यह घर तुम्हें एक ग्राइंडर तक पहुँच प्रदान करता है, जो तुम्हारी रून को पाउडर में बदल देता है। यदि तुम चाहो, तो मैं इस पाउडर का उपयोग तुम्हारे कुछ Dahäl जादुओं को बेहतर बनाने के लिए कर सकता हूँ।",color:"dark_aqua",extra:[{text:" [सामान देखें -->]",color:"yellow",click_event:{action:run_command,command:"/function att2:gameplay/shop/seller/aramis_shop_opening"},hover_event:{action:show_text,value:"यह देखने के लिए यहाँ क्लिक करें कि Aramis क्या बेच रहा है।"}}]}]}
