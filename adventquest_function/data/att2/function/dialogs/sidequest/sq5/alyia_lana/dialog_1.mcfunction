...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"[Faites voir ce que vous avez. -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/alyia_lana_shop_opening"},"hover_event":{"action":"show_text","value":"Cliquez ici pour voir la marchandise d'Alyia Lana."}}]}
...
tellraw @s[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"[讓我看看你有什麽。-->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/alyia_lana_shop_opening"},"hover_event":{"action":"show_text","value":"單擊此處查看 Alyia 的銷售情況。"}}]}
...
tellraw @s[scores={LANGUAGE=3}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"[見せてください、何を持っているのか。 -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/alyia_lana_shop_opening"},"hover_event":{"action":"show_text","value":"アリヤの販売品を見るにはここをクリック"}}]}

#KOREAN LANGUAGE

tellraw @s[scores={LANGUAGE=4}] {"text":" °-° 알리야 라나 : ","color":"green","extra":[{"text":"안녕하세요, 파이 한 조각 드셔보시겠어요? 아니면 다른 것도 있습니다...","color":"dark_aqua"}]}

tellraw @s[scores={LANGUAGE=4}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"[보여주세요, 무엇을 가지고 있는지. -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/alyia_lana_shop_opening"},"hover_event":{"action":"show_text","value":"여기를 클릭하여 알리야가 판매하는 상품을 확인하세요."}}]}
...
tellraw @s[scores={LANGUAGE=5}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"[أرني ماذا لديك. -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/alyia_lana_shop_opening"},"hover_event":{"action":"show_text","value":"انقر هنا لرؤية ما تبيعه ألييا."}}]}
...
tellraw @s[scores={LANGUAGE=6}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"[Покажи, что у тебя есть. -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/alyia_lana_shop_opening"},"hover_event":{"action":"show_text","value":"Нажмите здесь, чтобы посмотреть, что продает Алия."}}]}
...
tellraw @s[scores={LANGUAGE=7}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"[Muéstrame lo que tienes. -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/alyia_lana_shop_opening"},"hover_event":{"action":"show_text","value":"Haz clic aquí para ver lo que Alyia está vendiendo."}}]}
...
tellraw @s[scores={LANGUAGE=8}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"[Zeig mir, was du hast. -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/alyia_lana_shop_opening"},"hover_event":{"action":"show_text","value":"Klicke hier, um zu sehen, was Alyia verkauft."}}]}
...
tellraw @s[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"[让我看看你有什么。-->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/alyia_lana_shop_opening"},"hover_event":{"action":"show_text","value":"单击此处查看 Alyia 的销售情况。"}}]}