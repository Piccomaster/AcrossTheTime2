...
tellraw @s[scores={LANGUAGE=0}] {"text":" °-° Hélèna Meli : ","color":"green","extra":[{"text":"Mais j'ai récemment attrapé quelques sangliers, je ne suis pas sûre qu'ils puissent te servir de monture, mais tu peux peut-être essayer","color":"dark_aqua","extra":[{"text":" [Voir les sangliers en vente -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/helena_meli_shop_opening"},"hover_event":{"action":"show_text","value":"Cliquez ici pour voir les sangliers vendus par Hélèna."}}]}]}
...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Hélèna Meli : ","color":"green","extra":[{"text":"不過我最近抓到了一些小野豬，我不確定牠們是否可以為你代步，也許你可以試一試","color":"dark_aqua","extra":[{"text":" [查看售賣的野豬 -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/helena_meli_shop_opening"},"hover_event":{"action":"show_text","value":"點擊此處查看Hélèna售賣的野豬。"}}]}]}
...
tellraw @s[scores={LANGUAGE=3}] {"text":" °-° Hélèna Meli : ","color":"green","extra":[{"text":"でも最近小さいイノシシを捕まえたんだけど、乗れるかどうかわからないけど、試してみてもいいかも","color":"dark_aqua","extra":[{"text":" [販売中のイノシシを見る -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/helena_meli_shop_opening"},"hover_event":{"action":"show_text","value":"Hélènaが販売しているイノシシを見るにはここをクリック。"}}]}]}
...
tellraw @s[scores={LANGUAGE=4}] {"text":" °-° Hélèna Meli : ","color":"green","extra":[{"text":"하지만 최근에 작은 멧돼지를 잡았는데, 당신의 탈것으로 쓸 수 있을지 모르겠어요. 한번 시도해볼 수 있을 거예요","color":"dark_aqua","extra":[{"text":" [판매 중인 멧돼지 보기 -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/helena_meli_shop_opening"},"hover_event":{"action":"show_text","value":"Hélèna가 판매하는 멧돼지를 보려면 여기를 클릭하세요."}}]}]}
...
tellraw @s[scores={LANGUAGE=7}] {"text":" °-° Hélèna Meli : ","color":"green","extra":[{"text":"Pero recientemente atrapé algunos jabalíes, no estoy segura de si pueden servirte como montura, pero quizás puedas probarlos","color":"dark_aqua","extra":[{"text":" [Ver jabalíes en venta -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/helena_meli_shop_opening"},"hover_event":{"action":"show_text","value":"Haz clic aquí para ver los jabalíes que vende Hélèna."}}]}]}
...
tellraw @s[scores={LANGUAGE=8}] {"text":" °-° Hélèna Meli : ","color":"green","extra":[{"text":"Aber ich habe kürzlich einige Wildschweine gefangen, ich bin nicht sicher, ob sie als Reittier dienen können, aber vielleicht kannst du es versuchen","color":"dark_aqua","extra":[{"text":" [Wildschweine zum Verkauf ansehen -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/helena_meli_shop_opening"},"hover_event":{"action":"show_text","value":"Klicke hier, um die von Hélèna verkauften Wildschweine zu sehen."}}]}]}
...
tellraw @s[scores={LANGUAGE=9}] {"text":" °-° Hélèna Meli : ","color":"green","extra":[{"text":"लेकिन हाल ही में कुछ छोटे जंगली सूअर पकड़े गए हैं, मुझे यकीन नहीं है कि वे तुम्हारे लिए परिवहन का काम कर सकते हैं, शायद तुम कोशिश कर सकते हो।","color":"dark_aqua","extra":[{"text":" [सामान देखें -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/helena_meli_shop_opening"},"hover_event":{"action":"show_text","value":"यहां क्लिक करें और देखें कि हेलेना क्या बेच रही है।"}}]}]}
#PORTUGUESE LANGUAGE
...
tellraw @s[scores={LANGUAGE=11}] {"text":" °-° Hélèna Meli : ","color":"green","extra":[{"text":"不过我最近抓到了一些小野猪，我不确定它们是否可以为你代步，也许你可以试一试","color":"dark_aqua","extra":[{"text":" [查看售卖的野猪 -->]","color":"yellow","click_event":{"action":"run_command","command":"/function att2:gameplay/shop/seller/helena_meli_shop_opening"},"hover_event":{"action":"show_text","value":"点击此处查看Hélèna售卖的野猪。"}}]}]}
