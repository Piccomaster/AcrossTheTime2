...
tellraw @s[scores={LANGUAGE=4}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[범인은 근처에 틀림없습니다. 지나가는 파괴 행위처럼 보이지 않아요. 도와드리겠습니다. -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-027a-0000-00000000027a if entity @s[distance=..7] if score helena_meli_PNJ DIALOG matches 1..3 run function att2:cinematic/sidequest/19/helena_meli/answer_1_1"},"hover_event":{"action":"show_text","value":"여기를 클릭 - 답변 1"}}]}

#ARABIC LANGUAGE

tellraw @s[scores={LANGUAGE=5}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[يجب أن يكون الجاني قريبًا، لا يبدو أن هذه عمل تخريبي عابر. سأساعدك. -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-027a-0000-00000000027a if entity @s[distance=..7] if score helena_meli_PNJ DIALOG matches 1..3 run function att2:cinematic/sidequest/19/helena_meli/answer_1_1"},"hover_event":{"action":"show_text","value":"انقر هنا - الإجابة 1"}}]}

#RUSSIAN LANGUAGE

tellraw @s[scores={LANGUAGE=6}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[Виновник должен быть поблизости, это не похоже на случайный акт вандализма. Я помогу вам. -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-027a-0000-00000000027a if entity @s[distance=..7] if score helena_meli_PNJ DIALOG matches 1..3 run function att2:cinematic/sidequest/19/helena_meli/answer_1_1"},"hover_event":{"action":"show_text","value":"Нажмите здесь - ответ 1"}}]}
...
tellraw @s[scores={LANGUAGE=8}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[Der Täter muss in der Nähe sein, das sieht nicht nach einem zufälligen Vandalismusakt aus. Ich werde Ihnen helfen. -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-027a-0000-00000000027a if entity @s[distance=..7] if score helena_meli_PNJ DIALOG matches 1..3 run function att2:cinematic/sidequest/19/helena_meli/answer_1_1"},"hover_event":{"action":"show_text","value":"Hier klicken - Antwort 1"}}]}
...
#Simplified Chinese
tellraw @s[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[罪魁祸首肯定就在附近，这不像是一次偶然的投毒。我会帮你找出凶手的。-->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-027a-0000-00000000027a if entity @s[distance=..7] if score helena_meli_PNJ DIALOG matches 1..3 run function att2:cinematic/sidequest/19/helena_meli/answer_1_1"},"hover_event":{"action":"show_text","value":"点击这里 - 回答 1"}}]}