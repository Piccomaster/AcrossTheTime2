...
tellraw @s[scores={LANGUAGE=0}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"En effet, j'ai besoin que ta cargaison arrive jusqu'à Eolorion.",color:"aqua"}]}
...
tellraw @s[scores={LANGUAGE=1}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"Indeed, I need your cargo to arrive at Eolorion.",color:"aqua"}]}
...
tellraw @s[scores={LANGUAGE=2}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"確實， 我需要你的貨物才能到達 Eolorion。",color:"aqua"}]}
...
tellraw @s[scores={LANGUAGE=3}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"確かに、あなたの貨物をEolorionに届ける必要があります。",color:"aqua"}]}
...
tellraw @s[scores={LANGUAGE=4}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"확실히, 당신의 화물이 Eolorion에 도착해야 합니다.",color:"aqua"}]}
...
tellraw @s[scores={LANGUAGE=5}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"بالفعل، أحتاج إلى وصول حمولتك إلى Eolorion.",color:"aqua"}]}
...
tellraw @s[scores={LANGUAGE=6}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"Действительно, мне нужно, чтобы ваш груз прибыл в Eolorion.",color:"aqua"}]}
...
tellraw @s[scores={LANGUAGE=7}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"De hecho, necesito que tu carga llegue a Eolorion.",color:"aqua"}]}
...
tellraw @s[scores={LANGUAGE=8}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"Tatsächlich muss Ihre Fracht in Eolorion ankommen.",color:"aqua"}]}
...
tellraw @s[scores={LANGUAGE=9}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"वास्तव में, मुझे आपकी खेप को Eolorion तक पहुंचाना है।",color:"aqua"}]}
...
tellraw @s[scores={LANGUAGE=10}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",extra:[{text:" : "},{text:"De fato, preciso que sua carga chegue a Eolorion.",color:"aqua"}]}
