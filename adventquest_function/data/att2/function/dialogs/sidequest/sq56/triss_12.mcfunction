...
#Simplified Chinese
tellraw @a[scores={LANGUAGE=11}] {"text":" °-° Triss : ","color":"green","extra":[{"text":"我感受到了你内心的仇恨，","color":"aqua"},{"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"aqua"},{"text":"，我并不能对此感到怨恨。但你还有别的选择，你不一定要杀他...","color":"dark_aqua"}]}