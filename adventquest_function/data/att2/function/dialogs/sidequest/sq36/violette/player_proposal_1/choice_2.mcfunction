...
#Simplified Chinese
tellraw @s[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[我会帮你，但前提是你得保证给我一些Chronotons作为报酬... -->]","color":"gray","click_event":{"action":"run_command","command":"/execute at 00000000-0000-130a-0000-00000000130a if entity @s[distance=..7] if score violette_PNJ DIALOG matches 2 run function att2:cinematic/sidequest/36/violette/answer_2_1"},"hover_event":{"action":"show_text","value":"点击这里 - 回答 2"}}]}