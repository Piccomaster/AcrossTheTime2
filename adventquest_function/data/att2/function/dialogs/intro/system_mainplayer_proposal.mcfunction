...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@s",extra:[{text:" : "},{text:"[JE SUIS LE HEROS -->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 627"},hover_event:{action:show_text,value:"Cliquez ici pour vous définir en tant que personnage principal."}}]}
...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@s",extra:[{text:" : "},{text:"[I AM THE HERO -->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 627"},hover_event:{action:show_text,value:"Click here to define yourself as the main character."}}]}
...
tellraw @s[scores={LANGUAGE=2}] {"selector":"@s",extra:[{text:" : "},{text:"[我是主人公 -->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 627"},hover_event:{action:show_text,value:"點擊此處以確認選擇該玩家成爲本次冒險的主角"}}]}
...
tellraw @s[scores={LANGUAGE=3}] {"selector":"@s",extra:[{text:" : "},{text:"[私が主役です -->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 627"},hover_event:{action:show_text,value:"ここをクリックして、自分を主人公に定義してください。"}}]}
...
tellraw @s[scores={LANGUAGE=4}] {"selector":"@s",extra:[{text:" : "},{text:"[나는 주인공입니다 -->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 627"},hover_event:{action:show_text,value:"여기를 클릭하여 자신을 주요 캐릭터로 정의하세요."}}]}
...
tellraw @s[scores={LANGUAGE=5}] {"selector":"@s",extra:[{text:" : "},{text:"[أنا البطل -->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 627"},hover_event:{action:show_text,value:"انقر هنا لتحديد نفسك كالشخصية الرئيسية."}}]}
...
tellraw @s[scores={LANGUAGE=6}] {"selector":"@s",extra:[{text:" : "},{text:"[Я герой -->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 627"},hover_event:{action:show_text,value:"Нажмите здесь, чтобы определить себя основным персонажем."}}]}
...
tellraw @s[scores={LANGUAGE=7}] {"selector":"@s",extra:[{text:" : "},{text:"[YO SOY EL HÉROE -->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 627"},hover_event:{action:show_text,value:"Haz clic aquí para definirte como el personaje principal."}}]}
...
tellraw @s[scores={LANGUAGE=8}] {"selector":"@s",extra:[{text:" : "},{text:"[ICH BIN DER HELD -->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 627"},hover_event:{action:show_text,value:"Klicke hier, um dich als Hauptcharakter zu definieren."}}]}
...
tellraw @s[scores={LANGUAGE=9}] {"selector":"@s",extra:[{text:" : "},{text:"[मैं हीरो हूँ -->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 627"},hover_event:{action:show_text,value:"मुख्य पात्र के रूप में खुद को परिभाषित करने के लिए यहाँ क्लिक करें।"}}]}
...
tellraw @s[scores={LANGUAGE=10}] {"selector":"@s",extra:[{text:" : "},{text:"[EU SOU O HERÓI -->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 627"},hover_event:{action:show_text,value:"Clique aqui para se definir como o personagem principal."}}]}
...
tellraw @s[scores={LANGUAGE=11}] {"selector":"@s",extra:[{text:" : "},{text:"[我是主人公 -->]",color:"green",click_event:{action:run_command,command:"/trigger ScoreTrigger set 627"},hover_event:{action:show_text,value:"点击此处以确认选择该玩家成为本次冒险的主角"}}]}