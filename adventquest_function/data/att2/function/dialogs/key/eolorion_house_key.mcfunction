...
tellraw @a[scores={LANGUAGE=2}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",,extra:[{text:" : "},{text:"我需要一個 ",color:"aqua",extra:[{text:"<Little Key>",color:"gray",hover_event:{action:"show_item","id":"minecraft:brick","count":1,"components":{custom_data:{EquipmentType:'misc',Rarity:'que'},custom_name:{translate:'item.quest.eolorion_house_key.name'},lore:[{translate:'item.quest.lore'}]}},extra:[{text:" 要打開這扇門！ ",color:"aqua"}]}]}]}
...
tellraw @a[scores={LANGUAGE=4}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",,extra:[{text:" : "},{text:"나는 ",color:"aqua",extra:[{text:"<Little Key>",color:"gray",hover_event:{action:"show_item","id":"minecraft:brick","count":1,"components":{custom_data:{EquipmentType:'misc',Rarity:'que'},custom_name:{translate:'item.quest.eolorion_house_key.name'},lore:[{translate:'item.quest.lore'}]}},extra:[{text:" 이 필요합니다!",color:"aqua"}]}]}]}
...
tellraw @a[scores={LANGUAGE=6}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",,extra:[{text:" : "},{text:"Мне нужен ",color:"aqua",extra:[{text:"<Little Key>",color:"gray",hover_event:{action:"show_item","id":"minecraft:brick","count":1,"components":{custom_data:{EquipmentType:'misc',Rarity:'que'},custom_name:{translate:'item.quest.eolorion_house_key.name'},lore:[{translate:'item.quest.lore'}]}},extra:[{text:" чтобы открыть эту дверь!",color:"aqua"}]}]}]}
...
tellraw @a[scores={LANGUAGE=9}] {nbt:"set",storage:"att2:id","interpret":true,color:"dark_red",,extra:[{text:" : "},{text:"मुझे ",color:"aqua",extra:[{text:"<Little Key>",color:"gray",hover_event:{action:"show_item","id":"minecraft:brick","count":1,"components":{custom_data:{EquipmentType:'misc',Rarity:'que'},custom_name:{translate:'item.quest.eolorion_house_key.name'},lore:[{translate:'item.quest.lore'}]}},extra:[{text:" चाहिए इस दरवाजे को खोलने के लिए!",color:"aqua"}]}]}]}
