...
tellraw @s[scores={LANGUAGE=..10}] {text:"⚙ ",color:"dark_red",extra:[{text:"Eol : ",color:"gray"},{score:{name:"Eol",objective:"SYMBOL"},color:"red"},{text:"/",color:"gray"},{text:"20",color:"gold"},{text:" ⚙",color:"dark_red"}]}
