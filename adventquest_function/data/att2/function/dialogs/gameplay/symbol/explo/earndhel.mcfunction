...
tellraw @s[scores={LANGUAGE=..10}] {text:"⚙ ",color:"dark_red",extra:[{text:"Ëarndhel : ",color:"gray"},{score:{name:"Earndhel",objective:"SYMBOL"},color:"red"},{text:"/",color:"gray"},{text:"18",color:"gold"},{text:" ⚙",color:"dark_red"}]}
