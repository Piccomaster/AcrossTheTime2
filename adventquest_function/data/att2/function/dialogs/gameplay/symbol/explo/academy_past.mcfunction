...
tellraw @s[scores={LANGUAGE=..10}] {text:"⚙ ",color:"dark_red",extra:[{text:"Academy Past : ",color:"gray"},{score:{name:"Academy_past",objective:"SYMBOL"},color:"red"},{text:"/",color:"gray"},{text:"31",color:"gold"},{text:" ⚙",color:"dark_red"}]}
