...
tellraw @s[scores={LANGUAGE=..10}] {text:"⚙ ",color:"dark_red",extra:[{text:"Jarat : ",color:"gray"},{score:{name:"Jarat",objective:"SYMBOL"},color:"red"},{text:"/",color:"gray"},{text:"14",color:"gold"},{text:" ⚙",color:"dark_red"}]}
