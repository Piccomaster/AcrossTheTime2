...
tellraw @s[scores={LANGUAGE=..10}] {text:"⚙ ",color:"dark_red",extra:[{text:"Angor Palace : ",color:"gray"},{score:{name:"Angor_palace",objective:"SYMBOL"},color:"red"},{text:"/",color:"gray"},{text:"45",color:"gold"},{text:" ⚙",color:"dark_red"}]}
