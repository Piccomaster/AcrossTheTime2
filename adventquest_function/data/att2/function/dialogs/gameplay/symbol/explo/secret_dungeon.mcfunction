...
tellraw @s[scores={LANGUAGE=..10}] {text:"⚙ ",color:"dark_red",extra:[{text:"Secret Dungeon : ",color:"gray"},{score:{name:"Secret_dungeon",objective:"SYMBOL"},color:"red"},{text:"/",color:"gray"},{text:"34",color:"gold"},{text:" ⚙",color:"dark_red"}]}
