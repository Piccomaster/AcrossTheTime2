...
tellraw @s[scores={LANGUAGE=11}] [{object:atlas,sprite:"item/music_disc_pigstep",color:"white",shadow_color:0},{text:"⚙ ",color:"dark_red",extra:[{text:"Mangroove森林 : ",color:"gray"},{score:{name:"Mangroove",objective:"SYMBOL"},color:"red"},{text:"/",color:"gray"},{text:"10",color:"gold"},{text:" ⚙",color:"dark_red"}]}]