...
tellraw @s[scores={LANGUAGE=..10}] {text:"⚙ ",color:"dark_red",extra:[{text:"Zirthion : ",color:"gray"},{score:{name:"Zirthion",objective:"SYMBOL"},color:"red"},{text:"/",color:"gray"},{text:"30",color:"gold"},{text:" ⚙",color:"dark_red"}]}
