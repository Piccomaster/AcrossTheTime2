...
tellraw @s[scores={LANGUAGE=..10}] {text:"⚙ ",color:"dark_red",extra:[{text:"Soquaï : ",color:"gray"},{score:{name:"Soquai",objective:"SYMBOL"},color:"red"},{text:"/",color:"gray"},{text:"35",color:"gold"},{text:" ⚙",color:"dark_red"}]}
