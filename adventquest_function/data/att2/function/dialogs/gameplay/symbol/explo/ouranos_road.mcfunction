...
tellraw @s[scores={LANGUAGE=..10}] {text:"⚙ ",color:"dark_red",extra:[{text:"Ouranos Road : ",color:"gray"},{score:{name:"Ouranos_road",objective:"SYMBOL"},color:"red"},{text:"/",color:"gray"},{text:"62",color:"gold"},{text:" ⚙",color:"dark_red"}]}
