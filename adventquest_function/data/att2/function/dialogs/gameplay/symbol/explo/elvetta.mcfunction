...
tellraw @s[scores={LANGUAGE=..10}] {text:"⚙ ",color:"dark_red",extra:[{text:"Elvetta : ",color:"gray"},{score:{name:"Elvetta",objective:"SYMBOL"},color:"red"},{text:"/",color:"gray"},{text:"13",color:"gold"},{text:" ⚙",color:"dark_red"}]}
