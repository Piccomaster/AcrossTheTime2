...
tellraw @s {"text":"⚙ ","color":"dark_red","extra":[{"text":"Méleïm : ","color":"gray"},{"score":{"name":"Meleim","objective":"SYMBOL"},"color":"red"},{"text":"/","color":"gray"},{"text":"30","color":"gold"},{"text":" ⚙","color":"dark_red"}]}
