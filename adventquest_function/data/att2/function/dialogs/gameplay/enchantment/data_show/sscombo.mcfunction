...
# sscombo
tellraw @s [{text:"【",color:dark_green},{"translate":"enchantment.att2.sscombo"},{text:"】",color:dark_green}]
tellraw @s [{"translate":"enchantment.data.list.explain"}]
tellraw @s [{"translate":"enchantment.att2.sscombo.explain"}]
tellraw @s [{"translate":"enchantment.data.list.materials"}]
#lvl 1
tellraw @s [{"translate":"enchantment.data.lvl",with:[{score:{name:"0",objective:"CAL"},color:green},{score:{name:"1",objective:"CAL"},color:green},{score:{name:"sscombo_esc_1",objective:"ENCHANTMENT_DATA"},color:green},{score:{name:"sscombo_rune_1",objective:"ENCHANTMENT_DATA"},color:green}]}]
#lvl 2
