...
# heart_protection
tellraw @s [{text:"【",color:dark_green},{"translate":"enchantment.att2.heart_protection",hover_event:{action:show_text,value:[{translate:"enchantment.att2.heart_protection.data.show.show_text"}]},click_event:{action:run_command,command:"/function att2:dialogs/gameplay/enchantment/data_show/heart_protection"}},{text:"】",color:dark_green}]
# dahalburst
