...
tellraw @s [{"translate":"enchantment.data.list.scythe",hover_event:{action:show_text,value:[{translate:"enchantment.data.list.scythe.show_text"}]},click_event:{action:run_command,command:"/trigger ScoreTrigger set 3524"}}]
