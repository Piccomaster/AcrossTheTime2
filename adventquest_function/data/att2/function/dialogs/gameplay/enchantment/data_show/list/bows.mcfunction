...
# anchorshot
tellraw @s [{"text":"【",color:dark_green},{"translate":"enchantment.att2.anchorshot",hover_event:{action:"show_text",value:[{translate:"enchantment.att2.anchorshot.data.show.show_text"}]},click_event:{action:"run_command",command:"/function att2:dialogs/gameplay/enchantment/data_show/anchorshot"}},{"text":"】",color:dark_green}]
# headhunter
tellraw @s [{"text":"【",color:dark_green},{"translate":"enchantment.att2.headhunter",hover_event:{action:"show_text",value:[{translate:"enchantment.att2.headhunter.data.show.show_text"}]},click_event:{action:"run_command",command:"/function att2:dialogs/gameplay/enchantment/data_show/headhunter"}},{"text":"】",color:dark_green}]
#cross bow 
