...
#CHINESE LANGUAGE
title @s[scores={LANGUAGE=2}] actionbar {"text":"此功能将会移除你选中的的附魔，再次点击确认移除附魔","color":"green"}
#JAPANESE LANGUAGE
...
title @s[scores={LANGUAGE=11}] actionbar {"text":"此功能将会移除你选中的的附魔，再次点击确认移除附魔","color":"dark_red"}
