...
tellraw @a[scores={LANGUAGE=2}] {"text":"°|°._.°|° : ","color":"gray","extra":[{"text":"发现Eolorion传送阵!","color":"yellow"}]}
tellraw @a[scores={LANGUAGE=3..10}] {"text":"°|°._.°|° : ","color":"gray","extra":[{"text":"WAYPOINT of Eolorion discovered!","color":"yellow"}]}
tellraw @a[scores={LANGUAGE=11}] {"text":"°|°._.°|° : ","color":"gray","extra":[{"text":"发现Eolorion传送阵!","color":"yellow"}]}