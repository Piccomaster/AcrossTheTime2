...
tellraw @s[scores={LANGUAGE=0}] {text:"⚙ Durée des potions : ",color:"dark_red",extra:[{text:"+",color:"gray"},{score:{name:"#BonusTimePotion",objective:"RUNE"},color:"red"},{text:"s",color:"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=1}] {text:"⚙ Time Potion : ",color:"dark_red",extra:[{text:"+",color:"gray"},{score:{name:"#BonusTimePotion",objective:"RUNE"},color:"red"},{text:"s",color:"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=2}] {text:"⚙ 藥水時長收益 : ",color:"dark_red",extra:[{text:"+",color:"gray"},{score:{name:"#BonusTimePotion",objective:"RUNE"},color:"red"},{text:"s",color:"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=3}] {text:"⚙ ポーション持続時間 : ",color:"dark_red",extra:[{text:"+",color:"gray"},{score:{name:"#BonusTimePotion",objective:"RUNE"},color:"red"},{text:"秒",color:"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=4}] {text:"⚙ 물약 지속 시간 : ",color:"dark_red",extra:[{text:"+",color:"gray"},{score:{name:"#BonusTimePotion",objective:"RUNE"},color:"red"},{text:"초",color:"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=5}] {text:"⚙ مدة الجرعة : ",color:"dark_red",extra:[{text:"+",color:"gray"},{score:{name:"#BonusTimePotion",objective:"RUNE"},color:"red"},{text:"ث",color:"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=6}] {text:"⚙ Длительность зелий : ",color:"dark_red",extra:[{text:"+",color:"gray"},{score:{name:"#BonusTimePotion",objective:"RUNE"},color:"red"},{text:"с",color:"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=7}] {text:"⚙ Duración de poción : ",color:"dark_red",extra:[{text:"+",color:"gray"},{score:{name:"#BonusTimePotion",objective:"RUNE"},color:"red"},{text:"s",color:"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=8}] {text:"⚙ Trankdauer : ",color:"dark_red",extra:[{text:"+",color:"gray"},{score:{name:"#BonusTimePotion",objective:"RUNE"},color:"red"},{text:"s",color:"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=9}] {text:"⚙ औषधि अवधि : ",color:"dark_red",extra:[{text:"+",color:"gray"},{score:{name:"#BonusTimePotion",objective:"RUNE"},color:"red"},{text:"से",color:"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=10}] {text:"⚙ Duração de Poção : ",color:"dark_red",extra:[{text:"+",color:"gray"},{score:{name:"#BonusTimePotion",objective:"RUNE"},color:"red"},{text:"s",color:"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=11}] {text:"⚙ 药水时长收益 : ",color:"dark_red",extra:[{text:"+",color:"gray"},{score:{name:"#BonusTimePotion",objective:"RUNE"},color:"red"},{text:"s",color:"dark_red"}]}
