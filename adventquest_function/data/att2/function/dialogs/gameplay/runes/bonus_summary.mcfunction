...
tellraw @s[scores={LANGUAGE=0}] {"text":"⚙ Limite de Dahäl : ","color":"dark_red","extra":[{"text":"+","color":"gray"},{"score":{"name":"BonusDahalMax","objective":"RUNE"},"color":"red"},{"text":"%","color":"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=5}] {"text":"⚙ حد داهال : ","color":"dark_red","extra":[{"text":"+","color":"gray"},{"score":{"name":"BonusDahalMax","objective":"RUNE"},"color":"red"},{"text":"%","color":"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=6}] {"text":"⚙ Лимит Дахаля : ","color":"dark_red","extra":[{"text":"+","color":"gray"},{"score":{"name":"BonusDahalMax","objective":"RUNE"},"color":"red"},{"text":"%","color":"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=7}] {"text":"⚙ Límite de Dahäl : ","color":"dark_red","extra":[{"text":"+","color":"gray"},{"score":{"name":"BonusDahalMax","objective":"RUNE"},"color":"red"},{"text":"%","color":"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=8}] {"text":"⚙ Dahäl-Limit : ","color":"dark_red","extra":[{"text":"+","color":"gray"},{"score":{"name":"BonusDahalMax","objective":"RUNE"},"color":"red"},{"text":"%","color":"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=9}] {"text":"⚙ दाहाल सीमा : ","color":"dark_red","extra":[{"text":"+","color":"gray"},{"score":{"name":"BonusDahalMax","objective":"RUNE"},"color":"red"},{"text":"%","color":"dark_red"}]}
...
tellraw @s[scores={LANGUAGE=10}] {"text":"⚙ Limite de Dahäl : ","color":"dark_red","extra":[{"text":"+","color":"gray"},{"score":{"name":"BonusDahalMax","objective":"RUNE"},"color":"red"},{"text":"%","color":"dark_red"}]}
