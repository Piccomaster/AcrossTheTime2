...
execute as @s[nbt={Inventory:[{id:"minecraft:melon_seeds",components:{"minecraft:custom_name":{translate:'item.quest.gem_of_space.name'}}}]}] run setblock -5032 67 -5040 minecraft:redstone_block
