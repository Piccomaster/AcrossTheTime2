...
execute if score Real2 TIMER matches 290 run summon minecraft:armor_stand -4377.25 41.25 -5050.75 {Rotation:[-30.0f,0.0f],equipment:{mainhand:{count:1,id:"minecraft:diamond_shovel",components:{EquipmentType:"meleeWeapon",EquipmentID:"loneshadow",Rarity:"myt",custom_model_data:{floats:[10000006]},unbreakable:{},enchantments:{},attribute_modifiers:[{type:attack_damage,id:attack_damage,amount:5.96,operation:add_value,slot:mainhand},{type:attack_speed,id:attack_speed,amount:-0.2,operation:add_multiplied_base,slot:mainhand}],display:{Name:"\" §7-§8• §8L§0one §8S§0hadow §8•§7- \"","Lore":["{\"text\":\"   §8Shall they all"," §0§ldie §8in §0§lloneliness,","  §8solitude is §7§mbliss§8...\"}"]}}},offhand:{}},ShowArms:1,Invisible:1,NoGravity:1,DisabledSlots:1973790,Pose:{RightArm:[-80f,-15f,-150f]}}
