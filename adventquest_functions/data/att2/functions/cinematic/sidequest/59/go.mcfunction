...
execute if score SQ59 SIDEQUEST matches 15 if score tic TIMECOUNTER matches 10 at @a[gamemode=adventure] as @e[type=minecraft:zombie,distance=..25] run data merge entity @s {drop_chances:{mainhand:0,offhand:0,feet:0,legs:0,chest:0,head:0,body:0,saddle:0}}
