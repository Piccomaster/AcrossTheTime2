...
summon interaction -5029 92 -4957 {height:0.5,width:0.5,response:1,Tags:["RUNE_SWITCH"],Passengers:[{id:"minecraft:block_display",block_state:{Name:"heavy_core"},Tags:["RUNE_SWITCH"],transformation:{translation:[0f,-0.35f,0f],scale:[1f,1f,1f]}},{id:"minecraft:text_display",text:[{translate:att2.runes.runepowder.count}],Tags:["RUNE_SWITCH"],transformation:{translation:[0f,-0.35f,0f],scale:[1f,1f,1f]}}]}
