...
##POTION_TIP
execute if score POTION_CHECK_STR TIMER matches 1 as @a[scores={TIMER_STR_PO=..200,STR_LVL_PO=0..,POTION_CUE=0}] at @s run function att2:dialog/gameplay/potion_tip/str_time
