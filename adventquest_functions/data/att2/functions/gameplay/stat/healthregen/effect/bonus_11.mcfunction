...
scoreboard players operation @s[scores={TIMER_HER_TOT=..0}] TIMER_HER_TOT = bonus_11 HER_DATA
#get score
scoreboard players operation TIMER_HER_TOT HER_DATA = bonus_11 HER_DATA
