...
# Particle
particle minecraft:dust{color:[1,0,0.4],scale:0.5} -5339.0 78 -4674.0 1.5 1 1 0 25 normal
particle minecraft:dust{color:[0.3,0,0.3],scale:0.5} -5339.0 78 -4674.0 1.5 1 1 0 25 normal
