...
#spell effect
#STR
scoreboard players operation @s STR_SP = lvl8 SPELL40_STR
#SPD
scoreboard players operation @s SPD_SP = lvl8 SPELL40_SPD
#HER
scoreboard players operation @s HER_SP = lvl8 SPELL40_HER
#HAS
scoreboard players operation @s HAS_SP = lvl8 SPELL40_HAS
#timer set
