...
#start enchantment
execute if score auto_mending ENCHANTMENT matches 1.. run function att2:gameplay/enchantment/remove_interaction
execute if score auto_mending ENCHANTMENT matches 1.. run scoreboard players set add_progress ENCHANTMENT 1
#reduce Materials
