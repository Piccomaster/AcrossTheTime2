...
execute if score speedsave ENCHANTMENT > now_lvl_show ENCHANTMENT if score speedsave ENCHANTMENT matches 2.. store result storage att2:enchantment end_lvl_show int 1 run scoreboard players get speedsave ENCHANTMENT
#cal and set Materials cost
scoreboard players operation esc_cost ENCHANTMENT = speedsave ENCHANTMENT
...
scoreboard players operation rune_cost ENCHANTMENT = speedsave ENCHANTMENT
