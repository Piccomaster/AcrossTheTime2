...
execute if score 1000slay ENCHANTMENT > now_lvl_show ENCHANTMENT if score 1000slay ENCHANTMENT matches 2.. store result storage att2:enchantment end_lvl_show int 1 run scoreboard players get 1000slay ENCHANTMENT
#cal and set Materials cost
scoreboard players operation esc_cost ENCHANTMENT = 1000slay ENCHANTMENT
...
scoreboard players operation rune_cost ENCHANTMENT = 1000slay ENCHANTMENT
