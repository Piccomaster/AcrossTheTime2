...
execute if score auto_mending ENCHANTMENT > now_lvl_show ENCHANTMENT if score auto_mending ENCHANTMENT matches 2.. store result storage att2:enchantment end_lvl_show int 1 run scoreboard players get auto_mending ENCHANTMENT
