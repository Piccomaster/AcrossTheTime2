...
execute if score gourmetmaster ENCHANTMENT > now_lvl_show ENCHANTMENT if score gourmetmaster ENCHANTMENT matches 2.. store result storage att2:enchantment end_lvl_show int 1 run scoreboard players get gourmetmaster ENCHANTMENT
