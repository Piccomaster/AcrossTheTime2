...
execute if score groundslam ENCHANTMENT > now_lvl_show ENCHANTMENT if score groundslam ENCHANTMENT matches 2.. store result storage att2:enchantment end_lvl_show int 1 run scoreboard players get groundslam ENCHANTMENT
