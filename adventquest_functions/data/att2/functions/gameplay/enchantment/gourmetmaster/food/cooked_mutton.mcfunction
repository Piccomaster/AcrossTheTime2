...
execute unless score @s FOODID matches 13 run scoreboard players add @s GOURMETMASTER 4
execute if score @s FOODID matches 13 run scoreboard players remove @s GOURMETMASTER 8
#set GOURMETMASTER ID
scoreboard players set @s FOODID 13
...
#reset
advancement revoke @s only att2_test:enchantment/gourmetmaster/cooked_mutton