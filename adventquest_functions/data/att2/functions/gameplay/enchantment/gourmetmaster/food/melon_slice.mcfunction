...
execute unless score @s FOODID matches 18 run scoreboard players add @s GOURMETMASTER 1
execute if score @s FOODID matches 18 run scoreboard players remove @s GOURMETMASTER 2
#set GOURMETMASTER ID
scoreboard players set @s FOODID 18
...
#reset
advancement revoke @s only att2_test:enchantment/gourmetmaster/melon_slice
