...
execute as @e[type=minecraft:item,x=-4912,y=10,z=-4433,dx=-130,dy=44,dz=104,nbt={Item:{id:"minecraft:diamond_pickaxe",components:{EquipmentID:"sastr"}},OnGround:1b}] run kill @s
