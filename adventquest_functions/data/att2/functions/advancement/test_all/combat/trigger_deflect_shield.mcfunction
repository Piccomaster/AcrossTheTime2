...
# DAMAGE BLOCK
advancement grant @s[scores={statDAMAGEBLOCK=1..}] only att2:combat/damage_block
advancement grant @s[scores={statDAMAGEBLOCK=100..}] only att2:combat/damage_block_100
advancement grant @s[scores={statDAMAGEBLOCK=2500..}] only att2:combat/damage_block_2500
advancement grant @s[scores={statDAMAGEBLOCK=10000..}] only att2:combat/damage_block_10000
advancement grant @s[scores={statDAMAGEBLOCK=50000..}] only att2:combat/damage_block_50000