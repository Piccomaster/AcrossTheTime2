...
tellraw @s[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"我终于来到了Vonaheim建造的大城堡。看样子这儿没有上去的道路， 那我应该反过来，试试看能不能在地下找到上去的方法...","color":"aqua"}]}
