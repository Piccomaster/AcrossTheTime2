...
#Simplified Chinese
tellraw @a[scores={LANGUAGE=11}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"*低声地自言自语*我为什么不在第一次见面的时候就杀死这个疯子...这就是当你太过于有耐心的时候会发生的事。","color":"aqua"}]}
